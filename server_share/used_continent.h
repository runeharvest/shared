...
public:
  ...
  const TUsedContinentCont &getContinents() const { return _Continents; }
   ...
   *	If the continent name is unknow, return
...
private:
...
#endif
  {
    ...
    TFindInstance(uint32 instanceNumber) : InstanceNumber(instanceNumber) {}
