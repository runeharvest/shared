...
public:
  CCommandExecutor() { CCommandExecutorSkel::init(this); }

  //	bool onProcessModuleMessage(IModuleProxy *sender, const CMessage
  //&message)
  //	{
  //		if (CCommandExecutorSkel::onDispatchMessage(sender, message))
  //			return true;
  //
  //		nlwarning("CCommandExecutor : Unknown message '%s' received",
  ...
  void sendCommand(NLNET::IModuleProxy *sender, const std::string &commandName,
