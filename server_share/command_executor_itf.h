...
private:
  typedef void (CCommandExecutorSkel::*TMessageHandler)(
  ...
  void sendCommand_skel(NLNET::IModuleProxy *sender,
...
public:
  ...
  //
  virtual void sendCommand(NLNET::IModuleProxy *sender,
...
public:
  ...
  //
  void sendCommand(NLNET::IModule *sender, const std::string &commandName,
                   const NLMISC::CEntityId &senderEId, bool haveTarget,
  ...
  // integration
  static const NLNET::CMessage &buildMessageFor_sendCommand(
