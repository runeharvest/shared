...
TLogNoContext_Chat::TLogNoContext_Chat() { ChatDesc.pushNoContext(); }

TLogNoContext_Chat::~TLogNoContext_Chat() { ChatDesc.popNoContext(); }

void _log_Chat_Chat(std::string channel, const NLMISC::CEntityId &senderCharId,
                    const std::string &chatText,
                    const std::list<NLMISC::CEntityId> &receiverCharIds,
  ...
  std::list<NLMISC::CEntityId>::const_iterator first(receiverCharIds.begin()),
      last(receiverCharIds.end());
...
void _log_Chat_Tell(const NLMISC::CEntityId &senderCharId,
                    const NLMISC::CEntityId &receiverCharId,
                    const std::string &chatText, const char *_filename_,
                    uint _lineNo_) {
  static LGS::TLogInfo logInfo;
  static bool init = false;
  if (!init) {
