...
// ****************************************************************************
bool CStatDBTableLeaf::playerGet(NLMISC::CEntityId playerId,
                                 sint32 &val) const {
...
// ****************************************************************************
void CStatDBBranch::getNodes(const std::string &pathPattern,
                             std::vector<CMatchingNode> &matchingNodes,
                             const std::string &currentPath) {
  BOMB_IF(pathPattern.empty(), "empty path!", return);

  // DO NOT clear the vector 'matchingNodes' here because this method is
  // recursive
...
// ****************************************************************************
void CStatDBBranch::acceptVisitor(CStatDBNodeVisitor &visitor,
                                  const std::string &currentPath) {
...
// ****************************************************************************
void CStatDBBranch::splitPath(const std::string &path, std::string &token,
...
// ****************************************************************************
void CStatDBEntitiesRemoval::visitTableLeaf(CStatDBTableLeaf *tableLeaf,
