...
public:
  /// constructor
  CCharacterDesc() : _NoContextCount(0) {
    _LogDefs.resize(11);
...
const std::string TLogContext_Character_BuyRolemasterPhrase::_ContextName(
    "Character_BuyRolemasterPhrase");
...
const std::string
    TLogContext_Character_AdminCommand::_ContextName("Character_AdminCommand");
/// The constructor push a log context in the logger system
...
const std::string TLogContext_Character_SkillProgress::_ContextName(
    "Character_SkillProgress");
/// The constructor push a log context in the logger system
...
const std::string TLogContext_Character_MissionRecvXp::_ContextName(
    "Character_MissionRecvXp");
/// The constructor push a log context in the logger system
...
void _log_Character_Create(uint32 userId, const NLMISC::CEntityId &charId,
                           const std::string &charName, const char *_filename_,
                           uint _lineNo_) {
...
void _log_Character_Delete(uint32 userId, const NLMISC::CEntityId &charId,
                           const std::string &charName, const char *_filename_,
                           uint _lineNo_) {
  static LGS::TLogInfo logInfo;
  static bool init = false;
...
void _log_Character_Select(uint32 userId, const NLMISC::CEntityId &charId,
                           const std::string &charName, const char *_filename_,
                           uint _lineNo_) {
  static LGS::TLogInfo logInfo;
  static bool init = false;
...
void _log_Character_LevelUp(const NLMISC::CEntityId &charId,
                            const std::string &skillName, uint32 level,
...
void _log_Character_UpdateSP(const std::string &spName, float spBefore,
                             float spAfter, const char *_filename_,
                             uint _lineNo_) {
  static LGS::TLogInfo logInfo;
  static bool init = false;
  if (!init) {
  ...
  if (!CharacterDesc.getContextVar_charId(charId)) {
    ...
    // 'noContext').
    STOP_IF(CharacterDesc.getNoContextCount() == 0,
            _filename_ << "(" << _lineNo_
                       << ") : Missing log context for log 'Character'");
    return;
  }
...
void _log_Character_LearnPhrase(const NLMISC::CSheetId &phraseId,
                                const char *_filename_, uint _lineNo_) {
  static LGS::TLogInfo logInfo;
  static bool init = false;
  if (!init) {
...
void _log_Character_AddKnownBrick(const NLMISC::CSheetId &brickId,
                                  const char *_filename_, uint _lineNo_) {
  static LGS::TLogInfo logInfo;
  static bool init = false;
  if (!init) {
...
void _log_Character_RemoveKnownBrick(const NLMISC::CSheetId &brickId,
                                     const char *_filename_, uint _lineNo_) {
  static LGS::TLogInfo logInfo;
  static bool init = false;
  if (!init) {
