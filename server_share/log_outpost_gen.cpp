...
public:
  /// constructor
  COutpostDesc() : _NoContextCount(0) {
    _LogDefs.resize(4);
...
TLogNoContext_Outpost::TLogNoContext_Outpost() { OutpostDesc.pushNoContext(); }

TLogNoContext_Outpost::~TLogNoContext_Outpost() { OutpostDesc.popNoContext(); }
