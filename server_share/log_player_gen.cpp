...
TLogNoContext_Player::TLogNoContext_Player() { PlayerDesc.pushNoContext(); }

TLogNoContext_Player::~TLogNoContext_Player() { PlayerDesc.popNoContext(); }

void _log_Player_Connect(uint32 userId, const std::string &fromAddr,
...
void _log_Player_Disconnect(uint32 userId, bool crashed, const char *_filename_,
                            uint _lineNo_) {
  static LGS::TLogInfo logInfo;
  static bool init = false;
  if (!init) {
