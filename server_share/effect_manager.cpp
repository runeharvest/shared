...
//--------------------------------------------------------------
CEffectManager::CEffectManager() {} // constructor //

//--------------------------------------------------------------
//				CEffectManager destructor
//--------------------------------------------------------------
CEffectManager::~CEffectManager() { release(); } // destructor //
...
void CEffectManager::update() {
  ...
  if (!_RegisteredServices.empty()) {
    ...
    const std::vector<CBasicEffect>::const_iterator itNewEnd =
        _NewEffects.end();
    for (; itNew != itNewEnd; ++itNew) {
      addMsg.addEffect(*itNew);
    }

    std::vector<CBasicEffect>::const_iterator itRemove =
        _RemovedEffects.begin();
    const std::vector<CBasicEffect>::const_iterator itRemoveEnd =
        _RemovedEffects.end();
    ...
    const set<NLNET::TServiceId>::const_iterator itEnd =
