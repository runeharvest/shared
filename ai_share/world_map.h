...
inline CCellLinkage::CCellLinkage(uint8 links)
    : _Links(links)
{
}
...
inline void CCellLinkage::serial(NLMISC::IStream &f)
{
	f.serial(_Links);
}
...
inline CDirection::CDirection(CDirection const &dir)
    : _value(dir._value)
{
}

inline CDirection::CDirection(TDirection dir)
    : _value(dir)
{
#ifdef NL_DEBUG
...
inline sint CDirection::dx() const
{
	return directionDatas[_value].dx;
}

inline sint CDirection::dy() const
{
...
inline CDirection::TDirection CDirection::getVal() const
{
	return _value;
}
...
inline uint32 CDirection::getWeight()
{
	return directionDatas[_value].weight;
}

inline void CDirection::getDirectionAround(CAngle const &Angle, CDirection &Dir0, CDirection &Dir1)
{
...
inline CNeighbourhood::CNeighbourhood()
    : Neighb(0)
{
}

inline CNeighbourhood::CNeighbourhood(uint32 neighb)
    : Neighb(neighb)
{
}
...
inline bool CUnitSlot::used() const
{
...
inline uint CMapCoord::cellIdMask(uint val) const
{
	return val & 0xff0f;
}
...
inline uint CMapCoord::toUnitId(uint val) const
{
	return val & 0x0f;
}

inline uint CMapCoord::toCellId(uint val) const
{
	return (val << 4) & 0x0f0;
}
...
inline uint CMapCoord::unitIdToUInt(uint val) const
{
	return val & 0x0f;
}

inline uint CMapCoord::cellIdToUInt(uint val) const
{
	return (val >> 4) & 0xf;
}
...
inline TMapCoordType &CMapCoord::cRef()
{
	return c;
}
...
inline CDirection CGridDirectionLayer::getDirection(CMapPosition const &pos) const
{
...
inline CTopology::TTopologyId::TTopologyId()
    : _value(UNDEFINED_TOPOLOGY)
{
}

inline CTopology::TTopologyId::TTopologyId(CMapPosition const &pos, uint topology)
{
#ifdef NL_DEBUG
...
inline CTopology::TTopologyId::TTopologyId(uint32 id)
{
	_value = id;
}

inline bool CTopology::TTopologyId::haveSameCellPos(TTopologyId const &other) const
{
...
inline uint32 CTopology::TTopologyId::getVal() const
{
	return _value;
}
...
inline CTopology::TTopologyRef::TTopologyRef(TTopologyId const &id, CRootCell *rootCell)
    : TTopologyId(id)
{
...
inline CTopology::CNeighbourLink::CNeighbourLink()
    : _Ref()
{
}

inline CTopology::CNeighbourLink::CNeighbourLink(TTopologyRef const &ref, float distance)
    : _Ref(ref)
    , _Distance(distance)
{
}
...
inline CTopology::TTopologyRef const &CTopology::CNeighbourLink::getTopologyRef() const
{
	return _Ref;
}
...
inline CCompatibleResult::CCompatibleResult(TAStarFlag movementFlags, uint32 choosenMasterTopo)
...
inline void CCompatibleResult::set(TAStarFlag movementFlags, uint32 choosenMasterTopo)
{
	_MovementFlags = movementFlags;
	_ChoosenMasterTopo = choosenMasterTopo;
}

inline void CCompatibleResult::setValid(bool valid)
{
	_Valid = valid;
}
...
inline bool const &CCompatibleResult::isValid() const
{
	return _Valid;
}
...
inline CTopology::TTopologyId CRootCell::getTopologyId(CWorldPosition const &wpos) const
{
	return CTopology::TTopologyId(wpos, getTopology(wpos));
}

inline CTopology::TTopologyRef CRootCell::getTopologyRef(const CWorldPosition &pos) const
{
#ifdef NL_DEBUG
...
inline CTopology const &CRootCell::getCstTopologyNode(CTopology::TTopologyId const &id) const
{
...
inline CCellLinkage CComputeCell::getCellLink(CWorldPosition const &wpos) const
{
...
inline bool CComputeCell::isSlotUsed(CMapPosition const &pos, CSlot const &slot) const
{
	TCellUnit const &cellUnit = getCellUnitCst(pos);
...
inline TCellUnit const &CComputeCell::getCellUnitCst(CMapPosition const &pos) const
{
	return _Grid[pos.cellUnitFastIndex()];
}

inline CUnitSlot const &CComputeCell::getUnitSlotCst(CWorldPosition const &wpos) const
{
#ifdef NL_DEBUG
...
inline TCellUnit const &CComputeCell::getCellUnitCst(CWorldPosition const &wpos) const
{
...
inline bool CWhiteCell::isSlotUsed(CMapPosition const &pos, CSlot const &slot) const
{
	return slot.slot() == 0;
}
...
inline CCellLinkage CSingleLayerCell::getCellLink(CWorldPosition const &wpos) const
{
...
inline bool CSingleLayerCell::isSlotUsed(CMapPosition const &pos, CSlot const &slot) const
{
...
inline CCellLinkage const &CMultiLayerCell::CCellLayer::getCellLinkage(CMapPosition const &pos) const
{
	return _Layer[pos.cellUnitFastIndex()]; // yCoord().getUnitId()][pos.xCoord().getUnitId()];
}

inline uint8 CMultiLayerCell::CCellLayer::getTopology(CMapPosition const &pos) const
{
	return _Topology[pos.cellUnitFastIndex()]; // yCoord().getUnitId()][pos.xCoord().getUnitId()];
}

inline CCellLinkage &CMultiLayerCell::CCellLayer::cellLinkage(CMapPosition const &pos)
{
	return _Layer[pos.cellUnitFastIndex()]; // yCoord().getUnitId()][pos.xCoord().getUnitId()];
}
...
inline CCellLinkage CMultiLayerCell::getCellLink(CWorldPosition const &wpos) const
{
#ifdef NL_DEBUG
	nlassert(wpos.isValid());
#endif
...
inline bool CMultiLayerCell::isSlotUsed(CMapPosition const &pos, CSlot const &slot) const
{
	if (!slot.isValid())
		return false;
...
inline void CMultiLayerCell::setLinks(CWorldPosition const &wpos, CCellLinkage links)
{
#ifdef NL_DEBUG
	nlassert(wpos.isValid());
#endif
...
inline void CMultiLayerCell::setTopology(CWorldPosition const &wpos, uint topology)
{
#ifdef NL_DEBUG
	nlassert(topology < 256);
	nlassert(wpos.isValid());
...
inline void CMultiLayerCell::setHeightMap(CSlot const &slot, I16x16Layer *heightMap)
{
#ifdef NL_DEBUG
...
inline CSuperCell::CSuperCell(CWorldMap const &worldMap)
    : _WorldMap(worldMap)
{
	for (uint i = 0; i < 16 * 16; i++)
		_Grid[i] = NULL;
...
inline CRootCell const *CSuperCell::getRootCellCst(CMapPosition const &pos) const
{
...
inline CComputeCell const *CSuperCell::getComputeCell(CMapPosition const &pos) const
{
...
inline CWorldPosition::CWorldPosition(const CRootCell *cell, const CMapPosition &pos, const CSlot &slot)
    : CMapPosition(pos)
    , CSlot(slot)
    , _RootCell(cell)
{
...
inline CWorldPosition::CWorldPosition(const CRootCell *cell, const CMapPosition &pos, const CSlot &slot, bool generationOnly)
    : CMapPosition(pos)
    , CSlot(slot)
    , _RootCell(cell)
{
...
inline CTopology::TTopologyRef::TTopologyRef(CWorldPosition const &pos, CRootCell const *rootCell)
...
inline void CTopology::CNeighbourLink::updateTopologyRef(CWorldMap *worldMapPtr)
{
...
inline CTopology::TTopologyId CWorldMap::getTopologyId(CWorldPosition const &wpos) const
{
...
inline CTopology const &CWorldMap::getTopologyNode(CTopology::TTopologyId const &id) const
{
...
inline CGridDirectionLayer const *CWorldMap::getGridDirectionLayer(CWorldPosition const &pos, CTopology::TTopologyRef const &topologyRef) const
{
	if (!pos.isValid())
		return NULL;
...
inline CWorldPosition CWorldMap::getWorldPosition(CMapPosition const &mapPos, CSlot const &slot) const
{
	return CWorldPosition(getRootCellCst(mapPos), mapPos, slot);
}

inline CWorldPosition CWorldMap::getWorldPosition(CMapPosition const &mapPos, TLevel level) const
{
	CRootCell const *cell = getRootCellCst(mapPos);
...
inline bool CWorldMap::setWorldPosition(AITYPES::TVerticalPos verticalPos, CWorldPosition &wpos, CAIVector const &pos, CRootCell const *originCell) const
{
	CSlot slot;
	CMapPosition const mapPos(pos);
...
inline CTopology::TTopologyRef CWorldMap::getTopologyRef(CTopology::TTopologyId const &id) const
{
	return CTopology::TTopologyRef(id, const_cast<CRootCell *>(getRootCellCst(id.getMapPosition())));
}

inline CRootCell const *CWorldMap::getRootCellCst(CMapPosition const &pos) const
{
	CSuperCell const *scell = getSuperCellCst(pos);
	return !scell ? NULL : scell->getRootCellCst(pos);
}

inline CSuperCell const *CWorldMap::getSuperCellCst(CMapPosition const &pos) const
{
	return _GridFastAccess[pos.superCellFastIndex()];
}

inline CWorldPosition CWorldMap::getWorldPositionGeneration(CMapPosition const &mapPos, CSlot const &slot) const
{
	return CWorldPosition(getRootCellCst(mapPos), mapPos, slot, true); //	without assuring cellLink is valid .. :(
}

inline CWorldPosition CWorldMap::getSafeWorldPosition(CMapPosition const &mapPos, CSlot const &slot) const
{
	CRootCell const *cell = getRootCellCst(mapPos);
...
inline CComputeCell const *CWorldMap::getComputeCellCst(CMapPosition const &pos) const
{
	CSuperCell const *scell = getSuperCellCst(pos);
