...
template <class T> class CEntityListLink {
public:
  //------------------------------------------------
  // ctor & dtor
  ...
  //------------------------------------------------
  // read accessors
  inline CEntityListLink<T> *const &next() const { return _next; }

  inline CEntityListLink<T> *const &prev() const { return _prev; }

  inline T *entity() const { return _entity; }
