...
public:
	...
	{
	public:
		CDescTypeEntry(const char *name, T value)
		    : _name(name)
		    , _value(value)
		{
		}
...
template <class type>
extern type getType(const char *s)
{
	int index = 0;
	do
	{
...
template <class type>
extern type getTypeAs(const type &t, const char *s)
{
...
template <class type>
extern void getType(type &t, const char *s)
{
	t = getType<type>(s);
}
...
template <>
class CTypeSpecialization<TAIType>
{
public:
	enum
	{
		BadType = AITypeBadType
	};
};
...
template <>
class CTypeSpecialization<TAITypeSpec>
{
public:
	enum
	{
		BadType = AITypeSpecBadType
	};
};
...
template <>
class CTypeSpecialization<TMgrType>
{
public:
	enum
	{
		BadType = MgrTypeBadType
	};
};
...
template <>
class CTypeSpecialization<TFaunaType>
{
public:
	enum
	{
		BadType = FaunaTypeBadType
	};
};
...
template <>
class CTypeSpecialization<TEffectType>
{
public:
	enum
	{
		BadType = EffectTypeBadType
	};
};
...
template <>
class CTypeSpecialization<TSpawnType>
{
public:
	enum
	{
		BadType = SpawnTypeBadType
	};
};
...
template <>
class CTypeSpecialization<TProfiles>
{
public:
	enum
	{
...
inline CPropertyId::CPropertyId()
    : _Id(0)
{
}
...
inline CPropertyId::CPropertyId(CPropertyId const &other)
    : _Id(other._Id)
{
}
inline CPropertyId::CPropertyId(NLMISC::TStringId id)
    : _Id(id)
{
}
...
inline bool CPropertyId::empty() const
{
	return _Id != 0;
}
...
inline NLMISC::TStringId CPropertyId::toStringId() const
{
	return _Id;
}
...
inline std::string TProperty::toString() const
{
...
inline CPropertySet::CPropertySet(std::string const &str)
{
	addProperty(str);
}
...
inline bool CPropertySet::containsPartOfStrict(CPropertySet const &other) const
{
	if (other.empty())
		return false;
...
inline bool CPropertySet::containsPartOfNotStrict(CPropertySet const &other) const
{
	if (other.empty())
		return true;
	for (TAdditionalPropertyList::const_iterator it = other.begin(), itEnd = other.end(); it != itEnd; ++it)
...
inline bool CPropertySet::containsPartOfStrictFilter(std::string const &other) const
{
	if (other.empty())
		return false;
...
inline bool CPropertySet::empty() const
{
...
inline size_t CPropertySet::size() const
{
...
inline CPropertySet::TAdditionalPropertyList::const_iterator CPropertySet::begin() const
{
	return _Activities.begin();
}

inline CPropertySet::TAdditionalPropertyList::const_iterator CPropertySet::end() const
{
	return _Activities.end();
}
}
