...
public:
  ...
  CMsgAIManagerUp(uint mgrId, std::string Name) { MgrId = mgrId; }
...
public:
  ...
  CMsgAIFeedback(const std::string &message) { Message = message; }

  CMsgAIFeedback(const char *msgStr) { Message = std::string(msgStr); }
