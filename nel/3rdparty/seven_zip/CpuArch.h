...
If MY_CPU_LE and MY_CPU_BE are not defined, we don't know about ENDIANNESS of
platform.
...
#if defined(_M_ARM64) || defined(__AARCH64EL__) || defined(__AARCH64EB__) ||   \
    defined(__aarch64__)
#define MY_CPU_ARM64
...
#if defined(_M_ARM) || defined(_M_ARM_NT) || defined(_M_ARMT) ||               \
    defined(__arm__) || defined(__thumb__) || defined(__ARMEL__) ||            \
...
#define MY_CPU_IA64_LE
    ...
    defined(MY_CPU_ARM64_LE) || defined(MY_CPU_IA64_LE) ||                     \
    defined(__LITTLE_ENDIAN__) || defined(__ARMEL__) ||                        \
    defined(__THUMBEL__) || defined(__AARCH64EL__) || defined(__MIPSEL__) ||   \
    defined(__MIPSEL) || defined(_MIPSEL) || defined(__BFIN__) ||              \
...
#define MY_CPU_LE
    ...
    defined(_MIPSEB) || defined(__m68k__) || defined(__s390__) ||              \
...
#define GetUi16(p)                                                             \
  ((UInt16)(((const Byte *)(p))[0] | ((UInt16)((const Byte *)(p))[1] << 8)))
...
#define GetBe16(p)                                                             \
  ((UInt16)(((UInt16)((const Byte *)(p))[0] << 8) | ((const Byte *)(p))[1]))
