...
// The following macros are here to allow logs generated by networking code to
// be enabled and dissabled

#define LNETL0_INFO                                                            \
  if (!VerboseLNETL0.get()) {                                                  \
  } else                                                                       \
    nlinfo
#define LNETL1_INFO                                                            \
  if (!VerboseLNETL1.get()) {                                                  \
  } else                                                                       \
    nlinfo
#define LNETL2_INFO                                                            \
  if (!VerboseLNETL2.get()) {                                                  \
  } else                                                                       \
    nlinfo
#define LNETL3_INFO                                                            \
  if (!VerboseLNETL3.get()) {                                                  \
  } else                                                                       \
    nlinfo
#define LNETL4_INFO                                                            \
  if (!VerboseLNETL4.get()) {                                                  \
  } else                                                                       \
    nlinfo
#define LNETL5_INFO                                                            \
  if (!VerboseLNETL5.get()) {                                                  \
  } else                                                                       \
    nlinfo
#define LNETL6_INFO                                                            \
  if (!VerboseLNETL6.get()) {                                                  \
  } else                                                                       \
    nlinfo
