...
#define CHECK_TYPES(__a, __b)                                                                                                                                                                                                                           \
	...
	template <class A>                                                                                                                                                                                                                                  \
	__a(const char *fmt, A a)                                                                                                                                                                                                                           \
	{                                                                                                                                                                                                                                                   \
		_check(a);                                                                                                                                                                                                                                      \
		__b(fmt, a);                                                                                                                                                                                                                                    \
	}                                                                                                                                                                                                                                                   \
	template <class A, class B>                                                                                                                                                                                                                         \
	__a(const char *fmt, A a, B b)                                                                                                                                                                                                                      \
	{                                                                                                                                                                                                                                                   \
		_check(a);                                                                                                                                                                                                                                      \
		_check(b);                                                                                                                                                                                                                                      \
		__b(fmt, a, b);                                                                                                                                                                                                                                 \
	...
	__a(const char *fmt, A a, B b, C c)                                                                                                                                                                                                                 \
	{                                                                                                                                                                                                                                                   \
		_check(a);                                                                                                                                                                                                                                      \
		_check(b);                                                                                                                                                                                                                                      \
		_check(c);                                                                                                                                                                                                                                      \
	...
	__a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k, L l)                                                                                                                                                                    \
	{                                                                                                                                                                                                                                                   \
		_check(a);                                                                                                                                                                                                                                      \
		_check(b);                                                                                                                                                                                                                                      \
		_check(c);                                                                                                                                                                                                                                      \
	...
	__a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k, L l, M m)                                                                                                                                                               \
	{                                                                                                                                                                                                                                                   \
		_check(a);                                                                                                                                                                                                                                      \
		_check(b);                                                                                                                                                                                                                                      \
		_check(c);                                                                                                                                                                                                                                      \
	...
	__a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k, L l, M m, N n)                                                                                                                                                          \
	{                                                                                                                                                                                                                                                   \
		_check(a);                                                                                                                                                                                                                                      \
		_check(b);                                                                                                                                                                                                                                      \
		_check(c);                                                                                                                                                                                                                                      \
	...
	__a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k, L l, M m, N n, O o)                                                                                                                                                     \
	{                                                                                                                                                                                                                                                   \
		_check(a);                                                                                                                                                                                                                                      \
		_check(b);                                                                                                                                                                                                                                      \
		_check(c);                                                                                                                                                                                                                                      \
	...
	__a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k, L l, M m, N n, O o, P p)                                                                                                                                                \
	{                                                                                                                                                                                                                                                   \
		_check(a);                                                                                                                                                                                                                                      \
		_check(b);                                                                                                                                                                                                                                      \
		_check(c);                                                                                                                                                                                                                                      \
	...
	__a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k, L l, M m, N n, O o, P p, Q q)                                                                                                                                           \
	{                                                                                                                                                                                                                                                   \
		_check(a);                                                                                                                                                                                                                                      \
		_check(b);                                                                                                                                                                                                                                      \
		_check(c);                                                                                                                                                                                                                                      \
	...
	__a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k, L l, M m, N n, O o, P p, Q q, R r)                                                                                                                                      \
	{                                                                                                                                                                                                                                                   \
		_check(a);                                                                                                                                                                                                                                      \
		_check(b);                                                                                                                                                                                                                                      \
		_check(c);                                                                                                                                                                                                                                      \
	...
	__a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k, L l, M m, N n, O o, P p, Q q, R r, S s)                                                                                                                                 \
	{                                                                                                                                                                                                                                                   \
		_check(a);                                                                                                                                                                                                                                      \
		_check(b);                                                                                                                                                                                                                                      \
		_check(c);                                                                                                                                                                                                                                      \
	...
	__a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k, L l, M m, N n, O o, P p, Q q, R r, S s, T t)                                                                                                                            \
	{                                                                                                                                                                                                                                                   \
		_check(a);                                                                                                                                                                                                                                      \
		_check(b);                                                                                                                                                                                                                                      \
		_check(c);                                                                                                                                                                                                                                      \
	...
	__a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k, L l, M m, N n, O o, P p, Q q, R r, S s, T t, U u)                                                                                                                       \
	{                                                                                                                                                                                                                                                   \
		_check(a);                                                                                                                                                                                                                                      \
		_check(b);                                                                                                                                                                                                                                      \
		_check(c);                                                                                                                                                                                                                                      \
	...
	__a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k, L l, M m, N n, O o, P p, Q q, R r, S s, T t, U u, V v)                                                                                                                  \
	{                                                                                                                                                                                                                                                   \
		_check(a);                                                                                                                                                                                                                                      \
		_check(b);                                                                                                                                                                                                                                      \
		_check(c);                                                                                                                                                                                                                                      \
	...
	__a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k, L l, M m, N n, O o, P p, Q q, R r, S s, T t, U u, V v, W w)                                                                                                             \
	{                                                                                                                                                                                                                                                   \
		_check(a);                                                                                                                                                                                                                                      \
		_check(b);                                                                                                                                                                                                                                      \
		_check(c);                                                                                                                                                                                                                                      \
		...
		_check(v);                                                                                                                                                                                                                                      \
		_check(w);                                                                                                                                                                                                                                      \
		__b(fmt, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w);                                                                                                                                                                  \
	}                                                                                                                                                                                                                                                   \
	...
	__a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k, L l, M m, N n, O o, P p, Q q, R r, S s, T t, U u, V v, W w, X x)                                                                                                        \
	{                                                                                                                                                                                                                                                   \
		_check(a);                                                                                                                                                                                                                                      \
		_check(b);                                                                                                                                                                                                                                      \
		_check(c);                                                                                                                                                                                                                                      \
		...
		_check(w);                                                                                                                                                                                                                                      \
		_check(x);                                                                                                                                                                                                                                      \
		__b(fmt, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x);                                                                                                                                                               \
	}                                                                                                                                                                                                                                                   \
	...
	__a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k, L l, M m, N n, O o, P p, Q q, R r, S s, T t, U u, V v, W w, X x, Y y)                                                                                                   \
	{                                                                                                                                                                                                                                                   \
		_check(a);                                                                                                                                                                                                                                      \
		_check(b);                                                                                                                                                                                                                                      \
		_check(c);                                                                                                                                                                                                                                      \
		...
		_check(x);                                                                                                                                                                                                                                      \
		_check(y);                                                                                                                                                                                                                                      \
		__b(fmt, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y);                                                                                                                                                            \
	}                                                                                                                                                                                                                                                   \
	...
	__a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k, L l, M m, N n, O o, P p, Q q, R r, S s, T t, U u, V v, W w, X x, Y y, Z z)                                                                                              \
	{                                                                                                                                                                                                                                                   \
		_check(a);                                                                                                                                                                                                                                      \
		_check(b);                                                                                                                                                                                                                                      \
		_check(c);                                                                                                                                                                                                                                      \
		...
		_check(y);                                                                                                                                                                                                                                      \
		_check(z);                                                                                                                                                                                                                                      \
		__b(fmt, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z);                                                                                                                                                         \
	}
