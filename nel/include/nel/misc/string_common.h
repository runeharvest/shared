 ...
 * This value is used when we have to create a standard C string buffer and we
 * don't know exactly the final size of the string.
 */
 ...
 *
 * This macro converts variable arguments into C string (zero terminated
 string).
 ...
 * \param _format format of the string, it must be the last argument before the
 \c '...'
...
/** sMart sprintf function. This function do a sprintf and add a zero at the end
 * of the buffer if there no enough room in the buffer.
 *
...
//
// These functions are needed by template system to failed the compilation if
// you pass bad type on nlinfo...
//
...
#define CHECK_TYPES(__a, __b)                                                  \
  ...
  template <class A> __a(const char *fmt, A a) {                               \
    _check(a);                                                                 \
    __b(fmt, a);                                                               \
  }                                                                            \
  template <class A, class B> __a(const char *fmt, A a, B b) {                 \
    _check(a);                                                                 \
    _check(b);                                                                 \
    __b(fmt, a, b);                                                            \
  }                                                                            \
  template <class A, class B, class C> __a(const char *fmt, A a, B b, C c) {   \
    _check(a);                                                                 \
    _check(b);                                                                 \
    _check(c);                                                                 \
    __b(fmt, a, b, c);                                                         \
  ...
  __a(const char *fmt, A a, B b, C c, D d) {                                   \
    _check(a);                                                                 \
    _check(b);                                                                 \
    _check(c);                                                                 \
    _check(d);                                                                 \
  ...
  __a(const char *fmt, A a, B b, C c, D d, E e) {                              \
    _check(a);                                                                 \
    _check(b);                                                                 \
    _check(c);                                                                 \
    _check(d);                                                                 \
  ...
  __a(const char *fmt, A a, B b, C c, D d, E e, F f) {                         \
    _check(a);                                                                 \
    _check(b);                                                                 \
    _check(c);                                                                 \
    _check(d);                                                                 \
  ...
  __a(const char *fmt, A a, B b, C c, D d, E e, F f, G g) {                    \
    _check(a);                                                                 \
    _check(b);                                                                 \
    _check(c);                                                                 \
    _check(d);                                                                 \
    ...
    _check(f);                                                                 \
    _check(g);                                                                 \
    __b(fmt, a, b, c, d, e, f, g);                                             \
  }                                                                            \
  template <class A, class B, class C, class D, class E, class F, class G,     \
            class H>                                                           \
  __a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h) {               \
    _check(a);                                                                 \
    _check(b);                                                                 \
    _check(c);                                                                 \
    _check(d);                                                                 \
    ...
    _check(g);                                                                 \
    _check(h);                                                                 \
    __b(fmt, a, b, c, d, e, f, g, h);                                          \
  }                                                                            \
  template <class A, class B, class C, class D, class E, class F, class G,     \
            class H, class I>                                                  \
  __a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i) {          \
    _check(a);                                                                 \
    _check(b);                                                                 \
    _check(c);                                                                 \
    _check(d);                                                                 \
    ...
    _check(h);                                                                 \
    _check(i);                                                                 \
    __b(fmt, a, b, c, d, e, f, g, h, i);                                       \
  }                                                                            \
  template <class A, class B, class C, class D, class E, class F, class G,     \
            class H, class I, class J>                                         \
  __a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j) {     \
    _check(a);                                                                 \
    _check(b);                                                                 \
    _check(c);                                                                 \
    _check(d);                                                                 \
  ...
  __a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j,       \
    ...
    _check(j);                                                                 \
    _check(k);                                                                 \
    __b(fmt, a, b, c, d, e, f, g, h, i, j, k);                                 \
  }                                                                            \
  template <class A, class B, class C, class D, class E, class F, class G,     \
            class H, class I, class J, class K, class L>                       \
  __a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k,  \
      L l) {                                                                   \
    _check(a);                                                                 \
    _check(b);                                                                 \
    _check(c);                                                                 \
    ...
    _check(k);                                                                 \
    _check(l);                                                                 \
    __b(fmt, a, b, c, d, e, f, g, h, i, j, k, l);                              \
  }                                                                            \
  template <class A, class B, class C, class D, class E, class F, class G,     \
  ...
  __a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k,  \
    ...
    _check(l);                                                                 \
    _check(m);                                                                 \
    __b(fmt, a, b, c, d, e, f, g, h, i, j, k, l, m);                           \
  }                                                                            \
  template <class A, class B, class C, class D, class E, class F, class G,     \
  ...
  __a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k,  \
    ...
    _check(m);                                                                 \
    _check(n);                                                                 \
    __b(fmt, a, b, c, d, e, f, g, h, i, j, k, l, m, n);                        \
  }                                                                            \
  template <class A, class B, class C, class D, class E, class F, class G,     \
            class H, class I, class J, class K, class L, class M, class N,     \
            class O>                                                           \
  __a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k,  \
    ...
    _check(n);                                                                 \
    _check(o);                                                                 \
    __b(fmt, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o);                     \
  }                                                                            \
  template <class A, class B, class C, class D, class E, class F, class G,     \
            class H, class I, class J, class K, class L, class M, class N,     \
            class O, class P>                                                  \
  __a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k,  \
    ...
    _check(o);                                                                 \
    _check(p);                                                                 \
    __b(fmt, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p);                  \
  }                                                                            \
  template <class A, class B, class C, class D, class E, class F, class G,     \
            class H, class I, class J, class K, class L, class M, class N,     \
  ...
  __a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k,  \
    ...
    _check(p);                                                                 \
    _check(q);                                                                 \
    __b(fmt, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q);               \
  }                                                                            \
  template <class A, class B, class C, class D, class E, class F, class G,     \
            class H, class I, class J, class K, class L, class M, class N,     \
            class O, class P, class Q, class R>                                \
  __a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k,  \
    ...
    _check(q);                                                                 \
    _check(r);                                                                 \
    __b(fmt, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r);            \
  }                                                                            \
  template <class A, class B, class C, class D, class E, class F, class G,     \
            class H, class I, class J, class K, class L, class M, class N,     \
            class O, class P, class Q, class R, class S>                       \
  __a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k,  \
    ...
    _check(r);                                                                 \
    _check(s);                                                                 \
    __b(fmt, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s);         \
  }                                                                            \
  template <class A, class B, class C, class D, class E, class F, class G,     \
            class H, class I, class J, class K, class L, class M, class N,     \
            class O, class P, class Q, class R, class S, class T>              \
  __a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k,  \
    ...
    _check(s);                                                                 \
    _check(t);                                                                 \
    __b(fmt, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t);      \
  }                                                                            \
  template <class A, class B, class C, class D, class E, class F, class G,     \
            class H, class I, class J, class K, class L, class M, class N,     \
            class O, class P, class Q, class R, class S, class T, class U>     \
  __a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k,  \
    ...
    _check(t);                                                                 \
    _check(u);                                                                 \
    __b(fmt, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u);   \
  }                                                                            \
  template <class A, class B, class C, class D, class E, class F, class G,     \
            class H, class I, class J, class K, class L, class M, class N,     \
            class O, class P, class Q, class R, class S, class T, class U,     \
  ...
  __a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k,  \
    ...
    _check(v);                                                                 \
    _check(w);                                                                 \
    __b(fmt, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, \
        w);                                                                    \
  }                                                                            \
  template <class A, class B, class C, class D, class E, class F, class G,     \
            class H, class I, class J, class K, class L, class M, class N,     \
  ...
  template <class A, class B, class C, class D, class E, class F, class G,     \
            class H, class I, class J, class K, class L, class M, class N,     \
            class O, class P, class Q, class R, class S, class T, class U,     \
            class V, class W, class X, class Y>                                \
  __a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k,  \
  ...
  template <class A, class B, class C, class D, class E, class F, class G,     \
            class H, class I, class J, class K, class L, class M, class N,     \
            class O, class P, class Q, class R, class S, class T, class U,     \
            class V, class W, class X, class Y, class Z>                       \
  __a(const char *fmt, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k,  \
      L l, M m, N n, O o, P p, Q q, R r, S s, T t, U u, V v, W w, X x, Y y,    \
      Z z) {                                                                   \
    _check(a);                                                                 \
...
template <class T> std::string toStringEnum(const T &val) {
  return toString("%u", (uint32)val);
}

/**
 * Template Object toString.
 * \param obj any object providing a "std::string toString()" method. The object
 * doesn't have to derive from anything.
 *
 * the VC++ error "error C2228: left of '.toString' must have class/struct/union
 * type" means you don't provide a toString() method to your object.
 */
template <class T> std::string toString(const T &obj) { return obj.toString(); }

// inline std::string toString(const char *val) { return toString("%s", val); }
inline std::string toString(const uint8 &val) {
  return toString("%hu", (uint16)val);
}
inline std::string toString(const sint8 &val) {
  return toString("%hd", (sint16)val);
}
...
inline std::string toString(const uint64 &val) {
  return toString("%" NL_I64 "u", val);
}
inline std::string toString(const sint64 &val) {
  return toString("%" NL_I64 "d", val);
}
...
// stl vectors of bool use bit reference and not real bools, so define the
// operator for bit reference
...
template <class T> bool fromString(const std::string &str, T &obj) {
  return obj.fromString(str);
}

inline bool fromString(const std::string &str, uint32 &val) {
...
inline bool fromString(const std::string &str, sint32 &val) {
  char *end;
  long v;
  errno = 0;
...
inline bool fromString(const std::string &str, uint8 &val) {
  char *end;
  long v;
  errno = 0;
  v = strtol(str.c_str(), &end, 10);
...
inline bool fromString(const std::string &str, sint8 &val) {
  char *end;
  long v;
  errno = 0;
  v = strtol(str.c_str(), &end, 10);
...
inline bool fromString(const std::string &str, uint16 &val) {
  char *end;
  long v;
  errno = 0;
  v = strtol(str.c_str(), &end, 10);
  if (errno || v > USHRT_MAX || v < 0 || end == str.c_str()) {
    val = 0;
    return false;
  } else {
    val = (uint16)v;
...
inline bool fromString(const std::string &str, sint16 &val) {
  char *end;
  long v;
  errno = 0;
  v = strtol(str.c_str(), &end, 10);
  if (errno || v > SHRT_MAX || v < SHRT_MIN || end == str.c_str()) {
    val = 0;
    return false;
  } else {
    val = (sint16)v;
...
inline bool fromString(const std::string &str, uint64 &val) {
  bool ret = sscanf(str.c_str(), "%" NL_I64 "u", &val) == 1;
  if (!ret)
    val = 0;
  return ret;
}
inline bool fromString(const std::string &str, sint64 &val) {
  bool ret = sscanf(str.c_str(), "%" NL_I64 "d", &val) == 1;
  if (!ret)
    val = 0;
  return ret;
}
inline bool fromString(const std::string &str, float &val) {
  bool ret = sscanf(str.c_str(), "%f", &val) == 1;
  if (!ret)
    val = 0.0f;
  return ret;
}
inline bool fromString(const std::string &str, double &val) {
  bool ret = sscanf(str.c_str(), "%lf", &val) == 1;
  if (!ret)
    val = 0.0;
  return ret;
}
...
/// Fast string to bool, reliably defined for strings starting with 0, 1, t, T,
/// f, F, y, Y, n, N, and empty strings, anything else is undefined.
///  - Kaetemi
inline bool toBool(const char *str) {
  return str[0] == '1' || (str[0] & 0xD2) == 0x50;
}
inline bool toBool(const std::string &str) {
  return toBool(str.c_str());
} // Safe because first byte may be null
...
inline bool fromString(const std::string &str, sint &val) {
...
inline bool endsWith(const char *str, size_t strLen, const char *suffix,
                     size_t suffixLen) {
  if (strLen < suffixLen)
    return false;
...
inline bool endsWith(const std::string &str, const char *suffix) {
  return endsWith(str.c_str(), str.size(), suffix, strlen(suffix));
}
inline bool endsWith(const std::string &str, const std::string &suffix) {
  return endsWith(str.c_str(), str.size(), suffix.c_str(), suffix.size());
}
...
inline std::string tStrToUtf8(const tchar *str) {
  return wideToUtf8((const wchar_t *)str);
}
inline std::string tStrToUtf8(const tstring &str) {
  return wideToUtf8((const std::wstring &)str);
}
inline std::wstring tStrToWide(const tchar *str) {
  return (const wchar_t *)str;
}
inline std::wstring tStrToWide(const tstring &str) {
  return (const std::wstring &)str;
}
inline std::string tStrToMbcs(const tchar *str) {
  return wideToMbcs((const wchar_t *)str);
}
inline std::string tStrToMbcs(const tstring &str) {
  return wideToMbcs((const std::wstring &)str);
}
...
inline tstring utf8ToTStr(const std::string &str) {
  return (const tstring &)utf8ToWide(str);
}
inline tstring wideToTStr(const wchar_t *str) { return (const tchar *)str; }
inline tstring wideToTStr(const std::wstring &str) {
  return (const tstring &)str;
}
inline tstring mbcsToTStr(const char *str) {
  return (const tstring &)mbcsToWide(str);
}
inline tstring mbcsToTStr(const std::string &str) {
  return (const tstring &)mbcsToWide(str);
}
...
typedef char tchar;
inline std::string tStrToUtf8(const tchar *str) {
  return mbcsToUtf8((const char *)str);
}
inline std::string tStrToUtf8(const tstring &str) {
  return mbcsToUtf8((const std::string &)str);
}
inline std::wstring tStrToWide(const tchar *str) {
  return mbcsToWide((const char *)str);
}
inline std::wstring tStrToWide(const tstring &str) {
  return mbcsToWide((const std::string &)str);
}
...
inline tstring wideToTStr(const wchar_t *str) {
  return (const tstring &)wideToMbcs(str);
}
inline tstring wideToTStr(const std::wstring &str) {
  return (const tstring &)wideToMbcs(str);
}
