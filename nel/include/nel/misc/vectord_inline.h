...
inline CVectorD &CVectorD::operator/=(double f) { return *this *= (1.0f / f); }
...
inline CVectorD CVectorD::operator-() const { return CVectorD(-x, -y, -z); }
...
inline bool CVectorD::isNull() const { return *this == CVectorD::Null; }
inline void CVectorD::cartesianToSpheric(double &r, double &theta,
                                         double &phi) const {
  CVectorD v;
...
inline void CVectorD::serial(IStream &f) { f.serial(x, y, z); }
