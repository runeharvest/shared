...
public:
  ...
  inline sint32 getOldValue32() const {
    return (sint32)(_oldProperty & 0xffffffff);
  }
  inline sint16 getOldValue16() const {
    return (sint16)(_oldProperty & 0xffff);
  }
   ...
   */
  void init(xmlNodePtr node, IProgressCallback &progressCallBack,
  ...
  /// Count the leaves
  virtual uint countLeaves() const { return 1; }
