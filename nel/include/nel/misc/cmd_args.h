...
public:
  ...
  struct TArg {
    ...
    std::string
        helpDescription; // description of argument in help. Eg: Specifies the
                         // directory where to write generated files
    bool onlyOnce; // only one argument of this type is used, if several are
                   // provided, only the last one is kept
  ...
  /// helpName is the name that will be displayed in help if it's a required
  /// argument helpDescription is the description of the argument that will be
  /// displayed in help onlyOnce can be set to false, if we allows to use this
  /// argument more than once
  void addArg(const std::string &shortName, const std::string &longName,
              const std::string &helpName, const std::string &helpDescription,
              bool onlyOnce = true);
  ...
  /// argument helpDescription is the description of the argument that will be
  /// displayed in help onlyOnce can be set to false, if we allows to use this
  /// argument more than once required can be set to false, if this argument is
  /// required
  void addAdditionalArg(const std::string &name,
                        const std::string &helpDescription,
                        bool onlyOnce = true, bool required = true);

  /// Parse the command line from main() parameters argc and argv and process
  /// default arguments.
  ...
  /// Parse the command linefrom a std::vector<std::string> and process default
  /// arguments.
   ...
   * -p"C:\Documents and Settings\toto.tmp" is in the command line
   */
