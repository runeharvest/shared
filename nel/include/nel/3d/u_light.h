...
public:
  ...
  virtual void setupDirectional(const NLMISC::CRGBA &ambiant,
                                const NLMISC::CRGBA &diffuse,
                                const NLMISC::CRGBA &specular,
                                const NLMISC::CVector &direction,
                                float constant = 1, float linear = 0,
                                float quadratic = 0) = 0;

  /// Quick setup a point light
  virtual void setupPointLight(const NLMISC::CRGBA &ambiant,
                               const NLMISC::CRGBA &diffuse,
                               const NLMISC::CRGBA &specular,
   ...
   */
  virtual void setupAttenuation(float farAttenuationBegin,
