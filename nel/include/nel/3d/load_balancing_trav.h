...
public:
  ...
  /// Compute the number of face to be rendered for thismodel, according to the
  /// number of faces he want to draw
...
public:
  ...
  /// Get the last face count asked from the instances before reduction. Sum of
  /// all groups
