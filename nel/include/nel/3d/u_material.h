...
// ***************************************************************************
/**
 * Game Interface for Material. Material for gamers are Unlighted materials!!
 * Only normal material unlighted is supported. \author Lionel Berenguier
...
public:
   ...
   * EMBM : apply to both color and alpha : the current texture, whose format is
   *DSDT, is used to offset the texture in the next stage. NB : for EMBM and
   *InterpolateConstant, this must be supported by driver.
   */
  enum TTexOperator {
    Replace = 0,
    Modulate,
...
public:
  ...
  /// \name Lighted material mgt. Relevant only if isLighted(). Used for get of
  /// UShape
  // @{
