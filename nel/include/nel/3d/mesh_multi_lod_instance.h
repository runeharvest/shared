...
// ***************************************************************************
// ClassIds.
const NLMISC::CClassId MeshMultiLodInstanceId =
    NLMISC::CClassId(0x1ade6ef8, 0x75c5a84);
...
public:
  ...
  const CLightContribution &getLightContribution() {
...
private:
  ...
  /// Coarse mesh transformed and Lighted. NB: array allocated at instanciation.
  /// => no allocation during time.
