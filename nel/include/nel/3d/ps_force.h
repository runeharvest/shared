...
public:
	...
	virtual void integrate(float /* date */, CPSLocated * /* src */, uint32 /* startIndex */, uint32 /* numObjects */, NLMISC::CVector * /* destPos */ = NULL, NLMISC::CVector * /* destSpeed */ = NULL,
	    ...
	    uint /* posStride */ = sizeof(NLMISC::CVector), uint /* speedStride */ = sizeof(NLMISC::CVector)) const
	{
...
template <class T>
class CIsotropicForceT : public CPSForce
{
public:
...
template <class T>
void CIsotropicForceT<T>::computeForces(CPSLocated &target)
{
...
#endif
	    void
	    operator()(const NLMISC::CVector & /* pos */, NLMISC::CVector &speed, float invMass)
	{
