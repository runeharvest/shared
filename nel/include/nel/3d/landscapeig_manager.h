...
// ***************************************************************************
/**
 * This class is used to load and unload IG of landscape. Used in conjunction
 * with ULandscape. \author Lionel Berenguier \author Nevrax France \date 2001
 */
...
public:
   ...
   *	the file is just a list of filename eg: "150_EM.ig", separated with
   *return. At this time, All UInstanceGroup are loaded, but none are
   *addToScene() ed.
   */
  void initIG(UScene *scene, const std::string &igDesc, UDriver *driver,
              uint selectedTexture, NLMISC::IProgressCallback *callBack);
  ...
  /// unload and delete all the zoneIgs. Call before deletion of the scene (else
  /// exception).
  void reset();
