...
public:
   ...
   *	clamp(attenuationBegin,0 , +oo) and clamp(attenuationEnd,
   *attenuationBegin, +oo) By default, attenuation is 10-30. PERFORMANCE
   *WARNING: big lights (disabled attenuation and big attenuationEnd) slow down
  ...
  /** Setup SpotLight. SpotLight is disabled by default. The direction of the
   *spot is lead by the J vector of the UPointLight WorldMatrix
   */
  ...
  UPointLight(class CPointLightModel *object) {
    _Object = (ITransformable *)object;
  };
  /// Attach an object to this proxy
  void attach(class CPointLightModel *object) {
    _Object = (ITransformable *)object;
  }
  /// Detach the object
  ...
  class CPointLightModel *getObjectPtr() const {
    return (CPointLightModel *)_Object;
  }
};
