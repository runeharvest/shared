...
// ***************************************************************************
// ClassIds.
const NLMISC::CClassId MeshInstanceId =
    NLMISC::CClassId(0x6bfe0a34, 0x23b26dc9);

// ***************************************************************************
/**
 * An instance of CMesh.
 * no special traverse, since same functionnality as CMeshBaseInstance.
 *	NB: CMeshInstance support shadowMap casting ONLY for an easy Demo /
 *Test. No Lod mgt, and No good shadow clip. \author Lionel Berenguier \author
