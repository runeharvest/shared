 ...
 */
class CPSFanLight : public CPSParticle,
...
public:
  ...
  uint32 getNbFans(void) const { return _NbFans; }

  /** Set the speed for phase
   *	If the located holding this particle as a limited lifetime, it gives how
   *many 0-2Pi cycle it'll do during its life Otherwise it gives how many cycle
  ...
  void setTexture(CSmartPtr<ITexture> tex) { _Tex = tex; }
