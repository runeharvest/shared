...
public:
  ...
  /// Load all Zones around a position. Call at init only!! (no zone must exist
  /// before). This is a blocking call.
  ...
  virtual void setTileColor(bool monochrome, float factor) {
    _ZoneManager.setZoneTileColor(monochrome, factor);
  }
  // @}
  ...
  virtual void show() { _Landscape->show(); }
  virtual void hide() { _Landscape->hide(); }
...
public:
  ...
  // @{
  CLandscapeModel *getLandscape() { return _Landscape; }
  // @}
};
