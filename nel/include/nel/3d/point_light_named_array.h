...
// ***************************************************************************
/**
 * A class used bi CInstanceGroup and CZone. Just a list of pointLights, grouped
 * by name. \author Lionel Berenguier \author Nevrax France \date 2001
 */
...
public:
   ...
   */
  void build(const std::vector<CPointLightNamed> &pointLights,
...
private:
  ...
  struct CPointLightGroup {
    ...
    CPointLightGroup() { AnimationLightIndex = -1; }
  ...
  struct CPointLightGroupV0 {
    ...
    void serial(NLMISC::IStream &f) { f.serial(StartId, EndId); }
  };
