...
class CPSShockWave : public CPSParticle,
...
public:
  /** ctor
   *  \param nbSeg : number of seg for the circonference of the shockwave. must
   * be >= 3 and <= 64. \param radiusCut : indicate how much to subtract to the
   * outter radius to get the inner radius \param  tex : the texture that must
   * be applied to the shockwave
   */
  CPSShockWave(uint nbSeg = 9, float radiusCut = 0.8f,
