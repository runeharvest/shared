...
public:
  ...
  // a vector of couple of float used with rasters (first is the left pos, and
  // second is the right pos)
   ...
   */
  static void makeRasters(const TPoint2DVect &poly, float quadWidth,
   ...
   * \param quadWidth width of the quad
   * \param quadHeight height of the quad
   * \param dest a vector that will contains the pos of all the quads that cover
   * the poly
   */
  static void processPoly(const TPoint2DVect &poly, float quadWidth,
