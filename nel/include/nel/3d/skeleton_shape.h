...
public:
   ...
   * WARNING: bones must be organized in Depth-first order (this is not
   * checked). Bone.LodDisableDistance are minimized such sons have always a
   * distance <= father distance.
   */
