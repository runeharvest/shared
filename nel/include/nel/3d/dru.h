...
{
	EDruOpenglDriverNotFound()
	    : EDru(NL3D_GL_DLL_NAME " not found")
	{
	}
};
...
struct EDruOpenglDriverCorrupted : public EDru
{
	EDruOpenglDriverCorrupted()
	    : EDru("Can't get NL3D_createIDriverInstance from " NL3D_GL_DLL_NAME " (Bad dll?)")
	{
	}
};
...
struct EDruOpenglDriverOldVersion : public EDru
{
	EDruOpenglDriverOldVersion()
	    : EDru(NL3D_GL_DLL_NAME " is a too old version. Ask for a more recent file")
	{
	}
};
...
{
	EDruOpenglEsDriverNotFound()
	    : EDru(NL3D_GLES_DLL_NAME " not found")
	{
	}
};
...
struct EDruOpenglEsDriverCorrupted : public EDru
{
	EDruOpenglEsDriverCorrupted()
	    : EDru("Can't get NL3D_createIDriverInstance from " NL3D_GLES_DLL_NAME " (Bad dll?)")
	{
	}
};
...
{
	EDruDirect3dDriverNotFound()
	    : EDru(NL3D_D3D_DLL_NAME " not found")
	{
	}
};
...
struct EDruDirect3dDriverCorrupted : public EDru
{
	EDruDirect3dDriverCorrupted()
	    : EDru("Can't get NL3D_createIDriverInstance from " NL3D_D3D_DLL_NAME " (Bad dll?)")
	{
	}
};
...
struct EDruDirect3dDriverOldVersion : public EDru
{
	EDruDirect3dDriverOldVersion()
	    : EDru(NL3D_D3D_DLL_NAME " is a too old version. Ask for a more recent file")
	{
	}
};
