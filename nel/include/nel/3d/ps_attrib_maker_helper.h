...
private:
	...
	void makeByIterator(It it,
	    void *tab,
	    uint32 stride,
	    uint32 numAttrib,
	    bool canOverlapOne,
	    bool forceClampEntry) const
	{
		uint8 *pt = (uint8 *)tab;
	 ...
	 */
	template <typename It>
	void makeNByIterator(It it, void *tab, uint32 stride, uint32 numAttrib, uint32 nbReplicate, bool canOverlapOne) const
	{
...
public:
	// default ctor
	CPSAttribMakerMemory()
	    : CPSAttribMakerMemoryBase<uint32>()
	{
	}
	// copy ctor
...
public:
	// default ctor
	CPSAttribMakerMemory()
	    : CPSAttribMakerMemoryBase<sint32>()
	{
	}
	// copy ctor
...
public:
	// default ctor
	CPSAttribMakerMemory()
	    : CPSAttribMakerMemoryBase<float>()
	{
	}
	// copy ctor
