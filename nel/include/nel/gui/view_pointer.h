...
public:
  ...
  /// Show or hide the pointer. Please, use SetMouseMode (bool freelook)
  /// instead.
...
private:
  ...
  virtual bool drawRotate(CCtrlBase * /* pCB */, NLMISC::CRGBA /* col */) {
    return false;
  }
  virtual bool drawScale(CCtrlBase * /* pCB */, NLMISC::CRGBA /* col */) {
    return false;
  }
  ...
  virtual bool drawPan(CCtrlBase * /* pCB */, NLMISC::CRGBA /* col */) {
    return false;
  }
...
protected:
  ...
  // draw current cursor with the given texture, or, if in hardware mode, change
  // the hardware cursor shape
