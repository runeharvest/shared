...
public:
	...
	{
		return NLMISC::toString(_ColorNormal.R) + " " + NLMISC::toString(_ColorNormal.G) + " " + NLMISC::toString(_ColorNormal.B) + " " + NLMISC::toString(_ColorNormal.A);
	}
	...
	{
		return NLMISC::toString(_ColorPushed.R) + " " + NLMISC::toString(_ColorPushed.G) + " " + NLMISC::toString(_ColorPushed.B) + " " + NLMISC::toString(_ColorPushed.A);
	}
	...
	void setActionOnLeftClick(const std::string &actionHandlerName)
	{
		...
		_AHOnLeftClick = CAHManager::getInstance()->getAH(actionHandlerName, _AHLeftClickParams);
	}
