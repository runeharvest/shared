...
public:
  ...
  /// Draw the view from XReal, YReal, WReal, HReal (implemented by derived
  /// classes) this coordinates are relative to the screen bottom left and
  /// begins the bottom left of the view
  virtual void draw() = 0;
  ...
  /// Handle all events (implemented by derived classes) (return true to signal
  /// event handled)
