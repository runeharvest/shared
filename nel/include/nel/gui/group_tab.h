 ...
 *	NB: controlled groups doesn't have to be child of the GroupTab, they are
 *searched in order:
 *		- in this group
 *		- in the parent group
 *		- in global
...
public:
  ...
  REFLECT_STRING("associatedGroupSelection", getAssociatedGroupSelection,
                 setAssociatedGroupSelection)
  REFLECT_EXPORT_END
