...
public:
	...
	ELuaError(const std::string &reason)
	    : Exception(reason)
	{
...
public:
	ELuaParseError() { }
	ELuaParseError(const std::string &reason)
	    : ELuaError(reason)
	{
	}
...
public:
	ELuaExecuteError() { }
	ELuaExecuteError(const std::string &reason)
	    : ELuaError(reason)
	{
	}
...
public:
	ELuaBadCast() { }
	ELuaBadCast(const std::string &reason)
	    : ELuaError(reason)
	{
	}
	// what(), plus append the Reason
...
public:
	ELuaNotATable() { }
	ELuaNotATable(const std::string &reason)
	    : ELuaError(reason)
	{
	}
	// what(), plus append the Reason
