...
public:
  ...
  void basicSet(sint32 x, sint32 y, sint32 PosX, sint32 PosY,
  ...
  uint8
  getCutEdge(sint32 x, sint32 y,
             uint8 pos) const; // pos==0 -> getUpCE, pos==1 -> getDownCE, ...
  uint32 getDate(sint32 x, sint32 y,
  ...
  bool setSharingMatNames(sint32 x, sint32 y, uint edge,
...
protected:
  ...
  struct SZoneUnit {
    ...
    uint8 Rot,
        Flip; // Rot 0-0deg, 1-90deg, 2-180deg, 3-270deg, Flip 0-false, 1-true
