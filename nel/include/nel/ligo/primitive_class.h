...
public:
  ...
  enum TType { Node, Point, Path, Bitmap, Zone, Alias } Type;
  ...
  public:
    ...
    bool translateAutoname(std::string &result, const IPrimitive &primitive,
                           const CPrimitiveClass &primitiveClass) const;

    // Get a default value
    bool getDefaultValue(std::string &result, const IPrimitive &primitive,
                         const CPrimitiveClass &primitiveClass,
                         std::string *fromWhere = NULL) const;
    bool getDefaultValue(std::vector<std::string> &result,
  ...
  // Read
  bool read(xmlNodePtr primitiveNode, const char *filename,
            const char *className, std::set<std::string> &contextStrings,
            std::map<std::string, std::string> &contextFilesLookup,
            NLLIGO::CLigoConfig &config, bool parsePrimitiveComboContent);
};
