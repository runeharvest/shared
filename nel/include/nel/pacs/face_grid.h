...
/**
 * A selection grid for the interior faces. It contains the indexes of the
 * faces, as uint32. \author Benjamin Legros \author Nevrax France \date 2001
 */
class CFaceGrid {
public:
  /**
  ...
  public:
    ...
    void insert(const NLMISC::CVector &bmin, const NLMISC::CVector &bmax,
                uint32 value);
  };
...
inline void CFaceGrid::select(const NLMISC::CVector &pos,
                              std::vector<uint32> &selected) const {
  selected.clear();
...
inline void CFaceGrid::CFaceGridBuild::insert(const NLMISC::CVector &bmin,
                                              ...
                                              uint32 value) {
  sint x0 = (sint)(bmin.x / Size), x1 = (sint)(bmax.x / Size),
       y0 = (sint)(bmin.y / Size), y1 = (sint)(bmax.y / Size);
