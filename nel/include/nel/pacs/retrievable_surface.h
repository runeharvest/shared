...
/**
 * The various features of the models (precisely, the indexes to the table of
 * features).
 */
enum {
...
protected:
  ...
  /// A Height QuadTree that allows to easily find the height out for a given 2D
  /// point. -- deprecated
...
public:
  ...
  bool isUnderWater() const {
    return (_Flags & (1 << CRetrievableSurface::IsUnderWaterBit)) != 0;
  }
