...
public:
  CStreamSource(CStreamSound *streamSound = NULL, bool spawn = false,
...
public:
  ...
  /// to the listener position (default: false)
  ...
  /// Prepare the buffers in this stream for the given maximum capacity. (TODO:
  /// Move this into UStreamSource)
...
protected:
  ...
  /// Try to capture a physical source for this logical source. Use
  /// hasPhysicalSource to verify. Called when source needs to start playing.
  void initPhysicalSource();

  /// Free the physical source for re-use by another logical source. Called when
  /// source stops playing.
  ...
  /// True when the sound is played muted and until the mixer event notifying
  /// the end.
  // bool							m_PlayMuted;
