 ...
 */
class CComplexSource : public CSourceCommon,
                       public CAudioMixerUser::IMixerEvent,
                       public CAudioMixerUser::IMixerUpdate {
public:
  /// Constructor
  CComplexSource(CComplexSound *soundPattern = NULL, bool spawn = false,
  ...
  //TSoundPriority pr, bool redispatch=true );
  ...
  //	virtual void					getPos( NLMISC::CVector&
  //pos ) const;
   ...
   * gain (which is getSource()->getGain()). Does nothing if getSource() is
   * null.
   */
  ...
  //	virtual void					setSourceRelativeMode(
  //bool mode );
  /// Get the source relative mode
  //	virtual bool					getSourceRelativeMode()
  //const;
...
private:
  ...
  void onEvent();
  /// Do the dirty work of starting to play. Called by play and by setGain or
  /// setRelativeGain when the source is muted.
  void playStuf();
