...
CSampleBankManager::CSampleBankManager(CAudioMixerUser *audioMixer)
    : m_AudioMixer(audioMixer), m_LoadedSize(0) {}

CSampleBankManager::~CSampleBankManager() { releaseAll(); }
...
CSampleBank *
CSampleBankManager::findSampleBank(const NLMISC::TStringId &filename) {
...
void CSampleBankManager::getLoadedSampleBankInfo(
