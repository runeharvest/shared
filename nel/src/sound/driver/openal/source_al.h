 ...
 * OpenAL sound source
 *
 * Note: the creation/deletion of sources and the setting of their rolloff
 * factor are done in CSoundDriverAL.
 *
...
public:
  ...
  /// (Internal) Update the manual rolloff, only called when using manual
  /// rolloff.
