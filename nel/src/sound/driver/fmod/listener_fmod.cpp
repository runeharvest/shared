...
CListenerFMod::CListenerFMod() //: IListener()
    : _Pos(CVector::Null), _Vel(CVector::Null), _Front(CVector::J),
      _Up(CVector::K) {
  _RolloffFactor = 1.f;
  _Pos = CVector::Null;
  _Vel = CVector::Null;
...
// ***************************************************************************
const NLMISC::CVector &CListenerFMod::getPos() const { return _Pos; }
...
// ***************************************************************************
void CListenerFMod::getVelocity(NLMISC::CVector &vel) const { vel = _Vel; }

// ***************************************************************************
void CListenerFMod::setOrientation(const NLMISC::CVector &front,
...
// ***************************************************************************
void CListenerFMod::getOrientation(NLMISC::CVector &front,
...
// ***************************************************************************
float CListenerFMod::getRolloffFactor() { return _RolloffFactor; }
...
// ***************************************************************************
void CListenerFMod::setEAXProperty(uint /* prop */, void * /* value */,
                                   uint /* valuesize */) {
  // TODO_EAX
}
...
void CListenerFMod::updateFModPos() {
  ...
  FSOUND_3D_Listener_SetAttributes(pos, vel, front[0], front[1], front[2],
                                   up[0], up[1], up[2]);
}
