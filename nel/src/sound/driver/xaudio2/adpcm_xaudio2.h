 ...
 * CAdpcmXAudio2 is a utility class for realtime streaming and decoding of Intel
 * ADPCM data to an XAudio2 source voice.
 */
...
protected:
  ...
  uint _AdpcmSize;
  /// Samples for 50ms. Also size in uint16 for 100ms PCM. (50ms 16bit PCM in
  /// uint16 = _SampleRate / 20)
  uint _SampleNb;
...
public:
  ...
  inline void setSourceVoice(IXAudio2SourceVoice *sourceVoice) {
  ...
  /// Plays as soon as submitted (if sourcevoice is playing).
