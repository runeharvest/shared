...
bool CFormElm::isArray() const { return false; }
...
bool CFormElm::getArrayNode(const UFormElm ** /* result */,
                            uint /* arrayIndex */) const {
...
bool CFormElm::getArrayNodeName(std::string & /* result */,
                                uint /* arrayIndex */) const {
...
bool CFormElm::getArrayValue(std::string & /* result */, uint /* arrayIndex */,
                             TEval /* evaluate */,
                             TWhereIsValue * /* where */) const {
  warning(false, "getArrayNode", "This node is not an array.");
  return false;
}
...
bool CFormElm::getArrayValue(sint8 & /* result */, uint /* arrayIndex */,
                             TEval /* evaluate */,
                             TWhereIsValue * /* where */) const {
...
bool CFormElm::getArrayValue(uint8 & /* result */, uint /* arrayIndex */,
                             TEval /* evaluate */,
                             TWhereIsValue * /* where */) const {
  warning(false, "getArrayValue", "This node is not an array.");
  return false;
...
bool CFormElm::getArrayValue(sint16 & /* result */, uint /* arrayIndex */,
                             TEval /* evaluate */,
                             TWhereIsValue * /* where */) const {
  warning(false, "getArrayValue", "This node is not an array.");
  return false;
...
bool CFormElm::getArrayValue(uint16 & /* result */, uint /* arrayIndex */,
                             TEval /* evaluate */,
                             TWhereIsValue * /* where */) const {
  warning(false, "getArrayValue", "This node is not an array.");
  return false;
...
bool CFormElm::getArrayValue(sint32 & /* result */, uint /* arrayIndex */,
                             TEval /* evaluate */,
                             TWhereIsValue * /* where */) const {
  warning(false, "getArrayValue", "This node is not an array.");
  return false;
...
bool CFormElm::getArrayValue(uint32 & /* result */, uint /* arrayIndex */,
                             TEval /* evaluate */,
                             TWhereIsValue * /* where */) const {
  warning(false, "getArrayValue", "This node is not an array.");
  return false;
...
bool CFormElm::getArrayValue(float & /* result */, uint /* arrayIndex */,
                             TEval /* evaluate */,
                             TWhereIsValue * /* where */) const {
  warning(false, "getArrayValue", "This node is not an array.");
  return false;
...
bool CFormElm::getArrayValue(double & /* result */, uint /* arrayIndex */,
                             TEval /* evaluate */,
                             TWhereIsValue * /* where */) const {
  warning(false, "getArrayValue", "This node is not an array.");
  return false;
...
bool CFormElm::getArrayValue(bool & /* result */, uint /* arrayIndex */,
                             TEval /* evaluate */,
                             TWhereIsValue * /* where */) const {
  warning(false, "getArrayValue", "This node is not an array.");
  return false;
...
bool CFormElm::getArrayValue(NLMISC::CRGBA & /* result */,
                             uint /* arrayIndex */, TEval /* evaluate */,
                             TWhereIsValue * /* where */) const {
  warning(false, "getArrayValue", "This node is not an array.");
  return false;
}
...
bool CFormElm::isStruct() const { return false; }

// ***************************************************************************

bool CFormElm::isVirtualStruct() const { return false; }

// ***************************************************************************

bool CFormElm::getDfnName(std::string & /* dfnName */) const { return false; }
...
bool CFormElm::getStructNodeName(uint /* element */,
                                 string & /* result */) const {
...
bool CFormElm::getStructNode(uint /* element */,
                             const UFormElm ** /* result */) const {
...
bool CFormElm::isAtom() const { return false; }
...
bool CFormElm::getValue(NLMISC::CRGBA & /* result */,
                        TEval /* evaluate */) const {
  warning(false, "getValue", "This node is not an atom.");
  return false;
}
...
CFormElm::CFormElm(CForm *form, CFormElm *parentNode, const CFormDfn *parentDfn,
                   uint parentIndex) {
  Form = form;
...
bool CFormElm::isUsed(const CForm *form) const { return form == Form; }

// ***************************************************************************

CForm *CFormElm::getForm() const { return Form; }

// ***************************************************************************

bool CFormElm::getNodeByName(UFormElm **result, const std::string &name,
                             TWhereIsNode *where, bool verbose, uint32 round) {
  const UFormElm *resultConst = NULL;
  if (((const UFormElm *)this)
          ->getNodeByName(&resultConst, name, where, verbose, round)) {
...
bool CFormElm::getNodeByName(const UFormElm **result, const std::string &name,
                             TWhereIsNode *where, bool verbose,
                             uint32 round) const {
  // The parent Dfn
  ...
  // Search for the node
  if (getNodeByName(name, &parentDfn, indexDfn, &nodeDfn, &nodeType, &node,
                    type, array, parentVDfnArray, verbose, round)) {
    // Set the result
    *result = node;
...
bool CFormElm::getValueByName(string &result, const std::string &name,
                              TEval evaluate, TWhereIsValue *where,
                              uint32 round) const {
  // The parent Dfn
  const CFormDfn *parentDfn;
  const CFormDfn *nodeDfn;
  ...
  // Search for the node
  if (getNodeByName(name, &parentDfn, parentIndex, &nodeDfn, &nodeType, &node,
                    type, array, parentVDfnArray, true, round)) {
    // End, return the current index
    if (type == UFormDfn::EntryType) {
      // The atom
      const CFormElmAtom *atom =
          node ? safe_cast<const CFormElmAtom *>(node) : NULL;

      // Evale
      nlassert(nodeType);
      return (nodeType->getValue(result, Form, atom, *parentDfn, parentIndex,
                                 evaluate, (uint32 *)where, round, name));
    } else {
      // Error message
      warning(false, "getValueByName",
              "The node (%s) is not an atom element. Can't return a value.",
              name.c_str());
    }
  } else {
    // Error message
...
bool CFormElm::getValueByName(sint8 &result, const std::string &name,
                              TEval evaluate, TWhereIsValue *where,
                              uint32 round) const {
...
bool CFormElm::getValueByName(uint8 &result, const std::string &name,
                              TEval evaluate, TWhereIsValue *where,
                              uint32 round) const {
  // Get the string value
  string value;
...
bool CFormElm::getValueByName(sint16 &result, const std::string &name,
                              TEval evaluate, TWhereIsValue *where,
                              uint32 round) const {
  // Get the string value
  string value;
...
bool CFormElm::getValueByName(uint16 &result, const std::string &name,
                              TEval evaluate, TWhereIsValue *where,
                              uint32 round) const {
  // Get the string value
  string value;
...
bool CFormElm::getValueByName(sint32 &result, const std::string &name,
                              TEval evaluate, TWhereIsValue *where,
                              uint32 round) const {
  // Get the string value
  string value;
...
bool CFormElm::getValueByName(uint32 &result, const std::string &name,
                              TEval evaluate, TWhereIsValue *where,
                              uint32 round) const {
  // Get the string value
  string value;
...
bool CFormElm::getValueByName(float &result, const std::string &name,
                              TEval evaluate, TWhereIsValue *where,
                              uint32 round) const {
  // Get the string value
  string value;
...
bool CFormElm::getValueByName(double &result, const std::string &name,
                              TEval evaluate, TWhereIsValue *where,
                              uint32 round) const {
  // Get the string value
  string value;
...
bool CFormElm::getValueByName(bool &result, const std::string &name,
                              TEval evaluate, TWhereIsValue *where,
                              uint32 round) const {
  // Get the string value
  string value;
...
bool CFormElm::getValueByName(NLMISC::CRGBA &result, const std::string &name,
                              TEval evaluate, TWhereIsValue *where,
                              uint32 round) const {
  // Get the string value
  string value;
...
UFormElm *CFormElm::getParent() const { return ParentNode; }

// ***************************************************************************

bool CFormElm::createNodeByName(const std::string &name,
                                const CFormDfn **parentDfn, uint &indexDfn,
                                const CFormDfn **nodeDfn,
                                const CType **nodeType, CFormElm **node,
                                UFormDfn::TEntryType &type, bool &array,
                                bool &created) {
  *parentDfn = ParentDfn;
  ...
  *node = this;
  bool parentVDfnArray;
  return getInternalNodeByName(Form, name, parentDfn, indexDfn, nodeDfn,
                               nodeType, node, type, array, Create, created,
                               parentVDfnArray, true, NLGEORGES_FIRST_ROUND);
}

// ***************************************************************************

bool CFormElm::deleteNodeByName(const std::string &name,
                                const CFormDfn **parentDfn, uint &indexDfn,
                                const CFormDfn **nodeDfn,
                                const CType **nodeType, CFormElm **node,
                                UFormDfn::TEntryType &type, bool &array) {
  ...
  *node = this;
  ...
  bool parentVDfnArray;
  return getInternalNodeByName(Form, name, parentDfn, indexDfn, nodeDfn,
                               nodeType, node, type, array, Delete, created,
                               parentVDfnArray, true, NLGEORGES_FIRST_ROUND);
}

// ***************************************************************************

bool CFormElm::getNodeByName(const std::string &name,
                             const CFormDfn **parentDfn, uint &indexDfn,
                             const CFormDfn **nodeDfn, const CType **nodeType,
                             CFormElm **node, UFormDfn::TEntryType &type,
                             bool &array, bool &parentVDfnArray, bool verbose,
                             uint32 round) const {
  *parentDfn = ParentDfn;
  indexDfn = ParentIndex;
  *nodeDfn = NULL;
  ...
  *node = (CFormElm *)this;
  bool created;
  return getInternalNodeByName(Form, name, parentDfn, indexDfn, nodeDfn,
                               nodeType, node, type, array, Return, created,
                               parentVDfnArray, verbose, round);
}

// ***************************************************************************

bool CFormElm::arrayInsertNodeByName(const std::string &name,
                                     const CFormDfn **parentDfn, uint &indexDfn,
                                     const CFormDfn **nodeDfn,
                                     const CType **nodeType, CFormElm **node,
                                     UFormDfn::TEntryType &type, bool &array,
                                     bool verbose, uint arrayIndex) const {
  ...
  *node = (CFormElm *)this;
  bool created;
  bool parentVDfnArray;
  if (getInternalNodeByName(Form, name, parentDfn, indexDfn, nodeDfn, nodeType,
                            node, type, array, Create, created, parentVDfnArray,
                            verbose, NLGEORGES_FIRST_ROUND)) {
    ...
    if (parentNode->isArray()) {
      ...
      if (arrayIndex < array->Elements.size()) {
        ...
        case UFormDfn::EntryType: {
          // Create an atom
          CFormElmAtom *atom =
              new CFormElmAtom(Form, array, *parentDfn, indexDfn);
          newelm = atom;
        } break;
        case UFormDfn::EntryDfn: {
          CFormElmStruct *_struct =
              new CFormElmStruct(Form, array, *parentDfn, indexDfn);
          _struct->build(*nodeDfn);
          newelm = _struct;
        } break;
        case UFormDfn::EntryVirtualDfn:
          // todo array of virtual struct
          // newelm = new CFormElmVirtualStruct (Form, array, *parentDfn,
          // indexDfn);
          break;
        default:
          nlstop;
...
bool CFormElm::arrayDeleteNodeByName(const std::string &name,
                                     const CFormDfn **parentDfn, uint &indexDfn,
                                     const CFormDfn **nodeDfn,
                                     const CType **nodeType, CFormElm **node,
                                     UFormDfn::TEntryType &type, bool &array,
...
bool CFormElm::getInternalNodeByName(CForm *form, const std::string &name,
                                     const CFormDfn **parentDfn, uint &indexDfn,
                                     const CFormDfn **nodeDfn,
                                     const CType **nodeType, CFormElm **node,
                                     UFormDfn::TEntryType &type, bool &array,
                                     TNodeAction action, bool &created,
                                     bool &parentVDfnArray, bool verbose,
                                     uint32 round) {
  ...
  if (*parentDfn) {
    ...
    *nodeType = theEntry.getTypePtr();
    ...
    indexDfn = 0xffffffff;
    *nodeType =
        (*node)->isAtom() ? safe_cast<CFormElmAtom *>(*node)->Type : NULL;
    *nodeDfn =
        (*node)->isStruct()
            ? (const CFormDfn *)(safe_cast<CFormElmStruct *>(*node)->FormDfn)
            : NULL;
    type = (*node)->isAtom()            ? UFormDfn::EntryType
           : (*node)->isVirtualStruct() ? UFormDfn::EntryVirtualDfn
                                        : UFormDfn::EntryDfn;
    array = false;
  }
  ...
  // Last struct elm
  CFormElmStruct *lastStructElm =
      ((*node)->ParentNode && (*node)->ParentNode->isStruct())
          ? safe_cast<CFormElmStruct *>((*node)->ParentNode)
          : NULL;
  uint lastStructIndex = 0;
  if (lastStructElm) {
    // Look for node in the parent
    for (; lastStructIndex < lastStructElm->Elements.size();
         lastStructIndex++) {
      // The same node ?
  ...
  while ((endToken = tokenize(startToken, token, errorIndex, code))) {
    ...
    if (!inArrayIndex) {
      ...
      case TokenString: {
        ...
        if (wantArrayIndex) {
          // Error message
          smprintf(error, 512, "Token (%s) should be an array index.",
                   token.c_str());
          goto exit;
        }
        ...
        if (((type == UFormDfn::EntryDfn) ||
             (type == UFormDfn::EntryVirtualDfn)) /*&& (!array)*/) {
          ...
          if ((type == UFormDfn::EntryVirtualDfn) && (*nodeDfn == NULL)) {
            ...
            if (action == Create) {
              ...
              CFormElmVirtualStruct *vStruct =
                  safe_cast<CFormElmVirtualStruct *>(*node);
              ...
              for (uint parent = 0; parent < form->getParentCount(); parent++) {
                ...
                UFormElm *uelm;
                if (parentPtr->getRootNode().getNodeByName(
                        &uelm, formName, NULL, verbose, round + 1) &&
                    uelm) {
                  // Value node ?
                  if (uelm->isVirtualStruct()) {
                    // Get a virtual struct pointer
                    CFormElmVirtualStruct *vStructParent =
                        safe_cast<CFormElmVirtualStruct *>(uelm);
            ...
            if (*nodeDfn == NULL) {
              // Error message
              smprintf(error, 512,
                       "Empty virtual struct element. Can't look into it while "
                       "it is not defined.");
              goto exit;
            }
          }
            ...
            for (element = 0; element < dfn.Entries.size(); element++) {
              ...
              if (dfn.Entries[element].Name == token) {
                ...
                *nodeType = dfn.Entries[element].Type;
                ...
                if (*node) {
                  // Get next node
                  CFormElmStruct *nodeStruct =
                      safe_cast<CFormElmStruct *>(*node);
                  ...
                  *node = nextElt;
                  ...
                  if ((action == Create) && (*node == NULL)) {
                    ...
                    if (array) {
                      // Create an atom
                      CFormElmArray *atom =
                          new CFormElmArray(form, *nodeDfn, *nodeType,
                                            nodeStruct, *parentDfn, indexDfn);
                      *node = atom;
                    } else {
                      // What kind of node ?
                      switch (type) {
                      case UFormDfn::EntryType: {
                        // Create an atom
                        CFormElmAtom *atom = new CFormElmAtom(
                            form, nodeStruct, *parentDfn, indexDfn);
                        *node = atom;
                      } break;
                      case UFormDfn::EntryDfn: {
                        CFormElmStruct *_struct = new CFormElmStruct(
                            form, nodeStruct, *parentDfn, indexDfn);
                        _struct->build(*nodeDfn);
                        *node = _struct;
                      } break;
                      case UFormDfn::EntryVirtualDfn:
                        *node = new CFormElmVirtualStruct(form, nodeStruct,
                                                          *parentDfn, indexDfn);
                        break;
                      default:
                        nlstop;
                  ...
                  if ((*node) && (*node)->isVirtualStruct()) {
                    ...
                    // Set the current dfn
                    *nodeDfn = safe_cast<const CFormElmVirtualStruct *>(*node)
                                   ->FormDfn;
                  }
          ...
          if (i == arrayDfn.size()) {
            // Not found
            smprintf(error, 512, "Struct does not contain element named (%s).",
                     token.c_str());
            goto exit;
          }
        } else {
          // Error message
          smprintf(error, 512,
                   "Not a struct element. Can't open the node (%s).",
                   token.c_str());
          goto exit;
        }
      } break;
      ...
      case TokenArrayBegin: {
        ...
        if (!array) {
          // Error message
          smprintf(error, 512,
                   "Not an array element. Can't open the node (%s).",
                   token.c_str());
          goto exit;
        }
        inArrayIndex = true;
      ...
      case TokenString: {
        ...
        if (!fromString(token, arrayIndex)) {
          // Error message
          smprintf(error, 512, "Keyword (%s) is not an array index.",
                   token.c_str());
          goto exit;
        }
          ...
          if (arrayIndex >= arraySize) {
            ...
            if (action == Create) {
              ...
              for (i = oldSize; i < array->Elements.size(); i++) {
                ...
                case UFormDfn::EntryVirtualDfn:
                  // todo array of virtual struct
                  // newelm = new CFormElmVirtualStruct (form, array,
                  // *parentDfn, indexDfn);
                  break;
                default:
                  nlstop;
              ...
              // Error message
              smprintf(error, 512, "Out of array bounds (%d >= %d).",
          ...
          *nodeType = (*parentDfn)->getEntry(indexDfn).getTypePtr();
          ...
          if ((action == Create) && (*node == NULL)) {
            ...
            case UFormDfn::EntryType: {
              // Create an atom
              CFormElmAtom *atom =
                  new CFormElmAtom(form, parentNode, *parentDfn, indexDfn);
              *node = atom;
            } break;
            case UFormDfn::EntryDfn: {
              CFormElmStruct *_struct =
                  new CFormElmStruct(form, parentNode, *parentDfn, indexDfn);
              _struct->build(*nodeDfn);
              *node = _struct;
            } break;
            case UFormDfn::EntryVirtualDfn:
              // todo array of virtual struct
              // *node = new CFormElmVirtualStruct (form, parentNode,
              // *parentDfn, indexDfn);
              break;
            default:
              nlstop;
...
exit:;
  ...
  if (((*node) == NULL) && (action == Return) && backupFirstElm) {
    ...
    if ((formNameSize > 0) && (formName[formNameSize - 1] != '.') &&
        (formName[formNameSize - 1] != '['))
      formName += ".";
    formName += name;
    ...
    for (uint parent = 0; parent < form->getParentCount(); parent++) {
      ...
      if (parentPtr->getFilename() == form->getFilename()) {
        nlerror("parent is identical to current sheet %s!",
                form->getFilename().c_str());
        return false;
      }
      ...
      bool createdParent;
      bool parentVDfnArray;
      if (getInternalNodeByName(parentPtr, formName, &parentDfnParent,
                                indexDfnParent, &nodeDfnParent, &nodeTypeParent,
                                &nodeParent, typeParent, arrayParent, action,
                                createdParent, parentVDfnArray, false,
                                round + 1)) {
        // Node found ?
        if (nodeParent) {
  ...
  if (*node) {
    if (round > NLGEORGES_MAX_RECURSION) {
      ...
      warning(false, formName, form->getFilename(), "getInternalNodeByName",
              "Recursive call on the same node (%s), look for loop references "
              "or inheritances.",
              name.c_str());
      return false;
    }
  ...
  if (verbose && errorAppend) {
    ...
    warning(false, currentName, form->getFilename(), "getInternalNodeByName",
            "Getting the node (%s) : %s", name.c_str(), error);
  }
...
const char *CFormElm::tokenize(const char *name, string &str,
                               uint & /* errorIndex */, uint &code) {
  if (*name == 0) {
    return NULL;
  }
...
bool CFormElm::setValueByName(const std::string &value, const std::string &name,
                              bool *created) {
  // The parent Dfn
  const CFormDfn *parentDfn;
  const CFormDfn *nodeDfn;
  ...
  // Search for the node
  if (createNodeByName(name, &parentDfn, indexDfn, &nodeDfn, &nodeType, &node,
                       type, array, _created)) {
    // Is this a type ?
    if (type == UFormDfn::EntryType) {
      // The atom
      ...
      // Error message
      warning(false, "setValueByName",
              "The node (%s) is not an atom element. Can't set the value.",
              name.c_str());
    }
  } else {
    // Error message
    warning(false, "setValueByName", "Can't created / set the node (%s).",
            name.c_str());
...
bool CFormElm::setValueByName(sint8 value, const std::string &name,
                              bool *created) {
...
bool CFormElm::setValueByName(uint8 value, const std::string &name,
                              bool *created) {
  return setValueByName(toString(value), name, created);
}
...
bool CFormElm::setValueByName(sint16 value, const std::string &name,
                              bool *created) {
  return setValueByName(toString(value), name, created);
}
...
bool CFormElm::setValueByName(uint16 value, const std::string &name,
                              bool *created) {
  return setValueByName(toString(value), name, created);
}
...
bool CFormElm::setValueByName(sint32 value, const std::string &name,
                              bool *created) {
  return setValueByName(toString(value), name, created);
}
...
bool CFormElm::setValueByName(uint32 value, const std::string &name,
                              bool *created) {
  return setValueByName(toString(value), name, created);
}
...
bool CFormElm::setValueByName(float value, const std::string &name,
                              bool *created) {
  return setValueByName(toString(value), name, created);
}
...
bool CFormElm::setValueByName(double value, const std::string &name,
                              bool *created) {
  return setValueByName(toString(value), name, created);
}
...
bool CFormElm::setValueByName(bool value, const std::string &name,
                              bool *created) {
  return setValueByName(toString(value), name, created);
}
...
bool CFormElm::setValueByName(NLMISC::CRGBA value, const std::string &name,
                              bool *created) {
  char tmp[512];
...
void CFormElm::warning(bool exception, const std::string &formName,
                       const std::string &formFileName,
                       const std::string &function, const char *format, ...) {
  ...
  // Set the warning
  NLGEORGES::warning(exception, "(CFormElm::%s) on node (%s) in form (%s) : %s",
                     function.c_str(), formName.c_str(), formFileName.c_str(),
                     buffer);
}

// ***************************************************************************

void CFormElm::warning(bool exception, const std::string &function,
  ...
  warning(exception, formName, getForm()->getFilename(), function, format,
          args);
...
CFormElmStruct::CFormElmStruct(CForm *form, CFormElm *parentNode,
                               const CFormDfn *parentDfn, uint parentIndex)
    : CFormElm(form, parentNode, parentDfn, parentIndex) {
  FormDfn = NULL;
}
...
bool CFormElmStruct::isStruct() const { return true; }
...
bool CFormElmStruct::getStructNodeName(uint element, string &result) const {
  if (element < Elements.size()) {
    ...
    warning(false, "getStructNodeName", "Index (%u) out of bound (%u).",
            element, (uint)Elements.size());
    return false;
  }
}
...
bool CFormElmStruct::getStructNode(uint element,
                                   const UFormElm **result) const {
  if (element < Elements.size()) {
    *result = Elements[element].Element;
    return true;
  } else {
    warning(false, "getStructNode", "Index (%u) out of bound (%u).", element,
            (uint)Elements.size());
    return false;
  }
}
...
UFormDfn *CFormElmStruct::getStructDfn() { return (CFormDfn *)FormDfn; }
...
xmlNodePtr CFormElmStruct::write(xmlNodePtr root, const CForm *form,
  ...
  if (isUsed(form) || forceWrite) {
    ...
    if (!structName.empty()) {
      ...
      xmlSetProp(node, (const xmlChar *)"Name",
                 (const xmlChar *)structName.c_str());
    }
...
void CFormElmStruct::read(xmlNodePtr node, CFormLoader &loader,
                          const CFormDfn *dfn, CForm *form) {
      ...
      while (child) {
        ...
        if (name && (dfnArray[dfnId]->Entries[elm].getName() == name)) {
          ...
          if (atom || _struct || vStruct || array) {
            // Same type ?
            if ((atom &&
                 (dfnArray[dfnId]->Entries[elm].getType() ==
                  UFormDfn::EntryType) &&
                 (!dfnArray[dfnId]->Entries[elm].getArrayFlag())) ||
                (array && dfnArray[dfnId]->Entries[elm].getArrayFlag() &&
                 ((dfnArray[dfnId]->Entries[elm].getType() ==
                   UFormDfn::EntryType) ||
                  (dfnArray[dfnId]->Entries[elm].getType() ==
                   UFormDfn::EntryDfn))) ||
              ...
              warning(false, "read",
                      "In block line %u, node (%s) type in DFN have changed.",
            ...
            // Throw exception
            warning(true, "read",
                    "XML Syntax error in block line %u, node (%s) name should "
                    "be STRUCT, ATOM or ARRAY.",
                    (uint)child->line, child->name);
          }
        }
      ...
      if (child) {
        ...
        if (dfnArray[dfnId]->Entries[elm].getArrayFlag()) {
          ...
          if (dfnArray[dfnId]->Entries[elm].getType() == UFormDfn::EntryType) {
            ...
            newElm = new CFormElmArray(
                form, NULL, dfnArray[dfnId]->Entries[elm].getTypePtr(), this,
                dfnArray[dfnId], elm);
          }
          // Array of struct
          else if (dfnArray[dfnId]->Entries[elm].getType() ==
                   UFormDfn::EntryDfn) {
            newElm = new CFormElmArray(
                form, dfnArray[dfnId]->Entries[elm].getDfnPtr(), NULL, this,
                dfnArray[dfnId], elm);
          }
          ...
          // Load the new element
          CFormElmAtom *newElm =
              new CFormElmAtom(form, this, dfnArray[dfnId], elm);
          Elements[elmIndex].Element = newElm;
          newElm->read(child, loader,
                       dfnArray[dfnId]->Entries[elm].getTypePtr(), form);
        } else if (dfnArray[dfnId]->Entries[elm].getType() ==
                   UFormDfn::EntryDfn) {
          // Load the new element
          CFormElmStruct *newElm =
              new CFormElmStruct(form, this, dfnArray[dfnId], elm);
          Elements[elmIndex].Element = newElm;
          newElm->read(child, loader, dfnArray[dfnId]->Entries[elm].getDfnPtr(),
                       form);
        } else // if dfnArray[dfnId]->Entries[elm].getType () ==
               // CFormDfn::CEntry::EntryVirtualDfn)
        {
          // Should be a struct
          nlassert(dfnArray[dfnId]->Entries[elm].getType() ==
                   UFormDfn::EntryVirtualDfn);

          // Load the new element
          CFormElmVirtualStruct *newElm =
              new CFormElmVirtualStruct(form, this, dfnArray[dfnId], elm);
          Elements[elmIndex].Element = newElm;
          newElm->read(child, loader, form);
        }
      } else
...
void CFormElmStruct::getFormName(std::string &result,
                                 const CFormElm *child) const {
  // Reset the result
  if (child == NULL) {
    result.clear();
    result.reserve(50);
...
void CFormElmStruct::warning(bool exception, const std::string &function,
                             const char *format, ...) const {
  // Make a buffer string
  va_list args;
  va_start(args, format);
  ...
  NLGEORGES::warning(
      exception, "(CFormElmStruct::%s) on node (%s) in form (%s) : %s",
      function.c_str(), formName.c_str(), Form->getFilename().c_str(), buffer);
}

// ***************************************************************************

void CFormElmStruct::getDependencies(
...
CFormElmVirtualStruct::CFormElmVirtualStruct(CForm *form, CFormElm *parentNode,
                                             const CFormDfn *parentDfn,
                                             uint parentIndex)
    : CFormElmStruct(form, parentNode, parentDfn, parentIndex) {}

// ***************************************************************************

xmlNodePtr CFormElmVirtualStruct::write(xmlNodePtr root, const CForm *form,
                                        const std::string &structName,
                                        bool forceWrite) const {
  // Is used ?
  if (isUsed(form) || forceWrite) {
    ...
    xmlSetProp(node, (const xmlChar *)"DfnName",
               (const xmlChar *)DfnFilename.c_str());
...
void CFormElmVirtualStruct::read(xmlNodePtr node, CFormLoader &loader,
                                 CForm *form) {
  ...
  if (filename) {
    ...
    if (!FormDfn) {
      // Throw exception
      warning(true, "read", "Can't find DFN filename (%s).",
              DfnFilename.c_str());
    }
  } else {
    // Throw exception
    warning(true, "read",
            "XML Syntax error in virtual struct in block line %u, should have "
            "a DfnName property.",
            (uint)node->line);
  }
...
bool CFormElmVirtualStruct::isVirtualStruct() const { return true; }
...
void CFormElmVirtualStruct::warning(bool exception, const std::string &function,
                                    const char *format, ...) const {
  // Make a buffer string
  va_list args;
  va_start(args, format);
  ...
  getFormName(formName, NULL);
  NLGEORGES::warning(
      exception, "(CFormElmVirtualStruct::%s) on node (%s) in form (%s) : %s",
      function.c_str(), formName.c_str(), Form->getFilename().c_str(), buffer);
}
...
CFormElmArray::CFormElmArray(CForm *form, const CFormDfn *formDfn,
                             const CType *type, CFormElm *parentNode,
                             const CFormDfn *parentDfn, uint parentIndex)
    : CFormElm(form, parentNode, parentDfn, parentIndex) {
...
bool CFormElmArray::isArray() const { return true; }
...
bool CFormElmArray::getArrayNode(const UFormElm **result,
                                 uint arrayIndex) const {
  if (arrayIndex < Elements.size()) {
    *result = Elements[arrayIndex].Element;
    return true;
  } else {
    warning(false, "getArrayNode", "Index (%u) out of bound (%u).", arrayIndex,
            (uint)Elements.size());
    return false;
  }
}
...
bool CFormElmArray::getArrayNodeName(std::string &result,
                                     uint arrayIndex) const {
  if (arrayIndex < Elements.size()) {
    ...
    warning(false, "getArrayNodeName", "Index (%u) out of bound (%u).",
            arrayIndex, (uint)Elements.size());
    return false;
  }
}
...
bool CFormElmArray::getArrayValue(std::string &result, uint arrayIndex,
                                  TEval evaluate, TWhereIsValue *where) const {
  if (arrayIndex >= Elements.size()) {
    warning(false, "getArrayValue",
            "Access out of bound, trying to access array index %u, array size "
            "is %u.",
            arrayIndex, (uint)Elements.size());
  } else if (Type) {
    return (Type->getValue(
        result, Form,
        safe_cast<const CFormElmAtom *>(Elements[arrayIndex].Element),
        *ParentDfn, ParentIndex, evaluate, (uint32 *)where,
        NLGEORGES_FIRST_ROUND, ""));
  } else {
    warning(
        false, "getArrayValue",
        "This array is not an array of atom. This is an array of structure.");
  }
...
bool CFormElmArray::getArrayValue(sint8 &result, uint arrayIndex,
                                  TEval evaluate, TWhereIsValue *where) const {
  if (Type) {
    string str;
    if (Type->getValue(
...
bool CFormElmArray::getArrayValue(uint8 &result, uint arrayIndex,
                                  TEval evaluate, TWhereIsValue *where) const {
  if (Type) {
    string str;
    if (Type->getValue(
...
bool CFormElmArray::getArrayValue(sint16 &result, uint arrayIndex,
                                  TEval evaluate, TWhereIsValue *where) const {
  if (Type) {
    string str;
    if (Type->getValue(
...
bool CFormElmArray::getArrayValue(uint16 &result, uint arrayIndex,
                                  TEval evaluate, TWhereIsValue *where) const {
  if (Type) {
    string str;
    if (Type->getValue(
...
bool CFormElmArray::getArrayValue(sint32 &result, uint arrayIndex,
                                  TEval evaluate, TWhereIsValue *where) const {
  if (Type) {
    string str;
    if (Type->getValue(
...
bool CFormElmArray::getArrayValue(uint32 &result, uint arrayIndex,
                                  TEval evaluate, TWhereIsValue *where) const {
  if (Type) {
    string str;
    if (Type->getValue(
...
bool CFormElmArray::getArrayValue(float &result, uint arrayIndex,
                                  TEval evaluate, TWhereIsValue *where) const {
  if (Type) {
    string str;
    if (Type->getValue(
...
bool CFormElmArray::getArrayValue(double &result, uint arrayIndex,
                                  TEval evaluate, TWhereIsValue *where) const {
  if (Type) {
    string str;
    if (Type->getValue(
...
bool CFormElmArray::getArrayValue(bool &result, uint arrayIndex, TEval evaluate,
                                  TWhereIsValue *where) const {
  if (Type) {
    string str;
    if (Type->getValue(
...
bool CFormElmArray::getArrayValue(NLMISC::CRGBA &result, uint arrayIndex,
                                  TEval evaluate, TWhereIsValue *where) const {
  if (Type) {
    string str;
    if (Type->getValue(
...
xmlNodePtr CFormElmArray::write(xmlNodePtr root, const CForm *form,
                                const std::string &structName,
                                bool forceWrite) const {
  // Arrau is used ?
  if (isUsed(form) || forceWrite) {
  ...
  if (node) {
    ...
    if (Type) {
      ...
      while (child) {
        ...
        // Create a new node
        CFormElmAtom *newElt =
            new CFormElmAtom(form, this, ParentDfn, ParentIndex);
      ...
      while (child) {
        ...
        // Create a new node
        CFormElmStruct *newElt =
            new CFormElmStruct(form, this, ParentDfn, ParentIndex);
        Elements[childNum].Element = newElt;
        if (name) {
          Elements[childNum].Name = name;
          xmlFree((void *)name);
...
bool CFormElmArray::setParent(CFormElm * /* parent */) { return true; }
...
void CFormElmArray::getFormName(std::string &result,
                                const CFormElm *child) const {
  // Reset the result
  if (child == NULL) {
    result.clear();
...
void CFormElmArray::warning(bool exception, const std::string &function,
                            const char *format, ...) const {
  // Make a buffer string
  va_list args;
  va_start(args, format);
  ...
  getFormName(formName, NULL);
  NLGEORGES::warning(
      exception, "(CFormElmArray::%s) on node (%s) in form (%s) : %s",
      function.c_str(), formName.c_str(), Form->getFilename().c_str(), buffer);
}
...
CFormElmAtom::CFormElmAtom(CForm *form, CFormElm *parentNode,
                           const CFormDfn *parentDfn, uint parentIndex)
    : CFormElm(form, parentNode, parentDfn, parentIndex) {
  Type = NULL;
}
...
bool CFormElmAtom::isAtom() const { return true; }

// ***************************************************************************

const CType *CFormElmAtom::getType() { return Type; }

// ***************************************************************************

void CFormElmAtom::getDependencies(
    std::set<std::string> & /* dependencies */) const {}
...
bool CFormElmAtom::getValue(string &result, TEval evaluate) const {
  ...
  // Evale
  return Type->getValue(result, Form, this, *ParentDfn, ParentIndex, evaluate,
                        NULL, NLGEORGES_FIRST_ROUND, "");
}
...
xmlNodePtr CFormElmAtom::write(xmlNodePtr root, const CForm *form,
                               const std::string &structName,
                               bool forceWrite) const {
  // Atom is used ?
  if (isUsed(form) || forceWrite) {
    ...
    if (!Value.empty()) {
      if (COXml::isStringValidForProperties(Value))
        xmlSetProp(node, (const xmlChar *)"Value",
...
void CFormElmAtom::read(xmlNodePtr node, CFormLoader & /* loader */,
                        const CType *type, CForm * /* form */) {
  // Set the type
  Type = type;
...
void CFormElmAtom::setValue(const std::string &value) { Value = value; }

// ***************************************************************************

void CFormElmAtom::getValue(std::string &result) const { result = Value; }

// ***************************************************************************

void CFormElmAtom::getFormName(std::string &result,
                               const CFormElm *child) const {
  // Must be NULL
  nlassert(child == NULL);
  result.clear();
...
void CFormElmAtom::warning(bool exception, const std::string &function,
                           const char *format, ...) const {
  // Make a buffer string
  va_list args;
  va_start(args, format);
  ...
  getFormName(formName, NULL);
  NLGEORGES::warning(
      exception, "(CFormElmAtom::%s) on node (%s) in form (%s) : %s",
      function.c_str(), formName.c_str(), Form->getFilename().c_str(), buffer);
}
