...
CMeshMRMSkinnedInstance::~CMeshMRMSkinnedInstance() {
  ...
  if (_FatherSkeletonModel) {
    ...
    // If skinned, setApplySkin(false) should have been called through
    // detachSkeletonSon()
...
void CMeshMRMSkinnedInstance::registerBasic() {
  CScene::registerModel(MeshMRMSkinnedInstanceId, MeshBaseInstanceId,
...
void CMeshMRMSkinnedInstance::setApplySkin(bool state) {
  ...
  CMeshMRMSkinned *pMesh =
      NLMISC::safe_cast<CMeshMRMSkinned *>((IShape *)Shape);
...
// ***************************************************************************
void CMeshMRMSkinnedInstance::changeMRMDistanceSetup(float distanceFinest,
  ...
  if (Shape) {
    ...
    pMesh->changeMRMDistanceSetup(distanceFinest, distanceMiddle,
                                  distanceCoarsest);
  }
}
...
// ***************************************************************************
const std::vector<NLMISC::CBSphere> *
...
// ***************************************************************************
bool CMeshMRMSkinnedInstance::getSkinBoneBBox(NLMISC::CAABBox &bbox,
                                              uint boneId) {
  // Get a pointer on the shape
  CMeshMRMSkinned *pMesh =
      NLMISC::safe_cast<CMeshMRMSkinned *>((IShape *)Shape);
  ...
  // get it.
  return pMesh->getMeshGeom().getSkinBoneBBox(_FatherSkeletonModel, bbox,
                                              boneId);
}
...
void CMeshMRMSkinnedInstance::renderSkin(float alphaMRM) {
  ...
  if (Shape && getVisibility() != CHrcTrav::Hide) {
    ...
    // render the meshGeom
    CMeshMRMSkinnedGeom &meshGeom =
        const_cast<CMeshMRMSkinnedGeom &>(pMesh->getMeshGeom());
...
// ***************************************************************************
sint CMeshMRMSkinnedInstance::renderSkinGroupGeom(float alphaMRM,
...
// ***************************************************************************
void CMeshMRMSkinnedInstance::renderSkinGroupPrimitives(
  ...
  CMeshMRMSkinnedGeom &meshGeom =
      const_cast<CMeshMRMSkinnedGeom &>(pMesh->getMeshGeom());
  meshGeom.renderSkinGroupPrimitives(this, baseVertex, specularRdrPasses,
                                     skinIndex);
}
// ***************************************************************************
...
// ***************************************************************************
sint CMeshMRMSkinnedInstance::renderShadowSkinGeom(uint remainingVertices,
                                                   uint8 *vbDest) {
  // Get a pointer on the shape
  CMeshMRMSkinned *pMesh =
      NLMISC::safe_cast<CMeshMRMSkinned *>((IShape *)Shape);
...
// ***************************************************************************
void CMeshMRMSkinnedInstance::renderShadowSkinPrimitives(CMaterial &castMat,
                                                         IDriver *drv,
                                                         uint baseVertex) {
  // Get a pointer on the shape
  CMeshMRMSkinned *pMesh =
...
// ***************************************************************************
bool CMeshMRMSkinnedInstance::intersectSkin(const CMatrix &toRaySpace,
