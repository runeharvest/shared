...
void CMeshMRMInstance::registerBasic() {
  CScene::registerModel(MeshMRMInstanceId, MeshBaseInstanceId,
...
// ***************************************************************************
void CMeshMRMInstance::changeMRMDistanceSetup(float distanceFinest,
...
// ***************************************************************************
sint CMeshMRMInstance::renderSkinGroupGeom(float alphaMRM,
...
// ***************************************************************************
void CMeshMRMInstance::renderSkinGroupPrimitives(
...
// ***************************************************************************
sint CMeshMRMInstance::renderShadowSkinGeom(uint remainingVertices,
                                            uint8 *vbDest) {
  // Get a pointer on the shape
  CMeshMRM *pMesh = NLMISC::safe_cast<CMeshMRM *>((IShape *)Shape);
  // render the meshGeom
...
// ***************************************************************************
void CMeshMRMInstance::renderShadowSkinPrimitives(CMaterial &castMat,
                                                  IDriver *drv,
                                                  uint baseVertex) {
  // Get a pointer on the shape
  CMeshMRM *pMesh = NLMISC::safe_cast<CMeshMRM *>((IShape *)Shape);
...
// ***************************************************************************
bool CMeshMRMInstance::intersectSkin(const CMatrix &toRaySpace, float &dist2D,
