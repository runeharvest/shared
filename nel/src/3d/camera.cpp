...
// ***************************************************************************
void CCamera::setFrustum(float left, float right, float bottom, float top,
                         float znear, float zfar, bool perspective) {
  _Frustum.init(left, right, bottom, top, znear, zfar, perspective);
}
// ***************************************************************************
void CCamera::setFrustum(float width, float height, float znear, float zfar,
                         bool perspective) {
  _Frustum.init(width, height, znear, zfar, perspective);
}
// ***************************************************************************
void CCamera::setPerspective(float fov, float aspectRatio, float znear,
                             float zfar) {
  _Frustum.initPerspective(fov, aspectRatio, znear, zfar);
}
// ***************************************************************************
void CCamera::getFrustum(float &left, float &right, float &bottom, float &top,
...
// ***************************************************************************
bool CCamera::isOrtho() const { return !_Frustum.Perspective; }
// ***************************************************************************
bool CCamera::isPerspective() const { return _Frustum.Perspective; }
...
// ***************************************************************************
void CCamera::registerToChannelMixer(CChannelMixer *chanMixer,
...
void CCamera::update() {
  ...
  if (IAnimatable::isTouched(OwnerBit) ||
    ...
    if (_FovAnimationEnabled && IAnimatable::isTouched(FovValue)) {
      ...
      setPerspective(_Fov.Value, _FovAnimationAspectRatio, _Frustum.Near,
                     _Frustum.Far);
    ...
    if (_TargetAnimationEnabled && (IAnimatable::isTouched(TargetValue) ||
...
// ***************************************************************************
void CCamera::buildCameraPyramid(std::vector<CPlane> &pyramid,
                                 bool useWorldMatrix) {
  pyramid.resize(6);
...
// ***************************************************************************
void CCamera::buildCameraPyramidCorners(
