...
TAnimationTime CPlayListUser::getLocalTime(uint8 slot,
                                           TGlobalAnimationTime globalTime,
                                           const UAnimationSet &animSet) const {
  NL3D_HAUTO_UI_PLAY_LIST;

  // Cast
  const CAnimationSetUser *cAnimSetUser =
      safe_cast<const CAnimationSetUser *>(&animSet);
...
float CPlayListUser::getLocalWeight(uint8 slot,
                                    TGlobalAnimationTime globalTime) const {
  NL3D_HAUTO_UI_PLAY_LIST;
...
void CPlayListUser::setStartWeight(uint8 slot, float startWeight,
...
float CPlayListUser::getStartWeight(uint8 slot,
...
void CPlayListUser::setEndWeight(uint8 slot, float endWeight,
                                 TGlobalAnimationTime time) {
  NL3D_HAUTO_UI_PLAY_LIST;
...
float CPlayListUser::getEndWeight(uint8 slot,
                                  TGlobalAnimationTime &time) const {
  NL3D_HAUTO_UI_PLAY_LIST;
...
void CPlayListUser::setSkeletonWeight(uint8 slot, uint skeletonId,
                                      bool inverted) {
  NL3D_HAUTO_UI_PLAY_LIST;
