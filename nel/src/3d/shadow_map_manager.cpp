...
CShadowMapManager::CShadowMapManager()
{
	...
	// **** Setup Blur
	_BlurQuads.setVertexFormat(CVertexBuffer::PositionFlag | CVertexBuffer::TexCoord0Flag | CVertexBuffer::TexCoord1Flag | CVertexBuffer::TexCoord2Flag | CVertexBuffer::TexCoord3Flag);
...
void CShadowMapManager::renderGenerate(CScene *scene)
{
	...
	if (_ShadowCasters.empty() || textDestW < baseTextureSize || textDestH < baseTextureSize)
	{
		clearAllShadowCasters();
		return;
	}
