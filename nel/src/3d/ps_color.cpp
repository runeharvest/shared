...
CRGBA CPSColorGradient::_DefaultGradient[] = {CRGBA(0, 0, 0),
                                              CRGBA(255, 255, 255)};
...
///======================================================================================
CPSColorGradient::CPSColorGradient(const CRGBA *colorTab, uint32 nbValues,
                                   uint32 nbStages, float nbCycles)
...
void CPSColorMemory::setColorType(CVertexBuffer::TVertexColorType colorType) {
  ...
  if (_Scheme)
    _Scheme->setColorType(colorType);
}

///======================================================================================
void CPSColorMemory::setDefaultValue(NLMISC::CRGBA defaultValue) {
  CPSAttribMakerMemory<NLMISC::CRGBA>::setDefaultValue(
      convertVBColor(defaultValue, _ColorType));
}

///======================================================================================
NLMISC::CRGBA CPSColorMemory::getDefaultValue(void) const {
  return convertVBColor(CPSAttribMakerMemory<NLMISC::CRGBA>::getDefaultValue(),
                        _ColorType);
}
...
void CPSColorBinOp::setColorType(CVertexBuffer::TVertexColorType colorType) {
  if (_Arg[0])
    _Arg[0]->setColorType(colorType);
  if (_Arg[1])
    _Arg[1]->setColorType(colorType);
}
...
///======================================================================================
void CPSValueBlendFuncRGBA::setColorType(
    CVertexBuffer::TVertexColorType colorType) {
  if (colorType == _ColorType)
    return;
...
///======================================================================================
void CPSValueBlendSampleFuncRGBA::setColorType(
    CVertexBuffer::TVertexColorType colorType) {
  if (colorType == _ColorType)
    return;
...
///======================================================================================
void CPSValueGradientFuncRGBA::setColorType(
    CVertexBuffer::TVertexColorType colorType) {
  if (colorType == _ColorType)
    return;
...
void convertVBColor(NLMISC::CRGBA *array, uint numColor,
  ...
  if (!array || format == CVertexBuffer::TRGBA)
    return;
...
NLMISC::CRGBA CPSValueGradientFuncRGBA::getValue(uint index) const {
  return convertVBColor(CPSValueGradientFunc<NLMISC::CRGBA>::getValue(index),
                        _ColorType);
}

///======================================================================================
void CPSValueGradientFuncRGBA::setValues(const NLMISC::CRGBA *valueTab,
                                         uint32 numValues, uint32 nbStages) {
  std::vector<NLMISC::CRGBA> convert(valueTab, valueTab + numValues);
  convertVBColor(&convert[0], numValues, _ColorType);
  CPSValueGradientFunc<NLMISC::CRGBA>::setValues(&convert[0], numValues,
                                                 nbStages);
}

///======================================================================================
void CPSValueGradientFuncRGBA::setValuesUnpacked(const NLMISC::CRGBA *valueTab,
                                                 uint32 numValues,
                                                 uint32 nbStages) {
  std::vector<NLMISC::CRGBA> convert(valueTab,
                                     valueTab + (numValues * nbStages + 1));
  convertVBColor(&convert[0], (numValues * nbStages + 1), _ColorType);
  CPSValueGradientFunc<NLMISC::CRGBA>::setValuesUnpacked(&convert[0], numValues,
                                                         nbStages);
}
