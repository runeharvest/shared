...
static const char *PPLightingVPCodeBegin = "!!VP1.0																				\n\
#compute B = N ^ T																		\n\
MOV R6, v[2];																			\n\
...
static const char *PPLightingVPNormalizeCodeBegin = "!!VP1.0																				\n\
...
static const char *PPLightingNoSpecVPCodeBegin = "!!VP1.0																				\n\
#compute B = N ^ T																		\n\
MOV R6, v[2];																			\n\
MUL R1, R6.yzxw, v[9].zxyw;																\n\
MAD R1, v[9].yzxw, -R6.zxyw, R1;														\n\
...
static const char *PPLightingVPNormalizeNoSpecCodeBegin = "!!VP1.0																				\n\
#normalize the normal																	\n\
DP3 R1, v[2], v[2];																		\n\
RSQ R1, R1.x;																			\n\
MUL R6, v[2], R1;																			\n\
...
static const char *PPLightingDirectionnalVPCodeBegin = "!!VP1.0																				\n\
#compute B = N ^ T																		\n\
MOV R6, v[2];																			\n\
MUL R1, R6.yzxw, v[9].zxyw;																\n\
MAD R1, v[9].yzxw, -R6.zxyw, R1;														\n\
...
static const char *PPLightingDirectionnalVPNormalizeCodeBegin = "!!VP1.0																				\n\
#normalize the normal																	\n\
DP3 R1, v[2], v[2];																		\n\
RSQ R1, R1.x;																			\n\
MUL R6, v[2], R1;																		\n\
...
static const char *PPLightingDirectionnalNoSpecVPCodeBegin = "!!VP1.0																				\n\
#compute B = N ^ T																		\n\
MOV R6, v[2];																			\n\
MUL R1, R6.yzxw, v[9].zxyw;																\n\
MAD R1, v[9].yzxw, -R6.zxyw, R1;														\n\
...
static const char *PPLightingDirectionnalNoSpecVPNormalizeCodeBegin = "!!VP1.0																				\n\
#normalize the normal																	\n\
DP3 R1, v[2], v[2];																		\n\
RSQ R1, R1.x;																			\n\
MUL R6, v[2], R1;																		\n\
...
static const char *PPLightingVPCodeEnd = "	# compute in Projection space														\n\
