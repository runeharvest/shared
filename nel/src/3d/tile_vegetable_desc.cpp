...
// ***************************************************************************
CTileVegetableDesc::CTileVegetableDesc() { _Empty = true; }
...
void CTileVegetableDesc::build(const std::vector<CVegetable> &vegetables) {
  ...
  // Parse all landscape vegetables, and store them in appropriate distance
  // Type.
  ...
  // Compute Seed such that creation of one vegetable for a tile will never
  // receive same seed.
  uint sumVeget = 0;
...
// ***************************************************************************
void CTileVegetableDesc::registerToManager(
...
// ***************************************************************************
const std::vector<CVegetable> &
CTileVegetableDesc::getVegetableList(uint distType) const {
