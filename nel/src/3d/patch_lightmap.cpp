...
void CPatch::computeNearBlockLightmap(uint uts, uint utt, CRGBA *lightText)
{
	...
	for (edge = 0; edge < 4; edge++)
	{
		...
		case 1:
			decalT = 2;
			dest = lightText + 1 + (NL_TILE_LIGHTMAP_SIZE - 1) * NL_TILE_LIGHTMAP_SIZE;
			break;
		case 2:
			decalS = 2;
	...
	for (corner = 0; corner < 4; corner++)
	{
		...
		case 1:
			decalS = -1;
			decalT = 2;
			dest = lightText + 0 + (NL_TILE_LIGHTMAP_SIZE - 1) * NL_TILE_LIGHTMAP_SIZE;
			break;
		case 2:
			decalS = 2;
			decalT = 2;
			dest = lightText + (NL_TILE_LIGHTMAP_SIZE - 1) + (NL_TILE_LIGHTMAP_SIZE - 1) * NL_TILE_LIGHTMAP_SIZE;
			break;
		case 3:
			decalS = 2;
			decalT = -1;
