...
#define NL3D_HAUTO_LIGHT_VCE                                                   \
  H_AUTO_USE(NL3D_Misc_VisualCollisionEntity_GetLight)
...
bool CVisualCollisionEntityUser::getStaticLightSetup(
  ...
  return _Entity->getStaticLightSetup(sunAmbient, pos, pointLightList,
...
bool CVisualCollisionEntityUser::getSurfaceInfo(const CVector &pos,
