...
void CGPUProgramParams::set4f(uint index, float f0, float f1, float f2,
                              float f3) {
...
void CGPUProgramParams::set4i(uint index, sint32 i0, sint32 i1, sint32 i2,
                              sint32 i3) {
...
void CGPUProgramParams::set4ui(uint index, uint32 ui0, uint32 ui1, uint32 ui2,
                               uint32 ui3) {
...
void CGPUProgramParams::set3f(const std::string &name, float f0, float f1,
                              float f2) {
...
void CGPUProgramParams::set4f(const std::string &name, float f0, float f1,
                              float f2, float f3) {
...
void CGPUProgramParams::set3i(const std::string &name, sint32 i0, sint32 i1,
                              sint32 i2) {
...
void CGPUProgramParams::set4i(const std::string &name, sint32 i0, sint32 i1,
                              sint32 i2, sint32 i3) {
...
void CGPUProgramParams::set2ui(const std::string &name, uint32 ui0,
                               uint32 ui1) {
...
void CGPUProgramParams::set3ui(const std::string &name, uint32 ui0, uint32 ui1,
                               uint32 ui2) {
...
void CGPUProgramParams::set4ui(const std::string &name, uint32 ui0, uint32 ui1,
                               uint32 ui2, uint32 ui3) {
...
void CGPUProgramParams::set3f(const std::string &name,
...
void CGPUProgramParams::set4f(const std::string &name, const NLMISC::CVector &v,
                              float f3) {
  float *f = getPtrFByOffset(allocOffset(name, 4, 1, Float));
  f[0] = v.x;
  f[1] = v.y;
...
void CGPUProgramParams::set4x4f(const std::string &name,
...
void CGPUProgramParams::set4fv(const std::string &name, size_t num,
                               const float *src) {
...
void CGPUProgramParams::set4iv(const std::string &name, size_t num,
                               const sint32 *src) {
...
void CGPUProgramParams::set4uiv(const std::string &name, size_t num,
                                const uint32 *src) {
...
size_t CGPUProgramParams::allocOffset(uint index, uint size, uint count,
                                      TType type) {
...
/// Allocate specified number of components if necessary
size_t CGPUProgramParams::allocOffset(const std::string &name, uint size,
                                      uint count, TType type) {
  nlassert(count > 0);     // this code will not properly handle 0
  nlassert(size > 0);      // this code will not properly handle 0
