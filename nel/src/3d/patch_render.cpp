...
inline void CPatch::fillFar0VertexVB(CTessFarVertex *pVert)
{
	...
	else
	{
		...
		*(CVector *)(CurVBPtr + CLandscapeGlobals::CurrentFar0VBInfo.DeltaPosOff) = pVert->Src->EndPos - pVert->Src->StartPos;
	}
}
// ***************************************************************************
...
inline void CPatch::fillFar1VertexVB(CTessFarVertex *pVert)
{
	...
	else
	{
		...
		*(CVector *)(CurVBPtr + CLandscapeGlobals::CurrentFar1VBInfo.DeltaPosOff) = pVert->Src->EndPos - pVert->Src->StartPos;
...
inline void CPatch::fillTileVertexVB(CTessNearVertex *pVert)
{
	...
	else
	{
		...
		*(CVector *)(CurVBPtr + CLandscapeGlobals::CurrentTileVBInfo.DeltaPosOff) = pVert->Src->EndPos - pVert->Src->StartPos;
	}
}
