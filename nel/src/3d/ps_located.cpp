...
#endif
    TAnimationTime
    CPSLocated::computeDateFromCollisionToNextSimStep(uint particleIndex, float particleAgeInSeconds)
{
...
void CPSLocated::removeOldParticles()
{
	...
	else if (hasCollisionInfos()) // particle has collision, and limited lifetime
	{
