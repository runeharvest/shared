...
bool UParticleSystemInstance::isSystemPresent(void) const {
  ...
  CParticleSystemModel *object =
      NLMISC::safe_cast<CParticleSystemModel *>(_Object);
...
void UParticleSystemInstance::setUserParam(uint index, float value) {
  ...
  object->touch(CParticleSystemModel::PSParam0 + index,
...
bool UParticleSystemInstance::emit(uint32 anId, uint quantity) {
  ...
  CParticleSystem *ps =
      (NLMISC::safe_cast<CParticleSystemModel *>(_Object))->getPS();
...
bool UParticleSystemInstance::hasActiveEmitters() const {
  return (NLMISC::safe_cast<CParticleSystemModel *>(_Object))
      ->hasActiveEmitters();
}
...
bool UParticleSystemInstance::isShared() const {
  CParticleSystemModel *object =
      NLMISC::safe_cast<CParticleSystemModel *>(_Object);
  if (object->Shape) {
    return NLMISC::safe_cast<CParticleSystemShape *>((IShape *)object->Shape)
        ->isShared();
  }
  return false;
}
...
// ***************************************************************************
void UParticleSystemInstance::setGlobalUserParamValue(const std::string &name,
                                                      float value) {
  if (name.empty()) {
...
// ***************************************************************************
float UParticleSystemInstance::getGlobalUserParamValue(
...
// ***************************************************************************
void UParticleSystemInstance::setGlobalVectorValue(const std::string &name,
...
// ***************************************************************************
NLMISC::CVector
UParticleSystemInstance::getGlobalVectorValue(const std::string &name) {
  if (name.empty()) {
    nlwarning("invalid name");
    return NLMISC::CVector::Null;
  } else
    return CParticleSystem::getGlobalVectorValue(name);
}

// ***************************************************************************
void UParticleSystemInstance::bypassGlobalUserParamValue(
    uint userParamIndex, bool byPass /*=true*/) {
...
// ***************************************************************************
bool UParticleSystemInstance::isGlobalUserParamValueBypassed(
...
// ***************************************************************************
void UParticleSystemInstance::forceSetUserMatrix(
    const NLMISC::CMatrix &userMat) {
  CParticleSystemModel *object =
      NLMISC::safe_cast<CParticleSystemModel *>(_Object);
