...
// ***************************************************************************
void CChainQuad::getGridBounds(sint32 &x0, sint32 &y0, sint32 &x1, sint32 &y1,
...
// ***************************************************************************
void CChainQuad::addEdgeToQuadNode(list<CEdgeChainEntry> &quadNode,
                                   sint ochainId, sint edgeId) {
...
// ***************************************************************************
sint CChainQuad::selectEdges(const NLMISC::CAABBox &bbox,
...
sint CChainQuad::selectEdges(CVector start, CVector end,
                             CCollisionSurfaceTemp &cst) const {
  sint nRes = 0;
  sint i;
  uint16 *ochainLUT = cst.OChainLUT;
