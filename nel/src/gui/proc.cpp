...
void CProcAction::buildParams(const std::vector<std::string> &paramList,
...
void CProcAction::buildCond(const std::vector<std::string> &paramList,
                            std::string &params) const {
  eval(paramList, CondBlocks, params);
}

// ***************************************************************************
void CProcAction::buildBlocks(const std::string &in,
                              std::vector<CParamBlock> &out) {
  out.clear();
...
// ***************************************************************************
void CProcAction::eval(const std::vector<std::string> &inArgs,
                       const std::vector<CParamBlock> &inBlocks,
                       std::string &out) {
