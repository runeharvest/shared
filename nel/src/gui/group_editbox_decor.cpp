...
class EBDPrivate {
public:
  enum Textures { BG, L, R, TM, BM, TL, TR, BL, BR, TCOUNT };
...
NLMISC_REGISTER_OBJECT(CViewBase, CGroupEditBoxDecor, std::string,
                       "edit_box_decor");
...
void CGroupEditBoxDecor::setProperty(const std::string &name,
...
xmlNodePtr CGroupEditBoxDecor::serialize(xmlNodePtr parentNode,
  ...
  xmlSetProp(node, BAD_CAST "tx_tl",
             BAD_CAST _Pvt->_Textures[EBDPrivate::TL]->getTexture().c_str());
  xmlSetProp(node, BAD_CAST "tx_tr",
             BAD_CAST _Pvt->_Textures[EBDPrivate::TR]->getTexture().c_str());
  xmlSetProp(node, BAD_CAST "tx_tm",
             BAD_CAST _Pvt->_Textures[EBDPrivate::TM]->getTexture().c_str());
  xmlSetProp(node, BAD_CAST "tx_bl",
             BAD_CAST _Pvt->_Textures[EBDPrivate::BL]->getTexture().c_str());
  xmlSetProp(node, BAD_CAST "tx_bm",
             BAD_CAST _Pvt->_Textures[EBDPrivate::BM]->getTexture().c_str());
  xmlSetProp(node, BAD_CAST "tx_br",
             BAD_CAST _Pvt->_Textures[EBDPrivate::BR]->getTexture().c_str());
  xmlSetProp(node, BAD_CAST "tx_l",
             BAD_CAST _Pvt->_Textures[EBDPrivate::L]->getTexture().c_str());
  xmlSetProp(node, BAD_CAST "tx_r",
             BAD_CAST _Pvt->_Textures[EBDPrivate::R]->getTexture().c_str());
  xmlSetProp(node, BAD_CAST "tx_bg",
             BAD_CAST _Pvt->_Textures[EBDPrivate::BG]->getTexture().c_str());
