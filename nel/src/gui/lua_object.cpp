...
// *************************************************
CLuaObject::CLuaObject(CLuaState &state, const char *id) { pop(state, id); }
...
// *************************************************
bool CLuaObject::isValid() const { return getLuaState() != NULL; }

// *************************************************
CLuaState *CLuaObject::getLuaState() const { return _LuaState; }
...
bool CLuaObject::isNil() const {
  push();
  bool result = _LuaState->isNil();
  _LuaState->pop();
  return result;
}
bool CLuaObject::isNumber() const {
  push();
  bool result = _LuaState->isNumber();
  _LuaState->pop();
  return result;
}
bool CLuaObject::isInteger() const {
  push();
  bool result = _LuaState->isInteger();
  _LuaState->pop();
  return result;
}
bool CLuaObject::isBoolean() const {
  push();
  bool result = _LuaState->isBoolean();
  _LuaState->pop();
  return result;
}
bool CLuaObject::isString() const {
  push();
  bool result = _LuaState->isString();
  _LuaState->pop();
  return result;
}
bool CLuaObject::isFunction() const {
  push();
  bool result = _LuaState->isFunction();
  _LuaState->pop();
  return result;
}
bool CLuaObject::isCFunction() const {
  push();
  bool result = _LuaState->isCFunction();
  _LuaState->pop();
  return result;
}
bool CLuaObject::isTable() const {
  push();
  bool result = _LuaState->isTable();
  _LuaState->pop();
  return result;
}
bool CLuaObject::isUserData() const {
  push();
  bool result = _LuaState->isUserData();
  _LuaState->pop();
  return result;
}
bool CLuaObject::isLightUserData() const {
  push();
  bool result = _LuaState->isLightUserData();
  _LuaState->pop();
  return result;
}
...
// *************************************************
bool CLuaObject::toBoolean() const {
  push();
  bool result = _LuaState->toBoolean();
  _LuaState->pop();
  return result;
}
lua_Number CLuaObject::toNumber() const {
  push();
  lua_Number result = _LuaState->toNumber();
  _LuaState->pop();
  return result;
}
lua_Integer CLuaObject::toInteger() const {
  push();
  lua_Integer result = _LuaState->toInteger();
  _LuaState->pop();
  return result;
}
...
lua_CFunction CLuaObject::toCFunction() const {
  push();
  lua_CFunction result = _LuaState->toCFunction();
  _LuaState->pop();
  return result;
}
void *CLuaObject::toUserData() const {
  push();
  void *result = _LuaState->toUserData();
  _LuaState->pop();
  return result;
}
const void *CLuaObject::toPointer() const {
  push();
  const void *result = _LuaState->toPointer();
  _LuaState->pop();
  return result;
}
...
CLuaEnumeration CLuaObject::enumerate() {
  if (!isEnumerable()) {
    throw ELuaNotATable(
        NLMISC::toString("Called CLuaObject::enumerate on an object that has "
                         "no enumeration (not a table or no '__next' method in "
                         "the metatable). Object is '%s' with type '%s'",
...
CLuaObject CLuaObject::at(const char *key) const {
  if (!isEnumerable())
    throw ELuaNotATable(
        NLMISC::toString("Can't get key '%s' in object '%s' because type is "
                         "'%s', it is not a table.",
                         key, getId().c_str(), getTypename())
            .c_str());
  return operator[](key);
}
...
bool CLuaObject::hasKey(const char *key) const {
  if (!isEnumerable())
    throw ELuaNotATable(
        NLMISC::toString("Trying to access key '%s' on object '%s' of type %s.",
                         key, getId().c_str(), getTypename())
            .c_str());
...
CLuaObject CLuaObject::newTable(const char *tableName) {
  ...
  if (!isTable())
    throw ELuaNotATable(
        NLMISC::toString("Trying to create a subtable '%s' on object '%s' of "
                         "type %s (not a table).",
                         tableName, getId().c_str(), getTypename()));
  CLuaStackChecker lsc(_LuaState);
  push();
...
void CLuaObject::setValue(const char *key, const CLuaObject &value) {
  ...
  if (!isTable())
    throw ELuaNotATable(NLMISC::toString(
        "Trying to set a value '%s' on object '%s' of type %s (not a table).",
        key, getId().c_str(), getTypename()));
  CLuaStackChecker lsc(_LuaState);
  push();
  _LuaState->push(key);
...
void CLuaObject::setNil(const char *key) {
  ...
  if (!isTable())
    throw ELuaNotATable(
        NLMISC::toString("Trying to set a value 'nil' at key %s on object '%s' "
                         "of type %s (not a table).",
                         key, getId().c_str(), getTypename()));
  CLuaStackChecker lsc(_LuaState);
  push();
  _LuaState->push(key);
...
void CLuaObject::setValue(const char *key, const char *value) {
  ...
  if (!isTable())
    throw ELuaNotATable(
        NLMISC::toString("Trying to set a value '%s' at key %s on object '%s' "
                         "of type %s (not a table).",
...
void CLuaObject::setValue(const char *key, bool value) {
  ...
  if (!isTable())
    throw ELuaNotATable(NLMISC::toString(
        "Trying to set a value '%s' at key %s on object '%s' of type %s (not a "
        "table).",
        value ? "true" : "false", key, getId().c_str(), getTypename()));
  CLuaStackChecker lsc(_LuaState);
  push();
  _LuaState->push(key);
  _LuaState->push(value);
...
void CLuaObject::setValue(const char *key, TLuaWrappedFunction value) {
  ...
  if (!isTable())
    throw ELuaNotATable(
        NLMISC::toString("Trying to set a function value '%p' at key %s on "
                         "object '%s' of type %s (not a table).",
...
void CLuaObject::setValue(const char *key, double value) {
  ...
  if (!isTable())
    throw ELuaNotATable(
        NLMISC::toString("Trying to set a value '%lf' at key %s on object '%s' "
                         "of type %s (not a table).",
                         value, key, getId().c_str(), getTypename()));
  CLuaStackChecker lsc(_LuaState);
  push();
...
void CLuaObject::setValue(const char *key, uint32 value) {
  ...
  if (!isTable())
    throw ELuaNotATable(
        NLMISC::toString("Trying to set a value '%u' at key %s on object '%s' "
                         "of type %s (not a table).",
                         value, key, getId().c_str(), getTypename()));
  CLuaStackChecker lsc(_LuaState);
  push();
...
void CLuaObject::setValue(const char *key, sint32 value) {
  ...
  if (!isTable())
    throw ELuaNotATable(
        NLMISC::toString("Trying to set a value '%d' at key %s on object '%s' "
                         "of type %s (not a table).",
                         value, key, getId().c_str(), getTypename()));
  CLuaStackChecker lsc(_LuaState);
  push();
...
void CLuaObject::setValue(const char *key, sint64 value) {
  ...
  if (!isTable())
    throw ELuaNotATable(NLMISC::toString(
        "Trying to set a value '%" NL_I64
        "d' at key %s on object '%s' of type %s (not a table).",
        value, key, getId().c_str(), getTypename()));
  CLuaStackChecker lsc(_LuaState);
  push();
  _LuaState->push(key);
...
void CLuaObject::eraseValue(const char *key) {
  ...
  if (!isTable())
    throw ELuaNotATable(
        NLMISC::toString("Trying to erase a value with key '%s' on object '%s' "
                         "of type %s (not a table).",
                         key, getId().c_str(), getTypename()));
  CLuaStackChecker lsc(_LuaState);
  push();
...
bool CLuaObject::callNoThrow(int numArgs, int numRet) {
  nlassert(isValid());
  if (!isFunction()) {
    nlwarning("Calling a non function object (id = %s, type = %s)",
              getId().c_str(), getTypename());
  ...
  if (dumpFunction) {
    ...
    nlwarning((std::string(ar.what) + ", at line " +
               NLMISC::toString(ar.linedefined) + " in " +
               std::string(ar.source))
                  .c_str());
  }
  push();
...
// *************************************************
bool CLuaObject::callMethodByNameNoThrow(const char *name, int numArgs,
                                         int numRet) {
  nlassert(isValid());
  int initialStackSize = _LuaState->getTop();
  if (!isTable() && !isUserData()) {
    nlwarning("Can't call method : object is not a table (id = %s)",
              getId().c_str());
...
// *************************************************
std::string CLuaObject::toStringRecurse(
    uint depth /*=0*/, uint maxDepth /*= 20*/,
    std::set<const void *> *alreadySeen /*= NULL */) const {
  ...
  if (isEnumerable()) // is enumeration possible on that object ?
  {
    std::string result;
    if (alreadySeen) {
      if (alreadySeen->count(
              toPointer())) // avoid cyclic graph (infinite recursion else)
      {
    ...
    ENUM_LUA_TABLE(*table, it) {
      ...
      result += std::string((depth + 1) * INDENT_NUM_BLANK, ' ') +
                it.nextKey().toString() + " = ";
      if (it.nextValue().isEnumerable()) {
        result += "\n" + it.nextValue().toStringRecurse(depth + 1, maxDepth,
                                                        alreadySeen);
      } else {
...
// *************************************************
void CLuaObject::dump(uint maxDepth /*= 20*/,
                      std::set<const void *> *alreadySeen /*= NULL */) const {
  try {
...
// *************************************************
std::string CLuaObject::concatId(const std::string &left,
