...
void CFpuChecker::dumpFpu(int value) {
  ...
  case _EM_INVALID:
    nlwarning("_EM_INVALID");
    break;
  case _EM_DENORMAL:
    nlwarning("_EM_DENORMAL");
    break;
  case _EM_ZERODIVIDE:
    nlwarning("_EM_ZERODIVIDE");
    break;
  case _EM_OVERFLOW:
    nlwarning("_EM_OVERFLOW");
    break;
  case _EM_UNDERFLOW:
    nlwarning("_EM_UNDERFLOW");
    break;
  case _EM_INEXACT:
    nlwarning("_EM_INEXACT");
    break;
  default:
...
void CFpuChecker::check() {
  ...
  if (NLMISC::OptFastFloorCWStackPtr != NLMISC::OptFastFloorCWStack)
    return;
