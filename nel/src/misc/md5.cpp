...
// ****************************************************************************
string CHashKeyMD5::toString() const { return toHexa(Data, 16); }
...
// ****************************************************************************
void CHashKeyMD5::serial(NLMISC::IStream &s) { s.serialBuffer(Data, 16); }
...
// Encodes input (guint32) into output (unsigned char). Assumes len is a
// multiple of 4.
// ****************************************************************************
...
// Decodes input (unsigned char) into output (guint32). Assumes len is a
// multiple of 4.
// ****************************************************************************
