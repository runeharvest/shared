...
// ****************************************************************************
CStringMapper::CStringMapper() { m_EmptyId = new string(); }

// ****************************************************************************
CStringMapper *CStringMapper::createLocalMapper() { return new CStringMapper; }
...
TStringId CStringMapper::localMap(const std::string &str) {
  ...
  TStringTable::const_iterator it =
      m_StringTable.find((const std::string *)&str);
...
const char *CStaticStringMapper::get(TSStringId stringId) {
  if (_MemoryCompressed) {
    ...
    std::map<TSStringId, std::string>::iterator it =
        _TempIdTable.find(stringId);
...
// ****************************************************************************
void CStaticStringMapper::serial(IStream &f,
