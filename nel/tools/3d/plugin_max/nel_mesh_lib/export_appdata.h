...
#define NEL3D_APPDATA_LOD_BLEND_IN                                             \
  (NEL3D_APPDATA_LOD_NAME + NEL3D_APPDATA_LOD_NAME_COUNT_MAX)
...
#define NEL3D_APPDATA_LOD_DISTANCE_MIDDLE                                      \
  (NEL3D_APPDATA_LOD_DISTANCE_FINEST + 1)
#define NEL3D_APPDATA_LOD_DISTANCE_COARSEST                                    \
  (NEL3D_APPDATA_LOD_DISTANCE_MIDDLE + 1)
...
#define NEL3D_APPDATA_EXPORT_LMC_DIFFUSE_START                                 \
  NEL3D_APPDATA_EXPORT_LMC_AMBIENT_START +                                     \
