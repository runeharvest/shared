...
bool CNelExport::exportCollision(const std::string &sPath,
  ...
  /*
     ...
     CExportNel::createCollisionMeshBuild(nodes, time);
...
/*
bool CNelExport::exportCollision (const char *sPath, INode& node, Interface&
_Ip, TimeValue time, CExportNelOptions &opt)
{
    // Result to return
    bool bRet=false;
    ...
    {
        CCollisionMeshBuild	*pCmb =
CExportNel::createCollisionMeshBuild(node, time);
...
bool CNelExport::exportPACSPrimitives(const std::string &sPath,
