...
int main(int argc, char *argv[]) {
  ...
  if (argc != 3) {
    // Output an help
    printf("animation_set_builder [animation_set.animset] [animation.anim]\n"
           "\tThis command line add or replace the animation.anim animation "
           "into the animation_set.animset animation set\n");
  } else {
    try {
      // Tha animation set
