...
CMainWindow::CMainWindow(const QMap<QString, QSize> &customSizeHints,
    ...
    : QMainWindow(parent, flags), m_PanoplyPreview(NULL), m_CommandLog(NULL),
      m_CommandLogDock(NULL), m_WidgetsMenu(NULL), m_HelpMenu(NULL),
      m_AboutAct(NULL) {
...
void CMainWindow::createStatusBar() { statusBar()->showMessage(tr("Ready")); }
...
void CMainWindow::about() {
  QMessageBox::about(this, tr("Panoply Preview"),
                     tr("Copyright (C) 2014  Jan BOON (jan.boon@kaetemi.be)"));
}
