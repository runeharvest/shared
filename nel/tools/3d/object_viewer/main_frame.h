...
typedef void (*winProc)(NL3D::IDriver *drv, HWND hWnd, UINT message,
...
public:
  ...
  bool isMoveObjectLightTest() const {
    return MouseMoveType == MoveObjectLightTest;
  }
...
public:
  ...
  // The default behaviour of CFrameWnd::PostNcDestroy() is to call 'delete
  // this'. We dont want that behaviour, we want the object viewer to call this
