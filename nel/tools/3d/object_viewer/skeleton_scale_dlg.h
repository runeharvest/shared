...
#if !defined(                                                                  \
    AFX_SKELETON_SCALE_DLG_H__4684D63E_9A55_47E7_BE43_F5C4CD86F211__INCLUDED_)
...
class CSkeletonScaleDlg : public CDialog {
  // Construction
public:
  CSkeletonScaleDlg(CObjectViewer *viewer,
...
public:
  ...
  void setSkeletonToEdit(NL3D::CSkeletonModel *skel,
...
protected:
  ...
  afx_msg void OnReleasedcaptureSsdSliderBoneSx(NMHDR *pNMHDR,
                                                LRESULT *pResult);
  afx_msg void OnReleasedcaptureSsdSliderBoneSy(NMHDR *pNMHDR,
                                                LRESULT *pResult);
  afx_msg void OnReleasedcaptureSsdSliderBoneSz(NMHDR *pNMHDR,
                                                LRESULT *pResult);
  afx_msg void OnReleasedcaptureSsdSliderSkinSx(NMHDR *pNMHDR,
                                                LRESULT *pResult);
  afx_msg void OnReleasedcaptureSsdSliderSkinSy(NMHDR *pNMHDR,
                                                LRESULT *pResult);
  afx_msg void OnReleasedcaptureSsdSliderSkinSz(NMHDR *pNMHDR,
                                                LRESULT *pResult);
...
private:
  ...
  // bkup the current _Bones in the undo queue, and clear the redo. dirtSave
  // indicate the skel need saving NB: compare precState with _Bones. if same,
  // then no-op!
