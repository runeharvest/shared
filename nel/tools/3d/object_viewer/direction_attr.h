...
#if !defined(                                                                  \
    AFX_DIRECTION_ATTR_H__C906E2A2_917C_4F4A_B771_5656204914F5__INCLUDED_)
...
/** This dialog helps to choose from several preset directions, or to choose a
 * custom one. This also allow to bind the direction to a global variable when
 * it is supported
 */
...
public:
  ...
  /** The CPSDirection object is used to see if a global variable can be bound
   * to the direction. When set to NULL it has no effect (the default)
   */
