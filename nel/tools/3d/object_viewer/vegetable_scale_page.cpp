...
CVegetableScalePage::CVegetableScalePage()
    : CPropertyPage(CVegetableScalePage::IDD), _SxyDlg(NULL), _SzDlg(NULL),
...
void CVegetableScalePage::setVegetableToEdit(NL3D::CVegetable *vegetable) {
  ...
  if (_Vegetable) {
    ...
    _BendFreqFactorDlg->setFloat(&_Vegetable->BendFrequencyFactor,
                                 _VegetableDlg);
  }
}
...
BOOL CVegetableScalePage::OnInitDialog() {
  ...
  _SxyDlg->setDefaultRangeAbs(NL_VEGETABLE_SCALE_RANGE_MIN,
                              NL_VEGETABLE_SCALE_RANGE_MAX);
  _SxyDlg->setDefaultRangeRand(NL_VEGETABLE_SCALE_RANGE_MIN,
                               NL_VEGETABLE_SCALE_RANGE_MAX);
  _SxyDlg->setDefaultRangeFreq(NL_VEGETABLE_FREQ_RANGE_MIN,
  ...
  _SzDlg->setDefaultRangeAbs(NL_VEGETABLE_SCALE_RANGE_MIN,
                             NL_VEGETABLE_SCALE_RANGE_MAX);
  _SzDlg->setDefaultRangeRand(NL_VEGETABLE_SCALE_RANGE_MIN,
                              NL_VEGETABLE_SCALE_RANGE_MAX);
  _SzDlg->setDefaultRangeFreq(NL_VEGETABLE_FREQ_RANGE_MIN,
                              NL_VEGETABLE_FREQ_RANGE_MAX);
  _SzDlg->init(x, y, this);
  y += CVegetableNoiseValueDlg::ControlHeight + spaceDy;

  // Init BendFreqFactorDlg Dialog.
  _BendFreqFactorDlg = new CDirectEditableRangeFloat(
      std::string("VEGET_BEND_FREQ_FACTOR"), NL_VEGETABLE_BENDFREQ_RANGE_MIN,
      NL_VEGETABLE_BENDFREQ_RANGE_MAX, "FreqFactor");
