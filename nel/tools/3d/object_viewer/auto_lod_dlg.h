...
#if !defined(                                                                  \
    AFX_AUTO_LOD_DLG_H__BCD6DB9A_FA8A_47AD_9E95_317A8B94047A__INCLUDED_)
...
class CAutoLODDlg : public CDialog, public CDialogStack {
  // Construction
public:
  CAutoLODDlg(CParticleWorkspace::CNode *ownerNode, NL3D::CParticleSystem *ps,
              IPopupNotify *pn, CWnd *pParent = NULL); // standard constructor
