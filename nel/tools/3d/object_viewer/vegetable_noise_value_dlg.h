...
#if !defined(                                                                  \
    AFX_VEGETABLE_NOISE_VALUE_DLG_H__9845CF5F_B7BB_4D55_9153_443BDC89613C__INCLUDED_)
...
public:
  ...
  CVegetableNoiseValueDlg(
      const std::string &noiseValueName); // standard constructor
  ~CVegetableNoiseValueDlg();
...
protected:
  ...
  afx_msg void OnReleasedcaptureSliderVegetableScaleNoise(NMHDR *pNMHDR,
                                                          LRESULT *pResult);
