...
CConstraintMeshGlobalTexAnimDlg::CConstraintMeshGlobalTexAnimDlg(
    NL3D::CPSConstraintMesh *cm, uint stage, CWnd *pParent /*= NULL*/)
    : _CM(cm), _Stage(stage),
...
BOOL CConstraintMeshGlobalTexAnimDlg::OnInitDialog() {
  ...
  const NL3D::CPSConstraintMesh::CGlobalTexAnim &gta =
      _CM->getGlobalTexAnim(_Stage);
