...
#if !defined(                                                                  \
    AFX_VEGETABLE_WIND_DLG_H__2A8C3E24_6763_4B2C_AFD4_DD6F74D3871E__INCLUDED_)
...
class CVegetableWindDlg : public CDialog {
  // Construction
public:
  CVegetableWindDlg(CObjectViewer *objViewer,
...
protected:
  ...
  afx_msg void OnReleasedcaptureSliderVegetableWindBendstart(NMHDR *pNMHDR,
                                                             LRESULT *pResult);
  afx_msg void OnReleasedcaptureSliderVegetableWindFrequency(NMHDR *pNMHDR,
                                                             LRESULT *pResult);
  afx_msg void OnReleasedcaptureSliderVegetableWindPower(NMHDR *pNMHDR,
                                                         LRESULT *pResult);
