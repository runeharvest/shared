...
//============================================================================================
CConstraintMeshDlg::CConstraintMeshDlg(NL3D::CPSConstraintMesh *cm,
                                       CWnd *pParent /*=NULL*/)
...
void CConstraintMeshDlg::OnForceStage0Modulation() {
  UpdateData();
  _CM->forceStageModulationByColor(
      0, m_ForceStage0Modulation ? true : false /* VC  WARNING */);
}

void CConstraintMeshDlg::OnForceStage1Modulation() {
  UpdateData();
  _CM->forceStageModulationByColor(
      1, m_ForceStage0Modulation ? true : false /* VC  WARNING */);
}

void CConstraintMeshDlg::OnForceStage2Modulation() {
  UpdateData();
  _CM->forceStageModulationByColor(
      2, m_ForceStage0Modulation ? true : false /* VC  WARNING */);
}

void CConstraintMeshDlg::OnForceStage3Modulation() {
  UpdateData();
  _CM->forceStageModulationByColor(
      3, m_ForceStage0Modulation ? true : false /* VC  WARNING */);
}

void CConstraintMeshDlg::OnForceVertexColorLighting() {
  UpdateData();
  _CM->forceVertexColorLighting(
      m_ForceVertexColorLighting ? true : false /* VC  WARNING */);
}
