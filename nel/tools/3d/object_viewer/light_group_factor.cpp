...
void CLightGroupFactor::OnHScroll(UINT nSBCode, UINT nPos,
...
// ***************************************************************************
void CLightGroupFactor::OnButtonColorEnd0() { chooseColor(ColorEnd0); }

void CLightGroupFactor::OnButtonColorEnd1() { chooseColor(ColorEnd1); }

void CLightGroupFactor::OnButtonColorEnd2() { chooseColor(ColorEnd2); }

void CLightGroupFactor::OnButtonColorStart0() { chooseColor(ColorStart0); }

void CLightGroupFactor::OnButtonColorStart1() { chooseColor(ColorStart1); }

void CLightGroupFactor::OnButtonColorStart2() { chooseColor(ColorStart2); }
