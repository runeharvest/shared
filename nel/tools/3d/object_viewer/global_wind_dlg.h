...
#if !defined(                                                                  \
    AFX_GLOBAL_WIND_DLG_H__E98702D3_6CD0_4B43_B44D_A0663D168D18__INCLUDED_)
...
class CGlobalWindDlg : public CDialog {
  // Construction
public:
  CGlobalWindDlg(CObjectViewer *objViewer,
...
protected:
  ...
  afx_msg void OnReleasedcaptureSliderGlobalWindPower(NMHDR *pNMHDR,
                                                      LRESULT *pResult);
