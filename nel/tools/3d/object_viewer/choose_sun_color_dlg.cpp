...
//*************************************************************************************************
CChooseSunColorDlg::CChooseSunColorDlg(NL3D::CScene *scene,
                                       CWnd *pParent /*=NULL*/)
    : CDialog(CChooseSunColorDlg::IDD, pParent), _DiffuseColorEdit(NULL),
      _AmbientColorEdit(NULL), _SpecularColorEdit(NULL) {
