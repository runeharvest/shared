...
#if !defined(                                                                  \
    AFX_EDIT_PS_SOUND_H__E11AAB2A_04BB_453A_B722_AA47DB840D5A__INCLUDED_)
...
class CEditPSSound : public CDialog {
  // Construction
public:
  CEditPSSound(CParticleWorkspace::CNode *ownerNode,
               NL3D::CPSSound *sound); // standard constructor
...
protected:
  ...
  CEditableRangeFloat
      *_PercentDlg; // dlg to tune the percent of sound emissions
