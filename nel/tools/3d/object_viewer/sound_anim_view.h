...
public:
  ...
  CSoundAnimationHolder(NLSOUND::CSoundAnimation *anim = 0, float start = 0.0f,
                        float end = 0.0f)
...
public:
  ...
  virtual void Create(CObjectViewer *objView, CAnimationDlg *animDlg,
                      CSoundAnimDlg *parent, const RECT &rect);
...
protected:
  ...
  static uint _WndId;
  static const float
      _Scale; // conversion time to pixels: pixel = time * _Zoom * _Scale
