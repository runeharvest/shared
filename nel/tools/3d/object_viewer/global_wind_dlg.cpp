...
CGlobalWindDlg::CGlobalWindDlg(CObjectViewer *objViewer,
                               CWnd *pParent /*=NULL*/)
...
ON_NOTIFY(NM_RELEASEDCAPTURE, IDC_SLIDER_GLOBAL_WIND_POWER,
...
// ***************************************************************************
void CGlobalWindDlg::OnReleasedcaptureSliderGlobalWindPower(NMHDR *pNMHDR,
                                                            LRESULT *pResult) {
  float a;
...
// ***************************************************************************
void CGlobalWindDlg::OnHScroll(UINT nSBCode, UINT nPos,
                               CScrollBar *pScrollBar) {
  // test if one of my sliders.
  CSliderCtrl *sliderCtrl = (CSliderCtrl *)pScrollBar;
  if (sliderCtrl == &SliderPower && nSBCode == SB_THUMBPOSITION ||
