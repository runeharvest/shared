...
#if !defined(                                                                  \
    AFX_EDIT_PS_LIGHT_H__6F00004D_F2A5_452E_9FC2_8188F9164613__INCLUDED_)
...
class CEditPSLight : public CDialog {
  // Construction
public:
  CEditPSLight(CParticleWorkspace::CNode *ownerNode,
               NL3D::CPSLight *light); // standard constructor
  ~CEditPSLight();
