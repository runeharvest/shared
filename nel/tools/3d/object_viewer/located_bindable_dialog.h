...
#if !defined(                                                                  \
    AFX_LOCATED_BINDABLE_DIALOG_H__C715DCAB_3F07_4777_96DA_61AE2E420B09__INCLUDED_)
...
public:
  ...
  CLocatedBindableDialog(
      ...
      NL3D::CPSLocatedBindable *bindable); // standard constructor
...
protected:
  ...
  void updateZBias();
  /// create the size control, or update it if it has been created. It returns
  /// the heivht of the control
  ...
  // plane basis //
  /////////////////
  struct CPlaneBasisWrapper : public IPSWrapper<NL3D::CPlaneBasis>,
                              IPSSchemeWrapper<NL3D::CPlaneBasis> {
