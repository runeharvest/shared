...
public:
  // this enum match the option in the combo box that allow to choose how the
  // direction of emission is computed.
  enum TDirectionMode {
    Default = 0,
...
public:
  CEmitterDlg(CParticleWorkspace::CNode *ownerNode, NL3D::CPSEmitter *emitter,
              CParticleDlg *particleDlg); // standard constructor
...
protected:
  ...
  struct CModulateStrenghtWrapper : public IPSWrapperFloat,
