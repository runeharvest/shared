...
CVegetableWindDlg::CVegetableWindDlg(CObjectViewer *objViewer,
                                     CWnd *pParent /*=NULL*/)
...
ON_NOTIFY(NM_RELEASEDCAPTURE, IDC_SLIDER_VEGETABLE_WIND_BENDSTART,
          OnReleasedcaptureSliderVegetableWindBendstart)
ON_NOTIFY(NM_RELEASEDCAPTURE, IDC_SLIDER_VEGETABLE_WIND_FREQUENCY,
          OnReleasedcaptureSliderVegetableWindFrequency)
ON_NOTIFY(NM_RELEASEDCAPTURE, IDC_SLIDER_VEGETABLE_WIND_POWER,
...
void CVegetableWindDlg::updateView() {
  ...
  SliderPower.SetPos((sint)(a * NL_VEGETABLE_EDIT_WIND_SLIDER_RANGE /
  ...
  SliderBendStart.SetPos((sint)(a * NL_VEGETABLE_EDIT_WIND_SLIDER_RANGE /
  ...
  SliderFrequency.SetPos((sint)(a * NL_VEGETABLE_EDIT_WIND_SLIDER_RANGE /
...
// ***************************************************************************
void CVegetableWindDlg::OnReleasedcaptureSliderVegetableWindPower(
    NMHDR *pNMHDR, LRESULT *pResult) {
  float a;
  a = (float)SliderPower.GetPos() * NL_VEGETABLE_EDIT_WIND_MAX_POWER /
      NL_VEGETABLE_EDIT_WIND_SLIDER_RANGE;
  _ObjViewer->setVegetableWindPower(a);
...
// ***************************************************************************
void CVegetableWindDlg::OnReleasedcaptureSliderVegetableWindBendstart(
    NMHDR *pNMHDR, LRESULT *pResult) {
  float a;
  a = (float)SliderBendStart.GetPos() * NL_VEGETABLE_EDIT_WIND_MAX_BENDSTART /
      NL_VEGETABLE_EDIT_WIND_SLIDER_RANGE;
  _ObjViewer->setVegetableWindBendStart(a);
...
// ***************************************************************************
void CVegetableWindDlg::OnReleasedcaptureSliderVegetableWindFrequency(
    NMHDR *pNMHDR, LRESULT *pResult) {
  float a;
  a = (float)SliderFrequency.GetPos() * NL_VEGETABLE_EDIT_WIND_MAX_FREQUENCY /
      NL_VEGETABLE_EDIT_WIND_SLIDER_RANGE;
  _ObjViewer->setVegetableWindFrequency(a);
