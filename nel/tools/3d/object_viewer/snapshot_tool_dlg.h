...
#if !defined(                                                                  \
    AFX_SNAPSHOT_TOOL_DLG_H__46526215_8CE7_4A83_BF42_056578B50D2A__INCLUDED_)
...
class CSnapshotToolDlg : public CDialog {
  // Construction
public:
  enum { OutputFormat_Tga, OutputFormat_Png, OutputFormat_Jpg };
  ...
  CSnapshotToolDlg(CObjectViewer *ov,
...
private:
  ...
  void toRegistry();
  void stringFromRegistry(HKEY hKey, const TCHAR *name, CString &dest,
                          const CString &defaultStr);
  void updateUIEnabledState();

  static void setCamFromView(uint view, NL3D::CCamera *cam,
