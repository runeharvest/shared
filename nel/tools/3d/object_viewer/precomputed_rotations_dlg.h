...
#if !defined(                                                                  \
    AFX_PRECOMPUTED_ROTATIONS_DLG_H__D7F383B7_AE48_4BFF_9E3E_AA41A8BE76A5__INCLUDED_)
...
public:
   ...
   *  \param toDisable a window that is disabled when precomputed rotation are
   * activated (null = none)
   */
  CPrecomputedRotationsDlg(
      CParticleWorkspace::CNode *ownerNode,
      NL3D::CPSHintParticleRotateTheSame *prts,
      class CAttribDlg *toDisable = NULL); // standard constructor
...
protected:
  ...
  // Implementation
protected:
  // anable / disable the controls for the tuning of the number of prerotated
  // models
