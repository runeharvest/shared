...
#if !defined(                                                                  \
    AFX_MULTI_TEX_DLG_H__5D160C02_0FF4_4DF3_A804_90CE96C4F448__INCLUDED_)
...
class CMultiTexDlg : public CDialog {
  // Construction
public:
  CMultiTexDlg(CParticleWorkspace::CNode *ownerNode,
               NL3D::CPSMultiTexturedParticle *mtp, IPopupNotify *pn,
