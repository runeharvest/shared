...
/** A CEdit control, that is selected when the focus is on it, and that can
 * notify a listener when return is pressed. It can be setup to contains a given
 * type.
 */
