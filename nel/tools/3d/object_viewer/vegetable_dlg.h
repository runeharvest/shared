...
#if !defined(                                                                  \
    AFX_VEGETABLE_DLG_H__4E65E757_88C9_4FCE_94CC_9E429D8DFD68__INCLUDED_)
...
class CVegetableDlg : public CDialog, public IVegetableRefresh {
  // Construction
public:
  CVegetableDlg(CObjectViewer *viewer,
...
protected:
   ...
   * \param keepDefaultShapeName if true, then vegetables with a
   * ShapeName.empty() are kept. \param keepHiden if true, then vegetables maked
   * as hiden in ObjectViewer are kept.
   */
  void buildVegetableSet(NL3D::CTileVegetableDesc &vegetSet,
                         bool keepDefaultShapeName = true,
                         bool keepHiden = true);
