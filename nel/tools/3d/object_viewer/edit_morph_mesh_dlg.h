...
#if !defined(                                                                  \
    AFX_EDIT_MORPH_MESH_DLG_H__62813786_A4E1_47E1_9EEF_4D169F270483__INCLUDED_)
...
class CEditMorphMeshDlg : public CDialog, public CDialogStack {
  // Construction
public:
  CEditMorphMeshDlg(CParticleWorkspace::CNode *ownerNode,
                    NL3D::CPSConstraintMesh *cm, CWnd *pParent,
                    CParticleDlg *particleDlg,
                    IPopupNotify *pn = NULL); // standard constructor
