...
#if !defined(                                                                  \
    AFX_PARTICLE_SYSTEM_EDIT_H__CD8281FA_CA1A_4D87_B54F_509D490066A9__INCLUDED_)
...
class CParticleSystemEdit : public CDialog,
                            public CDialogStack,
                            public IPopupNotify {
  // Construction
public:
  CParticleSystemEdit(CParticleWorkspace::CNode *ownerNode,
                      CParticleTreeCtrl *ptc); // standard constructor
