...
#if !defined(                                                                  \
    AFX_VEGETABLE_LIST_COLOR_H__4F2D3BE1_B010_4A29_8452_C0E274B69743__INCLUDED_)
...
public:
  ...
  // itemXXX is the total space taken by an item. squareXXX is the size of the
  // colored square
  void setupItem(uint itemWidth, uint itemHeight, uint squareWidth,
                 uint squareHeight);
