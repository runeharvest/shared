...
CVegetableCopyDlg::CVegetableCopyDlg(CVegetableDlg *vegetableDlg,
                                     CWnd *pParent /*=NULL*/)
...
ON_BN_CLICKED(IDC_BUTTON_VEGETABLE_APPEARANCE_NONE,
...
void CVegetableCopyDlg::OnOK() {
  ...
  if (VegetableSelected != LB_ERR) {
    ...
    MessageBox(_T("Select a  vegetable to copy first"), _T("Error"),
