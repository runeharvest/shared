...
#if !defined(                                                                  \
    AFX_CONSTRAINT_MESH_GLOBAL_TEX_ANIM_DLG_H__8676F219_18E6_4626_BE10_5A429D1EA0CD__INCLUDED_)
...
class CConstraintMeshGlobalTexAnimDlg : public CDialog,
                                        public CEditEx::IListener {
  // Construction
public:
  CConstraintMeshGlobalTexAnimDlg(NL3D::CPSConstraintMesh *cm, uint stage,
