...
#if !defined(                                                                  \
    AFX_WATER_POOL_EDITOR_H__E6DAABC1_AD21_42EB_9DA4_A0AFBAE7C47C__INCLUDED_)
...
protected:
  ...
  struct CFilterWeightWrapper : IPSWrapperFloat {
    ...
    float get(void) const {
      nlassert(Whm);
      return Whm->getFilterWeight();
    }
    void set(const float &v) {
      nlassert(Whm);
      Whm->setFilterWeight(v);
    }
  ...
  struct CImpulsionStrenghtWrapper : IPSWrapperFloat {
    ...
    float get(void) const {
      nlassert(Whm);
      return Whm->getWaveIntensity();
    }
    void set(const float &v) {
      nlassert(Whm);
      Whm->setWaves(v, Whm->getWavePeriod(), Whm->getWaveImpulsionRadius(),
                    Whm->getBorderWaves());
    }
  ...
  struct CWavePeriodWrapper : IPSWrapperFloat {
    ...
    float get(void) const {
      nlassert(Whm);
      return Whm->getWavePeriod();
    }
    void set(const float &v) {
      nlassert(Whm);
      Whm->setWaves(Whm->getWaveIntensity(), v, Whm->getWaveImpulsionRadius(),
                    Whm->getBorderWaves());
    }
  ...
  struct CWaveImpulsionRadiusWrapper : IPSWrapperUInt {
    ...
    uint32 get(void) const {
      nlassert(Whm);
      return Whm->getWaveImpulsionRadius();
    }
    void set(const uint32 &v) {
      nlassert(Whm);
      Whm->setWaves(Whm->getWaveIntensity(), Whm->getWavePeriod(), v,
                    Whm->getBorderWaves());
    }
