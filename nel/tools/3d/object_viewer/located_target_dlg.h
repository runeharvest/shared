...
#if !defined(                                                                  \
    AFX_LOCATED_TARGET_DLG_H__FA197835_AE71_4057_88A4_48F28A01E367__INCLUDED_)
...
class CLocatedTargetDlg : public CDialog, public CDialogStack {
  // Construction
public:
  CLocatedTargetDlg(CParticleWorkspace::CNode *ownerNode,
                    NL3D::CPSTargetLocatedBindable *blTarget,
