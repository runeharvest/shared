...
*/
namespace NLQT {
class CObjectViewerWidget : public QWidget, public IObjectViewer {
  Q_OBJECT
...
public:
  ...
  void saveScreenshot(const std::string &nameFile, bool jpg, bool png,
                      bool tga);
  ...
  inline NL3D::UPlayListManager *getPlayListManager() {
    return _PlayListManager;
  }

  void setCamera(NL3D::UScene *scene, NLMISC::CAABBox &bbox,
                 NL3D::UTransform &entity, bool high_z = false);
  bool setupLight(const NLMISC::CVector &position,
