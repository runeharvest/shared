...
std::string CConfig::className() const { return "Config"; }
...
void CConfig::clean() { CStorageContainer::clean(); }

void CConfig::build(uint16 version, uint filter) {
  CStorageContainer::build(version);
}

void CConfig::disown() { CStorageContainer::disown(); }
...
std::string CConfig20a0::className() const { return "Config20a0"; }

void CConfig20a0::toString(std::ostream &ostream,
...
void CConfig20a0::clean() { CStorageContainer::clean(); }

void CConfig20a0::build(uint16 version, uint filter) {
  CStorageContainer::build(version);
}

void CConfig20a0::disown() { CStorageContainer::disown(); }
...
std::string CConfig20a0Entry::className() const { return "Config20a0Entry"; }

void CConfig20a0Entry::toString(std::ostream &ostream,
                                const std::string &pad) const {
  CStorageContainer::toString(ostream, pad);
}
...
void CConfig20a0Entry::clean() { CStorageContainer::clean(); }

void CConfig20a0Entry::build(uint16 version, uint filter) {
  CStorageContainer::build(version);
}

void CConfig20a0Entry::disown() { CStorageContainer::disown(); }
...
std::string CConfigScript::className() const { return "ConfigScript"; }

void CConfigScript::toString(std::ostream &ostream,
                             const std::string &pad) const {
  CStorageContainer::toString(ostream, pad);
}
...
void CConfigScript::clean() { CStorageContainer::clean(); }

void CConfigScript::build(uint16 version, uint filter) {
  CStorageContainer::build(version);
}

void CConfigScript::disown() { CStorageContainer::disown(); }
...
void CConfigScriptEntry::toString(std::ostream &ostream,
                                  const std::string &pad) const {
  CStorageContainer::toString(ostream, pad);
}
...
void CConfigScriptEntry::clean() { CStorageContainer::clean(); }

void CConfigScriptEntry::build(uint16 version, uint filter) {
  CStorageContainer::build(version);
}

void CConfigScriptEntry::disown() { CStorageContainer::disown(); }
...
void CConfigScriptHeader::toString(std::ostream &ostream,
                                   const std::string &pad) const {
  ostream << "(" << className() << ") { ";
...
void CConfigScriptMetaContainer::toString(std::ostream &ostream,
                                          const std::string &pad) const {
  CStorageContainer::toString(ostream, pad);
}
...
void CConfigScriptMetaContainer::clean() { CStorageContainer::clean(); }

void CConfigScriptMetaContainer::build(uint16 version, uint filter) {
  CStorageContainer::build(version);
}

void CConfigScriptMetaContainer::disown() { CStorageContainer::disown(); }

IStorageObject *CConfigScriptMetaContainer::createChunkById(uint16 id,
                                                            bool container) {
  if (container) {
    switch (id) {
    case 0x0007: // ConfigScriptMetaContainer
    ...
    case 0x0060: // ConfigScriptMetaContainerHeader (contains the number of
                 // entries, amusingly)
      return new CStorageValue<uint32>();
    }
  }
...
void CConfigScriptMetaString::toString(std::ostream &ostream,
                                       const std::string &pad) const {
