...
public:
  CScene(const CSceneClassRegistry *sceneClassRegistry,
...
public:
  CSceneClassContainer(CScene *scene,
                       const CSceneClassRegistry *sceneClassRegistry,
                       CDllDirectory *dllDirectory,
                       CClassDirectory3 *classDirectory3);
