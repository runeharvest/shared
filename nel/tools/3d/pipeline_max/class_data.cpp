...
std::string CClassData::className() const { return "ClassData"; }
...
void CClassData::clean() { CStorageContainer::clean(); }

void CClassData::build(uint16 version, uint filter) {
  CStorageContainer::build(version);
}

void CClassData::disown() { CStorageContainer::disown(); }
...
std::string CClassDataEntry::className() const { return "ClassDataEntry"; }

void CClassDataEntry::toString(std::ostream &ostream,
...
void CClassDataEntry::clean() { CStorageContainer::clean(); }

void CClassDataEntry::build(uint16 version, uint filter) {
  CStorageContainer::build(version);
}

void CClassDataEntry::disown() { CStorageContainer::disown(); }
...
std::string CClassDataHeader::className() const { return "ClassDataHeader"; }
...
void CClassDataHeader::toString(std::ostream &ostream,
                                const std::string &pad) const {
  ostream << "(" << className() << ") { ";
