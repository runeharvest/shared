...
public:
   ...
   */
  static bool buildZoneTemplate(INode *pNode, const PatchMesh &patchMesh,
   ...
   */
  static bool loadLigoConfigFile(CLigoConfig &config, Interface &it,
                                 bool dialog);
   ...
   * \param dialog is true to see the message in a dilog, false to see it in the
   * script window.
   */
  static void errorMessage(const std::string &msg, const std::string &title,
