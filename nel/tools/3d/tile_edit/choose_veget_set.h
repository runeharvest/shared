...
#if !defined(                                                                  \
    AFX_CHOOSE_VEGET_SET_H__EA817A1B_515D_4FD8_984F_35155195041C__INCLUDED_)
...
class CChooseVegetSet : public CDialog {
  // Construction
public:
  CChooseVegetSet(SelectionTerritoire *pParent,
                  const std::string &oldFile); // standard constructor
