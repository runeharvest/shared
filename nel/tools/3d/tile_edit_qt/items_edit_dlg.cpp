...
void CItems_edit_dlg::initDialog(const QString &title, const QString &label,
                                 const QStringList &availableItemsList,
                                 const QStringList &selectedItemsList) {
...
QStringList CItems_edit_dlg::getItems(QWidget *parent, const QString &title,
                                      const QString &label,
                                      const QStringList &availableList,
                                      const QStringList &selectedList, bool *ok,
                                      Qt::WindowFlags f) {
