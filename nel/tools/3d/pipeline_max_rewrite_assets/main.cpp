...
// const char *SrcDirectoryRecursive =
// "w:\\database\\stuff\\fyros\\city\\newpositionville\\";
const char *SrcDirectoryRecursiveInit = "w:\\database\\";
// const char *SrcDirectoryRecursiveHandle =
// "w:\\database\\stuff\\generique\\agents\\accessories\\"; const char
// *SrcDirectoryRecursiveHandle =
// "w:\\database\\landscape\\ligo\\primes_racines\\max\\";
const char *SrcDirectoryRecursiveHandle =
    "w:\\database\\stuff\\fyros\\decors\\constructions\\";

bool UseFallbackTga = false;
const char *FallbackTga =
...
std::string rewritePath(const std::string &path,
  ...
  NLMISC::strFindReplace(stdPath, "\\\\amiga\\3d\\database\\",
                         databaseDirectory);
  ...
  NLMISC::strFindReplace(stdPath, "fy_hof_cheveux_shave01",
                         "fy_hof_cheveux_shave");

  NLMISC::strFindReplace(
      stdPath, "matis\\agents\\_textures\\actors\\ma_hom_underwear_avtbras",
      "tryker\\agents\\_textures\\actors\\tr_hom_underwear_avtbras");
  NLMISC::strFindReplace(
      stdPath, "matis\\agents\\_textures\\actors\\ma_hom_underwear_epaule",
      "tryker\\agents\\_textures\\actors\\tr_hom_underwear_epaule");
  NLMISC::strFindReplace(
      stdPath,
      "matis\\agents\\_textures\\actors\\ma_hom_underwear_hand-downside",
      "tryker\\agents\\_textures\\actors\\tr_hom_underwear_hand-downside");
  NLMISC::strFindReplace(
      stdPath, "matis\\agents\\_textures\\actors\\ma_hom_underwear_hand-upside",
      "tryker\\agents\\_textures\\actors\\tr_hom_underwear_hand-upside");
  NLMISC::strFindReplace(
      stdPath, "matis\\agents\\_textures\\actors\\ma_hom_underwear_molet",
      "tryker\\agents\\_textures\\actors\\tr_hom_underwear_molet");
  NLMISC::strFindReplace(
      stdPath,
      "matis\\agents\\_textures\\actors\\ma_hof_underwear_hand-downside",
      "tryker\\agents\\_textures\\actors\\tr_hof_underwear_hand-downside");
  NLMISC::strFindReplace(
      stdPath, "matis\\agents\\_textures\\actors\\ma_hof_underwear_hand-upside",
      "tryker\\agents\\_textures\\actors\\tr_hof_underwear_hand-upside");

  NLMISC::strFindReplace(stdPath, "tr_hof_underwear_torso",
                         "tr_hof_underwear_torse");
  NLMISC::strFindReplace(stdPath, "tr_hof_underwear_hand-",
                         "tr_hof_underwear_hand_");

  NLMISC::strFindReplace(stdPath, "fy_hom_armor00_avbras.",
                         "fy_hom_armor00_avbras_c1.");
  NLMISC::strFindReplace(stdPath, "fy_hom_armor00_bottes.",
                         "fy_hom_armor00_bottes_c1.");
  NLMISC::strFindReplace(stdPath, "fy_hom_armor00_bras.",
                         "fy_hom_armor00_bras_c1.");
  NLMISC::strFindReplace(stdPath, "fy_hom_armor00_cuissear.",
                         "fy_hom_armor00_cuissear_c1.");
  NLMISC::strFindReplace(stdPath, "fy_hom_armor00_cuisseav.",
                         "fy_hom_armor00_cuisseav_c1.");
  NLMISC::strFindReplace(stdPath, "fy_hom_armor00_dos.",
                         "fy_hom_armor00_dos_c1.");
  NLMISC::strFindReplace(stdPath, "fy_hom_armor00_hand-downside.",
                         "fy_hom_armor00_hand-downside_c1.");
  NLMISC::strFindReplace(stdPath, "fy_hom_armor00_hand-upside.",
                         "fy_hom_armor00_hand-upside_c1.");
  NLMISC::strFindReplace(stdPath, "fy_hom_armor00_pieds.",
                         "fy_hom_armor00_pieds_c1.");
  NLMISC::strFindReplace(stdPath, "fy_hom_armor00_torse.",
                         "fy_hom_armor00_torse_c1.");

  NLMISC::strFindReplace(stdPath, "fy-hof-gilet02-dos",
                         "fy_hof_gilet02_arriere_n");
  NLMISC::strFindReplace(stdPath, "fy-hof-pantalon02-arriere",
                         "fy_hof_pantalon02_arriere_n");
  NLMISC::strFindReplace(stdPath, "fy-hof-pantalon02-avant",
                         "fy_hof_pantalon02_avant_n");
  NLMISC::strFindReplace(stdPath, "fy-hom-blouson02-avantbras",
                         "fy_hom_blouson02_avbras_n");
  NLMISC::strFindReplace(stdPath, "fy-hom-blouson02-bras",
                         "fy_hom_blouson02_bras_n");
  NLMISC::strFindReplace(stdPath, "fy-hom-blouson02-dos",
                         "fy_hom_blouson02_arriere_n");
  NLMISC::strFindReplace(stdPath, "fy-hom-blouson02-torse",
                         "fy_hom_blouson02_avant_n");
  NLMISC::strFindReplace(stdPath, "fy-hom-pantalon02-mollet",
                         "fy_hom_pantalon02_mollet_n");
  NLMISC::strFindReplace(stdPath, "fy-hom-shoes02", "fy_hom_shoes02_shoes_n");
  NLMISC::strFindReplace(stdPath, "fyhof-gilet02-torse",
                         "fy_hof_gilet02_torse_n");

  NLMISC::strFindReplace(stdPath, "ge_hom_armor02_armpad",
                         "ge_hom_armor02_avbras");
  NLMISC::strFindReplace(stdPath, "ge_hom_armor02_bottes",
                         "ge_hom_armor02_pied");
  NLMISC::strFindReplace(stdPath, "ge_hom_armor02_cuisse-arr",
                         "ge_hom_armor02_cuisse_arr");
  NLMISC::strFindReplace(stdPath, "ge_hom_armor02_cuisse-avt",
                         "ge_hom_armor02_cuisse_avt");
  NLMISC::strFindReplace(stdPath, "ge_hom_armor02_hand-down",
                         "ge_hom_armor02_hand_down");
  NLMISC::strFindReplace(stdPath, "ge_hom_armor02_hand-up",
                         "ge_hom_armor02_hand_up");
  NLMISC::strFindReplace(stdPath, "ge_hom_armor02_torse",
                         "ge_hom_armor02_torso");
  ...
  NLMISC::strFindReplace(stdPath, "\\ge_mission_stele_kami0.",
                         "\\ge_mission_stele_kami.");
  NLMISC::strFindReplace(stdPath, "\\ge_mission_reward_karavan_bigshield.",
                         "\\ge_mission_reward_karavan_bigshield_c1.");

  NLMISC::strFindReplace(stdPath, "\\tr_hom_underwear_cuisse_arr.",
                         "\\tr_hom_underwear_cuisse-arr.");
  NLMISC::strFindReplace(stdPath, "\\tr_hom_underwear_cuisse_avt.",
                         "\\tr_hom_underwear_cuisse-avt.");

  NLMISC::strFindReplace(stdPath, "interfaces_visage", "visage_interface");

  if (stdPath.find("\\trame.") != std::string::npos)
    stdPath = standardizePath(
        databaseDirectory + "/stuff/lod_actors/texture_lod/trame.png", false);
  if (stdPath.find("\\tr_hof_visage_c1.") != std::string::npos)
    stdPath = standardizePath(
        databaseDirectory +
            "/stuff/tryker/agents/_textures/actors/tr_hof_visage_c1.png",
        false);
  if (stdPath.find("\\tr_hof_visage_c2.") != std::string::npos)
    stdPath = standardizePath(
        databaseDirectory +
            "/stuff/tryker/agents/_textures/actors/tr_hof_visage_c2.png",
        false);
  if (stdPath.find("\\tr_hof_visage_c3.") != std::string::npos)
    stdPath = standardizePath(
        databaseDirectory +
            "/stuff/tryker/agents/_textures/actors/tr_hof_visage_c3.png",
        false);
  if (stdPath.find("\\ma_hof_cheveux_medium02.") != std::string::npos)
    stdPath = standardizePath(
        databaseDirectory +
            "/stuff/matis/agents/_textures/actors/ma_hof_cheveux_medium02.png",
        false);

  /*if (stdPath.size() > path.size())
  {
      nlwarning("Path size becomes too large: '%s' -> '%s'", path.c_str(),
  stdPath.c_str()); return path;
  }*/

  if (NLMISC::CFile::getFilename(stdPath) == stdPath) {
    breakable {
      if (fileNameCache.find(stdPath) == fileNameCache.end() ||
          KnownFileCache.find(stdPath) == KnownFileCache.end()) {
        if (stdPath[stdPath.size() - 3] == 't' &&
        ...
        // #nlwarning("File name not known: '%s' ('%s')", path.c_str(),
        // stdPath.c_str());
    ...
    if (stdPath.find(databaseDirectory) == std::string::npos) {
      if (stdPath[1] == ':' || (stdPath[0] == '\\' && stdPath[1] == '\\')) {
        if (KnownFileCache.find(NLMISC::CFile::getFilename(stdPath)) !=
            KnownFileCache.end())
        ...
        // #nlwarning("Path not in database: '%s' ('%s')", path.c_str(),
        // stdPath.c_str());
        MissingFiles.insert(path);
        return stdPath;
      } else {
    ...
    breakable {
      if (!NLMISC::CFile::fileExists(nativeDatabasePath(stdPath))) {
        ...
        {
          std::string stdPathVv2 =
              standardizePath(NLMISC::CFile::getPath(stdPath) + "/vv2/" +
          ...
          if (NLMISC::CFile::fileExists(nativeDatabasePath(stdPathVv2))) {
            ...
            if (stdPathVv2[stdPathVv2.size() - 3] == 'p' &&
                stdPathVv2[stdPathVv2.size() - 2] == 'n' &&
                stdPathVv2[stdPathVv2.size() - 1] == 'g') {
          ...
          if (vv2works) {
            ...
            {
                nlwarning("Path with vv2 size becomes too large: '%s' -> '%s'",
            path.c_str(), stdPathVv2.c_str()); return stdPath;
            }
            else
            {*/
            stdPath = stdPathVv2;
        ...
        // #nlwarning("Path file does not exist: '%s' ('%s')", path.c_str(),
        // stdPath.c_str());
        MissingFiles.insert(path);
        return stdPath;
      }
...
void doFileInitialize(const std::string &filePath) {
  ...
  KnownFileCache[NLMISC::CFile::getFilename(filePath)] =
      standardizePath(filePath, false);
}
...
void doDirectoryInitialize(const std::string &directoryPath) {
  ...
  NLMISC::CPath::getPathContent(nativeDatabasePath(dirPath), false, true, true,
                                dirContents);

  // nldebug("Native: '%s'", nativeDatabasePath(dirPath).c_str());
  // nldebug("Contents: %i", dirContents.size());

  for (std::vector<std::string>::iterator it = dirContents.begin(),
                                          end = dirContents.end();
       it != end; ++it) {
...
void doFileScanner(const std::string &filePath) {
  if (filePath[filePath.size() - 3] == 'm' &&
      filePath[filePath.size() - 2] == 'a' &&
      filePath[filePath.size() - 1] == 'x') {
    nldebug("File: '%s'", filePath.c_str());
    ...
    // find paths
    for (std::vector<char>::size_type i = 256; i < buffer.size();
         ++i) // skip the first 256 lol :)
    {
      if (((NLMISC::toLower(buffer[i - 1]) == 'x' &&
            NLMISC::toLower(buffer[i - 2]) == 'a' &&
            NLMISC::toLower(buffer[i - 3]) == 'm') ||
           (NLMISC::toLower(buffer[i - 1]) == 'a' &&
            NLMISC::toLower(buffer[i - 2]) == 'g' &&
            NLMISC::toLower(buffer[i - 3]) == 't') ||
           (NLMISC::toLower(buffer[i - 1]) == 'g' &&
            NLMISC::toLower(buffer[i - 2]) == 'n' &&
            NLMISC::toLower(buffer[i - 3]) == 'p')) &&
        ...
        for (std::vector<char>::size_type j = i - 4; j > 0; --j) {
          if (!isCharacter(buffer[j])) {
            ...
            // nlwarning("Invalid characters '%i' in path at %i, len %i!",
            // (uint32)buffer[j], (uint32)j, (uint32)(i - j)); beginPath = j +
            // 1; // test
            break;
          }
          if (buffer[j] == ':') {
        ...
        if (beginPath != 0) {
          ...
          std::string foundPath = std::string(
              &buffer[beginPath],
              sizePath); // std::string(buffer.at(beginPath), buffer.at(i));
          // nldebug("Found path: '%s' from %i to %i", foundPath.c_str(),
          // (uint32)beginPath, (uint32)i);
...
void runScanner() {
  ...
  for (std::set<std::string>::iterator it = MissingFiles.begin(),
                                       end = MissingFiles.end();
       it != end; ++it)
...
void serializeStorageContainer(
    PIPELINE::MAX::CStorageContainer *storageContainer, GsfInfile *infile,
...
void serializeStorageContainer(
    PIPELINE::MAX::CStorageContainer *storageContainer, GsfOutfile *outfile,
    const char *streamName) {
  // nldebug("write");
  GsfOutput *output =
      GSF_OUTPUT(gsf_outfile_new_child(outfile, streamName, false));
  if (!output) {
...
void serializeRaw(std::vector<uint8> &rawOutput, GsfInfile *infile,
                  const char *streamName) {
  GsfInput *input = gsf_infile_child_by_name(infile, streamName);
  if (!input) {
    nlerror("GSF Could not read stream %s", streamName);
...
void serializeRaw(std::vector<uint8> &rawOutput, GsfOutfile *outfile,
                  const char *streamName) {
  GsfOutput *output =
      GSF_OUTPUT(gsf_outfile_new_child(outfile, streamName, false));
  if (!output) {
...
std::string rewritePathFinal(const std::string &str) {
  ...
  if (NLMISC::CFile::getFilename(result) != result &&
      !NLMISC::CFile::fileExists(nativeDatabasePath(result)) &&
      ((result[result.size() - 3] == 't' && result[result.size() - 2] == 'g' &&
        result[result.size() - 1] == 'a') ||
       (result[result.size() - 3] == 'p' && result[result.size() - 2] == 'n' &&
        result[result.size() - 1] == 'g'))) {
    // nlwarning("Replacing missing '%s' with '%s'", result.c_str(),
    // FallbackTga);
    if (UseFallbackTga) {
      return FallbackTga;
    } else {
...
bool isImportantFilePath(const std::string &str) {
  ...
  if (strtrimmed.size() >= 4) {
    ...
    return (strlw[strlw.size() - 3] == 'm' && strlw[strlw.size() - 2] == 'a' &&
            strlw[strlw.size() - 1] == 'x') ||
           (strlw[strlw.size() - 3] == 't' && strlw[strlw.size() - 2] == 'g' &&
            strlw[strlw.size() - 1] == 'a') ||
           (strlw[strlw.size() - 3] == 'p' && strlw[strlw.size() - 2] == 'n' &&
            strlw[strlw.size() - 1] == 'g');
  }
  return false;
}
...
bool fixChunk(uint16 id, IStorageObject *chunk) {
  ...
  bool changed = false;
  CStorageValue<std::string> *asString =
      dynamic_cast<CStorageValue<std::string> *>(chunk);
  if (asString) {
  ...
  CStorageValue<ucstring> *asUCString =
      dynamic_cast<CStorageValue<ucstring> *>(chunk);
  if (asUCString) {
  ...
  if (asRaw) {
    ...
    case 10:
      if (hasImportantFilePath(asRaw)) {
        ...
        if (overrideFF && asRaw->Value.size() > 4 &&
            asRaw->Value[asRaw->Value.size() - 4] == 0xFF) {
        ...
        if (!(asRaw->Value.size() == size + 4 + 11)) {
          ...
          asRaw->toString(std::cout);
          nldebug("x");
          nlwarning("size '%i' does not match '%i', use different algo :)",
                    size, asRaw->Value.size() - 4 - 11);
          uint8 nonsense[11];
          uint32 counter;
          std::vector<std::string> strings;
          {
            ...
            while ((sint)mem.getPos() != (sint)mem.size()) {
              ...
              if (!(v[v.size() - 1] == 0)) {
                ...
                asRaw->toString(std::cout);
                nldebug("x");
                nlwarning("not null term inside array stuff %i '%s'", i,
                          v.c_str());
                if (HaltOnIssue) {
                  std::string x;
                  std::cin >> x;
...
bool fixChunks(CStorageContainer *container) {
  bool changed = false;
  for (CStorageContainer::TStorageObjectConstIt
           it = container->chunks().begin(),
           end = container->chunks().end();
       it != end; ++it) {
    if (it->second->isContainer()) {
      changed =
          (changed || fixChunks(static_cast<CStorageContainer *>(it->second)));
    } else {
...
void handleFile(const std::string &path) {
  ...
  serializeRaw(documentSummaryInformation, infile,
  ...
  PIPELINE::MAX::CScene scene(&SceneClassRegistry, &dllDirectory,
                              &classDirectory3);
  ...
  */
  ...
  if (ReplaceMapExt) {
    ...
    NLMISC::CClassId editableMeshClassId =
    ...
    for (CStorageContainer::TStorageObjectConstIt
             it = scene.container()->chunks().begin(),
             end = scene.container()->chunks().end();
         it != end; ++it) {
      if (it->first == 0x2032) // Derived Object
      {
        // nldebug("Found derived object");
        CReferenceMaker *derivedObject =
            dynamic_cast<CReferenceMaker *>(it->second);
        ...
        for (uint i = 0; i < derivedObject->nbReferences(); ++i) {
          if (derivedObject->getReference(i) &&
              derivedObject->getReference(i)->classDesc()->classId() ==
                  fromClassId) {
            nldebug("Found map extender at '%i' / '%i'!", i,
                    derivedObject->nbReferences());
            mapExtenderIndex = i;
            mapExtender = derivedObject->getReference(i);

            bool deleteDerivedGeom = false;
            CStorageContainer *derivedData = dynamic_cast<CStorageContainer *>(
                derivedObject->findStorageObject(0x2500, mapExtenderIndex));
            nlassert(derivedData);
            CStorageContainer *derivedGeom = dynamic_cast<CStorageContainer *>(
                derivedData->findStorageObject(0x2512));
            if (!derivedGeom) {
              CStorageRaw *derivedGeomRaw = dynamic_cast<CStorageRaw *>(
                  derivedData->findStorageObject(0x2512));
              if (derivedGeomRaw) {
            ...
            CStorageRaw *derivedVertices = dynamic_cast<CStorageRaw *>(
                derivedGeom->findStorageObject(0x03e9));
            if (!derivedVertices) {
            ...
            CStorageRaw *derivedIndices = dynamic_cast<CStorageRaw *>(
                derivedGeom->findStorageObject(0x03eb));
            if (!derivedIndices) {
              derivedGeom->toString(std::cout);
            ...
            CStorageContainer::TStorageObjectContainer &mapChunks =
            ...
            mapChunks.push_back(CStorageContainer::TStorageObjectWithId(
                0x0100, chunkVertCount));
            ...
            mapChunks.push_back(
                CStorageContainer::TStorageObjectWithId(0x0240, chunkFaces));

            // Write geom points
            CStorageValue<uint32> *chunkGeomPointCount =
                new CStorageValue<uint32>();
            chunkGeomPointCount->Value = nbVertices; // derived vertices?
            mapChunks.push_back(CStorageContainer::TStorageObjectWithId(
                0x0320, chunkGeomPointCount));
        ...
        if (mapExtender) {
          ...
          for (uint i = 0; i < derivedObject->nbReferences(); ++i) {
            if (derivedObject->getReference(i) &&
                derivedObject->getReference(i)->classDesc()->classId() ==
                    editMeshClassId) {
              nldebug("Found edit mesh at '%i' / '%i'!", i,
                      derivedObject->nbReferences());
              editMeshIndex = i;
              ...
              CStorageContainer::TStorageObjectContainer &meshChunks =
                  const_cast<CStorageContainer::TStorageObjectContainer &>(
                      editMesh->chunks());

              // Ensure no selection
              for (CStorageContainer::TStorageObjectIterator
                       it = meshChunks.begin(),
                       end = meshChunks.end();
                   it != end;) {
          ...
          for (uint i = 0; i < derivedObject->nbReferences(); ++i) {
            if (derivedObject->getReference(i) &&
                derivedObject->getReference(i)->classDesc()->classId() ==
                    editableMeshClassId) {
              nldebug("Found editable mesh at '%i' / '%i'!", i,
                      derivedObject->nbReferences());
              editableMeshIndex = i;
          ...
          if (editableMesh &&
              editableMeshIndex + 1 != derivedObject->nbReferences()) {
            nlwarning("Editable mesh not at bottom of the stack, this is "
                      "unpossible!");
            std::string x;
            std::cin >> x;
            continue;
          ...
          /*
                              if (editableMesh == NULL || editMesh == NULL)
                              {
                                  ...
                                  nlwarning("editable mesh or edit mesh not
             found"); std::string x; std::cin >> x; continue;
                              }
                              ...
                              // derivedObject -> 0x2500 -> 0x2512 -> 0x03e9 /
             0x03eb
                              // editableMesh -> 0x08fe (geom) -> 0x0916 /
             0x0918

                              CStorageContainer *editableMeshGeometry =
             dynamic_cast<CStorageContainer
             *>(editableMesh->findStorageObject(0x08fe));
                              ...
                              CStorageRaw *editableVertices =
             dynamic_cast<CStorageRaw
             *>(editableMeshGeometry->findStorageObject(0x0916));
                              nlassert(editableVertices);
                              CStorageRaw *editableIndices =
             dynamic_cast<CStorageRaw
             *>(editableMeshGeometry->findStorageObject(0x0918));
                              nlassert(editableIndices);

              //return new CStorageArraySizePre<NLMISC::CVector>();
                              if (derivedIndices->Value.size() !=
             editableIndices->Value.size())
                              {
                                  editableMesh->toString(std::cout);
                                  derivedObject->toString(std::cout);
                              ...
                              nlassert(derivedVertices->Value.size() % 12 == 0);
                              uint32 nbVertices = derivedVertices->Value.size()
             / 12; NLMISC::CMemStream memVertices;
                              memVertices.serial(nbVertices);
                              derivedVertices->serial(memVertices);
                              memVertices.invert();
                              editableVertices->setSize(derivedVertices->Value.size()
             + 4); editableVertices->serial(memVertices);
    ...
    NLMISC::CClassId toClassId =
        NLMISC::CClassId(0x02df2e3a, 0x72ba4e1f); // uvw unwrap
    // NLMISC::CClassId toClassId = NLMISC::CClassId(0x5c5b50f7,0x60397ca1); //
    // converttomesh :| NLMISC::CClassId toClassId =
    // NLMISC::CClassId(0x31f9c666, 0x03b4a577); // uvw mapping add dllname to:
    // uvwunwrap.dlm
    for (CStorageContainer::TStorageObjectConstIt
             it = classDirectory3.chunks().begin(),
             end = classDirectory3.chunks().end();
         it != end; ++it) {
      ...
      if (classEntry) {
        ...
        if (classEntry->classId() == fromClassId) {
          ...
          CDllEntry *dllEntry =
              const_cast<CDllEntry *>(dllDirectory.get(classEntry->dllIndex()));
  ...
  if (WriteModified && (ReplaceMapExt || pathsChanged)) {
    ...
    serializeRaw(documentSummaryInformation, outfile,
...
int main(int argc, char **argv) {
  ...
  runInitialize();
  runHandler();
  // handleFile(nativeDatabasePath("w:\\database\\landscape\\ligo\\desert\\max\\zonematerial-converted-brandon.max"));
  // // overrideFF
  // handleFile(nativeDatabasePath("w:\\database\\landscape\\ligo\\desert\\max\\zonematerial-converted-154_dz.max"));
  // // overrideFF
