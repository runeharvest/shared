...
CNodeMeta::CNodeMeta()
    : AddToIG(true), ExportMesh(TMeshShape), ExportBone(TBoneAuto),
      AutoAnim(false) {}
...
CSceneMeta::CSceneMeta()
    : ImportShape(true), ImportSkel(true), ImportAnim(true), ImportCmb(true),
      ImportIG(true), ExportDefaultIG(false), SkeletonMode(TSkelRoot) {}
