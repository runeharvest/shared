...
#if !defined(                                                                  \
    AFX_LOG_ANALYSERDLG_H__667551B0_360A_43CD_846F_7D02803A822A__INCLUDED_)
...
public:
  ...
  ///
  void getLogSeries(const CString &filenameStr,
                    std::vector<CString> &filenameList);

  ///
  bool isLogSeriesEnabled() const {
    return ((CButton *)GetDlgItem(IDC_CheckAllFileSeries))->GetCheck() == 1;
  }
