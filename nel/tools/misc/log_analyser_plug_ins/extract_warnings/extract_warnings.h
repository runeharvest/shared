...
// CONNECTION_STATS_EXPORTS symbol defined on the command line. this symbol
// should not be defined on any project that uses this DLL. This way any other
// project whose source files include this file see CONNECTION_STATS_API
// functions as being imported from a DLL, wheras this DLL sees symbols defined
...
LOG_ANALYSER_PLUGIN_API bool doAnalyse(const std::vector<const char *> &vec,
