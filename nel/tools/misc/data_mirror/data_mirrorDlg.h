...
#if !defined(                                                                  \
    AFX_DATA_MIRRORDLG_H__D812F8AA_58F2_4ED2_B0F3_0CAB1B0DCB77__INCLUDED_)
...
public:
  ...
  void updateList();
  void updateSort();
  void addEntry(uint where, const char *file, FILETIME &newDate,
                FILETIME &oldDate);

  enum { Modified = 0, Added, Removed, FileTypes };
