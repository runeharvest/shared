...
struct CUTMiscCommon : public Test::Suite {
  ...
  void decodeURIComponent() {
    TEST_ASSERT(std::string("\x00", 1) ==
                NLMISC::decodeURIComponent(std::string("\x00", 1)));
    TEST_ASSERT(std::string("\x0A", 1) ==
                NLMISC::decodeURIComponent(std::string("\x0A", 1)));
    TEST_ASSERT(std::string("\xA0", 1) ==
                NLMISC::decodeURIComponent(std::string("\xA0", 1)));
