...
public:
  ...
  void tear_down() { NLMISC::CPath::setCurrentPath(_OldPath.c_str()); }

  void addBnp() {
    // add bnp file in the path and access to file inside
    NLMISC::CPath::addSearchBigFile(NEL_UNIT_BASE "ut_misc_files/files.bnp",
                                    false, false);
  }
  ...
  void loadFromBnp() {
    // lookup for the file
    string filename =
        NLMISC::CPath::lookup("file1_in_bnp.txt", true, true, false);
  ...
  void addXmlpack() {
    ...
    NLMISC::CPath::addSearchXmlpackFile(
        NEL_UNIT_BASE "ut_misc_files/xml_files/xml_files.xml_pack", false,
        false);
  }
  ...
  void loadFromXmlpack() {
    // lookup for the file
    string filename =
        NLMISC::CPath::lookup("file1_in_xml_pack.xml", true, true, false);
    TEST_ASSERT(
        filename == NEL_UNIT_BASE
        "ut_misc_files/xml_files/xml_files.xml_pack@@file1_in_xml_pack.xml");
    ...
    // lookup for the 2nd file
    filename =
        NLMISC::CPath::lookup("file2_in_xml_pack.xml", true, true, false);
    TEST_ASSERT(
        filename == NEL_UNIT_BASE
        "ut_misc_files/xml_files/xml_files.xml_pack@@file2_in_xml_pack.xml");

    {
      ...
      // check the file content
      string refText =
          "<anotherxml><withSomethink name=\"bar\"/></anotherxml>" + NewLine;
  ...
  void decompressMemory() { NLMISC::CPath::memoryUncompress(); }
  ...
  void loadXmlpackWithSameName() {
    ...
    //		NLMISC::CPath::addSearchXmlpackFile(NEL_UNIT_BASE
    //"ut_misc_files/xml_files/same_subfolder_1/samename/samename.xml_pack",
    //true, false, NULL); 		NLMISC::CPath::addSearchXmlpackFile(NEL_UNIT_BASE
    //"ut_misc_files/xml_files/same_subfolder_2/samename/samename.xml_pack",
    //true, false, NULL);
    NLMISC::CPath::addSearchPath(NEL_UNIT_BASE "ut_misc_files/xml_files", true,
                                 false);

    // lookup for the files in first subdirectory
    string filename =
        NLMISC::CPath::lookup("file1_in_sub_1.xml", true, true, false);
    TEST_ASSERT(filename == NEL_UNIT_BASE
                "ut_misc_files/xml_files/same_subfolder_1/samename/"
                "samename.xml_pack@@file1_in_sub_1.xml");
    filename = NLMISC::CPath::lookup("file2_in_sub_1.xml", true, true, false);
    TEST_ASSERT(filename == NEL_UNIT_BASE
                "ut_misc_files/xml_files/same_subfolder_1/samename/"
                "samename.xml_pack@@file2_in_sub_1.xml");

    // lookup for the files in the second subdirectory
    filename = NLMISC::CPath::lookup("file1_in_sub_2.xml", true, true, false);
    TEST_ASSERT(filename == NEL_UNIT_BASE
                "ut_misc_files/xml_files/same_subfolder_2/samename/"
                "samename.xml_pack@@file1_in_sub_2.xml");
    filename = NLMISC::CPath::lookup("file2_in_sub_2.xml", true, true, false);
    TEST_ASSERT(filename == NEL_UNIT_BASE
                "ut_misc_files/xml_files/same_subfolder_2/samename/"
                "samename.xml_pack@@file2_in_sub_2.xml");
