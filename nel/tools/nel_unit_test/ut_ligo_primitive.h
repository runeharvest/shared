...
public:
  CUTLigoPrimitive() { TEST_ADD(CUTLigoPrimitive::testAliasGenerator) }
...
private:
  ...
  void setup() {
    ...
    classfile =
        ...
        "	<PRIMITIVE CLASS_NAME=\"root\" TYPE=\"node\" "
        "AUTO_INIT=\"true\" DELETABLE=\"true\">\n" +
        ...
        "	</PRIMITIVE>\n" + "\n" +
        "	<!-- the alias class, used by all other class that need "
        "persistent aliases-->\n" +
        "	<PRIMITIVE CLASS_NAME=\"alias\" TYPE=\"alias\" "
        "AUTO_INIT=\"true\" DELETABLE=\"false\">\n" +
        "	</PRIMITIVE>\n" + "\n" +
        "	<PRIMITIVE CLASS_NAME=\"test\" TYPE=\"node\" "
        "AUTO_INIT=\"false\" DELETABLE=\"true\" NUMBERIZE=\"false\">\n" +
        "		<PARAMETER NAME=\"name\" TYPE=\"string\" "
        "VISIBLE=\"true\"/>\n" +
    ...
    NLLIGO::IPrimitive *p = dynamic_cast<NLLIGO::IPrimitive *>(
    ...
    NLLIGO::CPrimAlias *pa = dynamic_cast<NLLIGO::CPrimAlias *>(
  ...
  void testAliasGenerator() {
    // Known bug : is we load/save a primitive and replacing a primitive node
    // with itself (conserving the alias), the
