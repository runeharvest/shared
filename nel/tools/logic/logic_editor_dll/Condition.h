...
public:
  ...
  /// copy constructor, also copy all sub nodes (and allocate new nodes for
  /// them)
  ...
  /// change all the occurences of the 'old' condition into 'newName'
  /// (recursive)
...
public:
  ...
  /// change all the occurences of the 'old' condition into 'newName' (for the
  /// nodes)
...
void cConditionToCLogicCondition(CCondition &condition,
                                 NLLOGIC::CLogicCondition &logicCondition);

/**
 *	cLogicConditionToCCondition
 */
void cLogicConditionToCCondition(const NLLOGIC::CLogicCondition &logicCondition,
