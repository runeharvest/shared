...
//
//-----------------------------------------------------
void cLogicCounterToCCounter(const CLogicCounter &logicCounter,
                             CCounter &counter) {
  // counter name
  ...
  case CLogicCounter::SHUTTLE:
    counter.m_sMode = "Shuttle";
    break;
  case CLogicCounter::LOOP:
    counter.m_sMode = "Loop";
    break;
  case CLogicCounter::STOP_AT_LIMIT:
    counter.m_sMode = "Stop on arrival";
    break;
  }
