...
#ifdef _DEBUG
void CLogic_editorView::AssertValid() const { CView::AssertValid(); }

void CLogic_editorView::Dump(CDumpContext &dc) const { CView::Dump(dc); }

CLogic_editorDoc *
CLogic_editorView::GetDocument() // non-debug version is inline
{
