...
CEditorFormView::CEditorFormView() : CFormView(CEditorFormView::IDD) {
...
#ifdef _DEBUG
void CEditorFormView::AssertValid() const { CFormView::AssertValid(); }

void CEditorFormView::Dump(CDumpContext &dc) const { CFormView::Dump(dc); }
#endif //_DEBUG
...
void CEditorFormView::OnInitialUpdate() {
  ...
  // modify the style to ensure proper redrawing of controls during window
  // resizing or views update
