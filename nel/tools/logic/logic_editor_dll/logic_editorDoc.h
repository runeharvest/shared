...
#if !defined(                                                                  \
    AFX_LOGIC_EDITORDOC_H__7E37E572_7B2F_4A62_BDC2_F1F4751381AD__INCLUDED_)
...
public:
   ...
   * \param CString old the old name of the var (not a reference because we may
   * delete the string when deleting the variable !!) \param CString &newName
   * the new name of the var \return BOOL TRUE if the change has been made,
