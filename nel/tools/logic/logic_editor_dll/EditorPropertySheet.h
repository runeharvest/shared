#if !defined(                                                                  \
    AFX_EDITORPROPERTYSHEET_H__8A0DFA3B_C96E_4D64_A63F_2EAC39871677__INCLUDED_)
...
class CEditorPropertySheet : public CPropertySheet {
  ...
  // Construction
public:
  CEditorPropertySheet(UINT nIDCaption, CWnd *pParentWnd = NULL,
                       UINT iSelectPage = 0);
  CEditorPropertySheet(LPCTSTR pszCaption, CWnd *pParentWnd = NULL,
                       UINT iSelectPage = 0);
