...
// an external program
void mainCallback() { nlinfo("The file was modified by external program!"); }
...
int main(int /* argc */, char ** /* argv */) {
  ...
  // CConfigFile checks if the config file has been modified by an external
  // program. in this case, the configfile automatically reloads and reparses
  // the file. you can connect a callback function that will be called in this
  // case if you want, for example, reset variables
  ...
  // exception will be called, you can catch them individually or all together
  ...
  nlinfo("Try to modify the var12 in the configfile or any other "
