...
struct CSharedClass : public CTransportClass {
  ...
  CSharedClass() : i1(10), i2(10), i3(10), f1(10), str("str10") {
    vi1.push_back(111);
    vi1.push_back(222);
    vi1.push_back(255);
  }
...
/*
 * Declare a service with the class IService, the names "GDS" (short) and
 * "gd_service" (long). The port is automatically allocated (0) and the main
