...
struct TSessionPartStatus {
  ...
  static const NLMISC::CStringConversion<TValues> &getConversionTable() {
    NL_BEGIN_STRING_CONVERSION_TABLE(TValues) NL_STRING_CONVERSION_TABLE_ENTRY(
        sps_play_subscribed) NL_STRING_CONVERSION_TABLE_ENTRY(sps_play_invited)
  ...
  static NLMISC::CStringConversion<TValues>
      conversionTable(TValues_nl_string_conversion_table,
...
public:
TSessionPartStatus() : _Value(invalid_val) {}
TSessionPartStatus(TValues value) : _Value(value) {}

TSessionPartStatus(const std::string &str) {
  _Value = getConversionTable().fromString(str);
}

void serial(NLMISC::IStream &s) { s.serialEnum(_Value); }
...
TValues getValue() const { return _Value; }
...
public:
TSessionType() : _Value(invalid_val) {}
TSessionType(TValues value) : _Value(value) {}
...
public:
TSessionOrientation() : _Value(invalid_val) {}
TSessionOrientation(TValues value) : _Value(value) {}
...
public:
TSessionState() : _Value(invalid_val) {}
TSessionState(TValues value) : _Value(value) {}
...
public:
TAnimMode() : _Value(invalid_val) {}
TAnimMode(TValues value) : _Value(value) {}
...
bool operator==(const TAnimMode &other) const { return _Value == other._Value; }
...
public:
TAccessType() : _Value(invalid_val) {}
TAccessType(TValues value) : _Value(value) {}
...
bool operator<(const TAccessType &other) const { return _Value < other._Value; }
...
public:
TRuleType() : _Value(invalid_val) {}
TRuleType(TValues value) : _Value(value) {}
...
bool operator==(const TRuleType &other) const { return _Value == other._Value; }
...
public:
TLevelFilterEnum() : _Value(empty_val) {}
TLevelFilterEnum(TValues value) : _Value(value) {}
...
typedef NLMISC::CEnumBitset<
    TLevelFilterEnum, uint32, TLevelFilterEnum::max_val, ',',
    NLMISC::TContainedEnum<TLevelFilterEnum, uint32>, TLevelFilterEnum::TValues>
    TLevelFilter;
...
public:
TEstimatedDuration() : _Value(invalid_val) {}
TEstimatedDuration(TValues value) : _Value(value) {}
...
public:
TRaceFilterEnum() : _Value(empty_val) {}
TRaceFilterEnum(TValues value) : _Value(value) {}
...
typedef NLMISC::CEnumBitset<
    TRaceFilterEnum, uint32, TRaceFilterEnum::max_val, ',',
    NLMISC::TContainedEnum<TRaceFilterEnum, uint32>, TRaceFilterEnum::TValues>
    TRaceFilter;
...
public:
TReligionFilterEnum() : _Value(empty_val) {}
TReligionFilterEnum(TValues value) : _Value(value) {}
...
typedef NLMISC::CEnumBitset<TReligionFilterEnum, uint32,
                            TReligionFilterEnum::max_val, ',',
                            NLMISC::TContainedEnum<TReligionFilterEnum, uint32>,
                            TReligionFilterEnum::TValues>
    TReligionFilter;
...
public:
TGuildFilter() : _Value(invalid_val) {}
TGuildFilter(TValues value) : _Value(value) {}
...
struct TShardFilterEnum {
  ...
  static const NLMISC::CStringConversion<TValues> &getConversionTable() {
    NL_BEGIN_STRING_CONVERSION_TABLE(TValues) NL_STRING_CONVERSION_TABLE_ENTRY(
        sf_shard00) NL_STRING_CONVERSION_TABLE_ENTRY(sf_shard01)
        NL_STRING_CONVERSION_TABLE_ENTRY(sf_shard02) NL_STRING_CONVERSION_TABLE_ENTRY(
            sf_shard03) NL_STRING_CONVERSION_TABLE_ENTRY(sf_shard04)
            NL_STRING_CONVERSION_TABLE_ENTRY(sf_shard05) NL_STRING_CONVERSION_TABLE_ENTRY(
                sf_shard06) NL_STRING_CONVERSION_TABLE_ENTRY(sf_shard07)
                NL_STRING_CONVERSION_TABLE_ENTRY(sf_shard08) NL_STRING_CONVERSION_TABLE_ENTRY(
                    sf_shard09) NL_STRING_CONVERSION_TABLE_ENTRY(sf_shard10)
                    NL_STRING_CONVERSION_TABLE_ENTRY(sf_shard11) NL_STRING_CONVERSION_TABLE_ENTRY(
                        sf_shard12) NL_STRING_CONVERSION_TABLE_ENTRY(sf_shard13)
                        NL_STRING_CONVERSION_TABLE_ENTRY(sf_shard14) NL_STRING_CONVERSION_TABLE_ENTRY(
                            sf_shard15) NL_STRING_CONVERSION_TABLE_ENTRY(sf_shard16)
                            NL_STRING_CONVERSION_TABLE_ENTRY(sf_shard17) NL_STRING_CONVERSION_TABLE_ENTRY(
                                sf_shard18) NL_STRING_CONVERSION_TABLE_ENTRY(sf_shard19)
                                NL_STRING_CONVERSION_TABLE_ENTRY(
                                    sf_shard20) NL_STRING_CONVERSION_TABLE_ENTRY(sf_shard21)
                                    NL_STRING_CONVERSION_TABLE_ENTRY(
                                        sf_shard22) NL_STRING_CONVERSION_TABLE_ENTRY(sf_shard23)
                                        NL_STRING_CONVERSION_TABLE_ENTRY(
                                            sf_shard24)
                                            NL_STRING_CONVERSION_TABLE_ENTRY(
                                                sf_shard25)
...
public:
TShardFilterEnum() : _Value(empty_val) {}
TShardFilterEnum(TValues value) : _Value(value) {}
...
typedef NLMISC::CEnumBitset<
    TShardFilterEnum, uint32, TShardFilterEnum::max_val, ',',
    NLMISC::TContainedEnum<TShardFilterEnum, uint32>, TShardFilterEnum::TValues>
    TShardFilter;
...
public:
  ...
  void setSessionId(TSessionId value) { _SessionId = value; }
  // The type of the session
  TSessionType getSessionType() const { return _SessionType; }

  void setSessionType(TSessionType value) { _SessionType = value; }
  // Instance ID that host this session
  uint32 getInstanceId() const { return _InstanceId; }

  void setInstanceId(uint32 value) { _InstanceId = value; }
  // Number of characters currently playing in the session (player and pioneer)
  uint32 getNbPlayingChars() const { return _NbPlayingChars; }

  void setNbPlayingChars(uint32 value) { _NbPlayingChars = value; }
...
public:
TSessionEvent() : _Value(invalid_val) {}
TSessionEvent(TValues value) : _Value(value) {}
...
private:
  typedef void (CRingSessionManagerSkel::*TMessageHandler)(
  ...
  void registerDSS_skel(NLNET::IModuleProxy *sender,
                        const NLNET::CMessage &__message);

  void sessionCreated_skel(NLNET::IModuleProxy *sender,
                           const NLNET::CMessage &__message);

  void reportSessionEvent_skel(NLNET::IModuleProxy *sender,
                               const NLNET::CMessage &__message);

  void scenarioStarted_skel(NLNET::IModuleProxy *sender,
                            const NLNET::CMessage &__message);

  void reportCharacterKicked_skel(NLNET::IModuleProxy *sender,
                                  const NLNET::CMessage &__message);

  void scenarioEnded_skel(NLNET::IModuleProxy *sender,
                          const NLNET::CMessage &__message);
...
public:
  ...
  virtual void
  registerDSS(NLNET::IModuleProxy *sender, uint32 shardId,
              const std::vector<TRunningSessionInfo> &runningSessions) = 0;
  // The session server report a session creation.
  virtual void
  sessionCreated(NLNET::IModuleProxy *sender,
                 const RSMGR::TRunningSessionInfo &sessionInfo) = 0;
  // The session report an event.
  // charId is used only when the event is about a character.
  virtual void reportSessionEvent(NLNET::IModuleProxy *sender,
                                  RSMGR::TSessionEvent event,
                                  TSessionId sessionId, uint32 charId) = 0;
  ...
  virtual void
  scenarioStarted(NLNET::IModuleProxy *sender, TSessionId sessionId,
                  const R2::TRunningScenarioInfo &scenarioInfo) = 0;
  // The session report that a DM has kicked a character from a session.
  virtual void reportCharacterKicked(NLNET::IModuleProxy *sender,
                                     TSessionId sessionId, uint32 charId) = 0;
  ...
  virtual void scenarioEnded(NLNET::IModuleProxy *sender, TSessionId sessionId,
                             ...
                             uint32 rrpScored, uint32 scenarioPointScored,
                             uint32 timeTaken,
                             const std::vector<uint32> &participants) = 0;
};
...
public:
  ...
  // A edition or animation server module register in the session manager
  // It send the list of session hosted in the server
  void registerDSS(NLNET::IModule *sender, uint32 shardId,
                   const std::vector<TRunningSessionInfo> &runningSessions);
  // The session server report a session creation.
  void sessionCreated(NLNET::IModule *sender,
                      const RSMGR::TRunningSessionInfo &sessionInfo);
  // The session report an event.
  // charId is used only when the event is about a character.
  void reportSessionEvent(NLNET::IModule *sender, RSMGR::TSessionEvent event,
                          TSessionId sessionId, uint32 charId);
  // The DSS report that an animation scenario has just started
  // this allow SU to create the session log and scenario info record if needed.
  void scenarioStarted(NLNET::IModule *sender, TSessionId sessionId,
                       const R2::TRunningScenarioInfo &scenarioInfo);
  // The session report that a DM has kicked a character from a session.
  void reportCharacterKicked(NLNET::IModule *sender, TSessionId sessionId,
                             uint32 charId);
  // The DSS report the end of an animation session and
  // provides a bunch of data about the session life.
  void scenarioEnded(NLNET::IModule *sender, TSessionId sessionId,
                     const R2::TRunningScenarioInfo &scenarioInfo,
                     uint32 rrpScored, uint32 scenarioPointScored,
                     uint32 timeTaken, const std::vector<uint32> &participants);

  // Message serializer. Return the message received in reference for easier
  // integration
  static const NLNET::CMessage &buildMessageFor_registerDSS(
      NLNET::CMessage &__message, uint32 shardId,
      const std::vector<TRunningSessionInfo> &runningSessions);

  // Message serializer. Return the message received in reference for easier
  // integration
  static const NLNET::CMessage &
  buildMessageFor_sessionCreated(NLNET::CMessage &__message,
                                 const RSMGR::TRunningSessionInfo &sessionInfo);

  // Message serializer. Return the message received in reference for easier
  // integration
  static const NLNET::CMessage &
  buildMessageFor_reportSessionEvent(NLNET::CMessage &__message,
                                     RSMGR::TSessionEvent event,
                                     TSessionId sessionId, uint32 charId);
  ...
  // integration
  static const NLNET::CMessage &
  buildMessageFor_scenarioStarted(NLNET::CMessage &__message,
  ...
  // integration
  static const NLNET::CMessage &
  buildMessageFor_reportCharacterKicked(NLNET::CMessage &__message,
                                        TSessionId sessionId, uint32 charId);

  // Message serializer. Return the message received in reference for easier
  // integration
  static const NLNET::CMessage &buildMessageFor_scenarioEnded(
      NLNET::CMessage &__message, TSessionId sessionId,
      const R2::TRunningScenarioInfo &scenarioInfo, uint32 rrpScored,
      uint32 scenarioPointScored, uint32 timeTaken,
...
public:
  /// the interceptor type
  typedef NLNET::CInterceptorForwarder<CRingSessionManagerClientSkel>
      TInterceptor;
...
private:
  typedef void (CRingSessionManagerClientSkel::*TMessageHandler)(
      NLNET::IModuleProxy *sender, const NLNET::CMessage &message);
  typedef std::map<std::string, TMessageHandler> TMessageHandlerMap;

  const TMessageHandlerMap &getMessageHandlers() const;

  void createSession_skel(NLNET::IModuleProxy *sender,
                          const NLNET::CMessage &__message);

  void addCharacterInSession_skel(NLNET::IModuleProxy *sender,
                                  const NLNET::CMessage &__message);

  void closeSession_skel(NLNET::IModuleProxy *sender,
                         const NLNET::CMessage &__message);

  void stopHibernation_skel(NLNET::IModuleProxy *sender,
                            const NLNET::CMessage &__message);

  void characterKicked_skel(NLNET::IModuleProxy *sender,
                            const NLNET::CMessage &__message);

  void characterUnkicked_skel(NLNET::IModuleProxy *sender,
                              const NLNET::CMessage &__message);

  void teleportOneCharacterToAnother_skel(NLNET::IModuleProxy *sender,
                                          const NLNET::CMessage &__message);

  void hibernateSession_skel(NLNET::IModuleProxy *sender,
                             const NLNET::CMessage &__message);

  void setSessionStartParams_skel(NLNET::IModuleProxy *sender,
                                  const NLNET::CMessage &__message);
...
public:
  ...
  virtual void createSession(NLNET::IModuleProxy *sender, uint32 ownerCharId,
                             TSessionId sessionId,
                             const RSMGR::TSessionType &type) = 0;
  // Ask the client to allow a character in the session
  virtual void addCharacterInSession(NLNET::IModuleProxy *sender,
                                     TSessionId sessionId, uint32 charId,
                                     const WS::TUserRole &enterAs,
                                     const std::string &ringAccess,
                                     bool newcomer) = 0;
  // Ask the client to close a running session
  virtual void closeSession(NLNET::IModuleProxy *sender,
  ...
  virtual void stopHibernation(NLNET::IModuleProxy *sender,
                               TSessionId sessionId, uint32 ownerId) = 0;
  // Session mananger report that a character has been kicked by the web
  virtual void characterKicked(NLNET::IModuleProxy *sender,
                               TSessionId sessionId, uint32 charId) = 0;
  // Session mananger report that a character has been unkicked by the web
  virtual void characterUnkicked(NLNET::IModuleProxy *sender,
                                 TSessionId sessionId, uint32 charId) = 0;
  // Ask to teleport on character to another (the 2 characters must be in the
  // same season) The character must arrived in the season
  virtual void teleportOneCharacterToAnother(NLNET::IModuleProxy *sender,
                                             TSessionId sessionId,
                                             uint32 sourceCharId,
                                             uint32 destCharId) = 0;
  // Ask to hibernate a session
  virtual void hibernateSession(NLNET::IModuleProxy *sender,
                                TSessionId sessionId) = 0;
  // Set the start position of a session (eg while your are uploading an
  // animation session)
  virtual void
  setSessionStartParams(NLNET::IModuleProxy *sender, uint32 charId,
                        TSessionId sessionId,
                        const std::string &initialIslandLocation,
                        const std::string &initialEntryPointLocation,
                        const std::string &initialSeason) = 0;
};
...
public:
  ...
  // Ask the client to create a new session modules
  void createSession(NLNET::IModule *sender, uint32 ownerCharId,
                     TSessionId sessionId, const RSMGR::TSessionType &type);
  // Ask the client to allow a character in the session
  void addCharacterInSession(NLNET::IModule *sender, TSessionId sessionId,
                             uint32 charId, const WS::TUserRole &enterAs,
                             const std::string &ringAccess, bool newcomer);
  // Ask the client to close a running session
  void closeSession(NLNET::IModule *sender, TSessionId sessionId);
  // Ask the client stop hibernation for the
  // specified session. This mean to remove any
  // hibernated scenario file from the backup.
  void stopHibernation(NLNET::IModule *sender, TSessionId sessionId,
                       uint32 ownerId);
  // Session mananger report that a character has been kicked by the web
  void characterKicked(NLNET::IModule *sender, TSessionId sessionId,
                       uint32 charId);
  // Session mananger report that a character has been unkicked by the web
  void characterUnkicked(NLNET::IModule *sender, TSessionId sessionId,
                         uint32 charId);
  // Ask to teleport on character to another (the 2 characters must be in the
  // same season) The character must arrived in the season
  void teleportOneCharacterToAnother(NLNET::IModule *sender,
                                     TSessionId sessionId, uint32 sourceCharId,
                                     uint32 destCharId);
  // Ask to hibernate a session
  void hibernateSession(NLNET::IModule *sender, TSessionId sessionId);
  // Set the start position of a session (eg while your are uploading an
  // animation session)
  void setSessionStartParams(NLNET::IModule *sender, uint32 charId,
                             TSessionId sessionId,
                             const std::string &initialIslandLocation,
                             const std::string &initialEntryPointLocation,
                             const std::string &initialSeason);

  // Message serializer. Return the message received in reference for easier
  // integration
  static const NLNET::CMessage &
  buildMessageFor_createSession(NLNET::CMessage &__message, uint32 ownerCharId,
                                TSessionId sessionId,
                                const RSMGR::TSessionType &type);

  // Message serializer. Return the message received in reference for easier
  // integration
  static const NLNET::CMessage &buildMessageFor_addCharacterInSession(
      NLNET::CMessage &__message, TSessionId sessionId, uint32 charId,
      const WS::TUserRole &enterAs, const std::string &ringAccess,
      bool newcomer);

  // Message serializer. Return the message received in reference for easier
  // integration
  static const NLNET::CMessage &
  buildMessageFor_closeSession(NLNET::CMessage &__message,
                               TSessionId sessionId);

  // Message serializer. Return the message received in reference for easier
  // integration
  static const NLNET::CMessage &
  buildMessageFor_stopHibernation(NLNET::CMessage &__message,
                                  TSessionId sessionId, uint32 ownerId);

  // Message serializer. Return the message received in reference for easier
  // integration
  static const NLNET::CMessage &
  buildMessageFor_characterKicked(NLNET::CMessage &__message,
                                  TSessionId sessionId, uint32 charId);

  // Message serializer. Return the message received in reference for easier
  // integration
  static const NLNET::CMessage &
  buildMessageFor_characterUnkicked(NLNET::CMessage &__message,
                                    TSessionId sessionId, uint32 charId);

  // Message serializer. Return the message received in reference for easier
  // integration
  static const NLNET::CMessage &buildMessageFor_teleportOneCharacterToAnother(
      NLNET::CMessage &__message, TSessionId sessionId, uint32 sourceCharId,
      uint32 destCharId);

  // Message serializer. Return the message received in reference for easier
  // integration
  static const NLNET::CMessage &
  buildMessageFor_hibernateSession(NLNET::CMessage &__message,
                                   TSessionId sessionId);

  // Message serializer. Return the message received in reference for easier
  // integration
  static const NLNET::CMessage &buildMessageFor_setSessionStartParams(
      NLNET::CMessage &__message, uint32 charId, TSessionId sessionId,
      const std::string &initialIslandLocation,
      const std::string &initialEntryPointLocation,
      const std::string &initialSeason);
};
...
protected:
  ...
  static void _cbConnection(NLNET::TSockId from, void *arg) {
    ...
    CRingSessionManagerWebItf *_this =
        reinterpret_cast<CRingSessionManagerWebItf *>(arg);
...
public:
  ...
  CRingSessionManagerWebItf(ICallbackServerAdaptor *replacementAdaptor = NULL) {
    if (replacementAdaptor == NULL) {
      ...
      _CallbackServer = CUniquePtr<ICallbackServerAdaptor>(
  ...
  void update() {
    ...
    try {
      ...
      nlwarning("CRingSessionManagerWeb : Exception launch in callback server "
                "update");
    }
  }
  ...
  void invokeResult(NLNET::TSockId dest, uint32 userId, uint32 resultCode,
  ...
  void scheduleSessionResult(NLNET::TSockId dest, uint32 charId,
  ...
  void sessionInfoResult(
      NLNET::TSockId dest, uint32 charId, TSessionId sessionId,
      const TRaceFilter &raceFilter, const TReligionFilter &religionFilter,
      const TGuildFilter &guildFilter, const TShardFilter &shardFilter,
      const TLevelFilter &levelFilter, bool subscriptionClosed, bool autoInvite,
      const std::string &language, const TSessionOrientation &orientation,
  ...
  // <lua>runAH(nul, "on_connect_to_shard",
  // "cookie=cookieValue|fsAddr=shardAddr|mode=participantStatus");<lua> result
  // : 0 : ok the client can join the session
  //          1 : char not found
  //          2 : session not found
  //          3 : no session participant for this character (not used for a
  //          mainland shard) 4 : can't find session server (not used for a
  //          mainland shard) 5 : shard hosting session is not reachable 6 : nel
  //          user info not found 7 : ring user not found 8 : welcome service
  //          rejected connection request 9 : session service shutdown (not used
  //          for a mainland shard)
  ...
  void joinSessionResult(NLNET::TSockId dest, uint32 userId,
                         TSessionId sessionId, uint32 result,
                         const std::string &shardAddr,
                         const TSessionPartStatus &participantStatus) {
    ...
    nlWrite(message, serial,
            const_cast<TSessionPartStatus &>(participantStatus));
  ...
  void
  joinSessionResultExt(NLNET::TSockId dest, uint32 userId, TSessionId sessionId,
                       uint32 result, const std::string &shardAddr,
                       const TSessionPartStatus &participantStatus,
                       const CSecurityCode &securityCheckForFastDisconnection) {
    ...
    nlWrite(message, serial,
            const_cast<TSessionPartStatus &>(participantStatus));
    nlWrite(message, serial,
            const_cast<CSecurityCode &>(securityCheckForFastDisconnection));
  ...
  // can be queried from the database. Offline shards are the ones in the
  // database of the same domain but not listed in the result. Then the client
  // will have to call joinShard to connect on an online shard.

  void getShardsResult(NLNET::TSockId dest, uint32 userId,
  ...
  static void cb_scheduleSession(NLNET::CMessage &message, NLNET::TSockId from,
                                 NLNET::CCallbackNetBase &netbase) {
    H_AUTO(scheduleSession_on_scheduleSession);
#ifdef NL_DEBUG
    nldebug(
        "CRingSessionManagerWeb::cb_scheduleSession received from class '%s'",
        typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());

    CRingSessionManagerWebItf *callback =
        (CRingSessionManagerWebItf *)adaptor->getContainerClass();
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_scheduleSession : calling "
            "on_scheduleSession");
#endif

    callback->on_scheduleSession(
        from, charId, sessionType, sessionTitle, sessionDesc, sessionLevel,
        ruleType, estimatedDuration, subscriptionSlot, animMode, raceFilter,
        religionFilter, guildFilter, shardFilter, levelFilter, language,
        orientation, subscriptionClosed, autoInvite);
  }

  static void cb_setSessionStartParams(NLNET::CMessage &message,
                                       NLNET::TSockId from,
                                       NLNET::CCallbackNetBase &netbase) {
    H_AUTO(setSessionStartParams_on_setSessionStartParams);
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_setSessionStartParams received from "
            "class '%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_setSessionStartParams : calling "
            "on_setSessionStartParams");
#endif

    callback->on_setSessionStartParams(
        from, charId, sessionId, initialIslandLocation,
        initialEntryPointLocation, initialSeason);
  }

  static void cb_getSessionInfo(NLNET::CMessage &message, NLNET::TSockId from,
                                NLNET::CCallbackNetBase &netbase) {
    H_AUTO(getSessionInfo_on_getSessionInfo);
#ifdef NL_DEBUG
    nldebug(
        "CRingSessionManagerWeb::cb_getSessionInfo received from class '%s'",
        typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_getSessionInfo : calling "
            "on_getSessionInfo");
#endif
  ...
  static void cb_updateSessionInfo(NLNET::CMessage &message,
                                   NLNET::TSockId from,
                                   NLNET::CCallbackNetBase &netbase) {
    H_AUTO(updateSessionInfo_on_updateSessionInfo);
#ifdef NL_DEBUG
    nldebug(
        "CRingSessionManagerWeb::cb_updateSessionInfo received from class '%s'",
        typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_updateSessionInfo : calling "
            "on_updateSessionInfo");
#endif

    callback->on_updateSessionInfo(
        from, charId, sessionId, sessionTitle, plannedDate, sessionDesc,
        sessionLevel, estimatedDuration, subscriptionSlot, raceFilter,
        religionFilter, guildFilter, shardFilter, levelFilter,
        subscriptionClosed, autoInvite, language, orientation);
  }

  static void cb_cancelSession(NLNET::CMessage &message, NLNET::TSockId from,
                               NLNET::CCallbackNetBase &netbase) {
    H_AUTO(cancelSession_on_cancelSession);
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_cancelSession received from class '%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug(
        "CRingSessionManagerWeb::cb_cancelSession : calling on_cancelSession");
#endif

    callback->on_cancelSession(from, charId, sessionId);
  }

  static void cb_startSession(NLNET::CMessage &message, NLNET::TSockId from,
                              NLNET::CCallbackNetBase &netbase) {
    H_AUTO(startSession_on_startSession);
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_startSession received from class '%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug(
        "CRingSessionManagerWeb::cb_startSession : calling on_startSession");
#endif

    callback->on_startSession(from, charId, sessionId);
  }

  static void cb_closeSession(NLNET::CMessage &message, NLNET::TSockId from,
                              NLNET::CCallbackNetBase &netbase) {
    H_AUTO(closeSession_on_closeSession);
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_closeSession received from class '%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug(
        "CRingSessionManagerWeb::cb_closeSession : calling on_closeSession");
#endif

    callback->on_closeSession(from, charId, sessionId);
  }

  static void cb_closeEditSession(NLNET::CMessage &message, NLNET::TSockId from,
                                  NLNET::CCallbackNetBase &netbase) {
    H_AUTO(closeEditSession_on_closeEditSession);
#ifdef NL_DEBUG
    nldebug(
        "CRingSessionManagerWeb::cb_closeEditSession received from class '%s'",
        typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_closeEditSession : calling "
            "on_closeEditSession");
#endif
  ...
  static void cb_addFriendCharacter(NLNET::CMessage &message,
                                    NLNET::TSockId from,
                                    NLNET::CCallbackNetBase &netbase) {
    H_AUTO(addFriendCharacter_on_addFriendCharacter);
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_addFriendCharacter received from class "
            "'%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_addFriendCharacter : calling "
            "on_addFriendCharacter");
#endif

    callback->on_addFriendCharacter(from, userId, friendCharId);
  }

  static void cb_removeFriendCharacter(NLNET::CMessage &message,
                                       NLNET::TSockId from,
                                       NLNET::CCallbackNetBase &netbase) {
    H_AUTO(removeFriendCharacter_on_removeFriendCharacter);
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_removeFriendCharacter received from "
            "class '%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_removeFriendCharacter : calling "
            "on_removeFriendCharacter");
#endif

    callback->on_removeFriendCharacter(from, userId, friendCharId);
  }

  static void cb_addBannedCharacter(NLNET::CMessage &message,
                                    NLNET::TSockId from,
                                    NLNET::CCallbackNetBase &netbase) {
    H_AUTO(addBannedCharacter_on_addBannedCharacter);
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_addBannedCharacter received from class "
            "'%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_addBannedCharacter : calling "
            "on_addBannedCharacter");
#endif

    callback->on_addBannedCharacter(from, userId, bannedCharId);
  }

  static void cb_removeBannedCharacter(NLNET::CMessage &message,
                                       NLNET::TSockId from,
                                       NLNET::CCallbackNetBase &netbase) {
    H_AUTO(removeBannedCharacter_on_removeBannedCharacter);
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_removeBannedCharacter received from "
            "class '%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_removeBannedCharacter : calling "
            "on_removeBannedCharacter");
#endif

    callback->on_removeBannedCharacter(from, userId, bannedCharId);
  }

  static void cb_addFriendDMCharacter(NLNET::CMessage &message,
                                      NLNET::TSockId from,
                                      NLNET::CCallbackNetBase &netbase) {
    H_AUTO(addFriendDMCharacter_on_addFriendDMCharacter);
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_addFriendDMCharacter received from "
            "class '%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_addFriendDMCharacter : calling "
            "on_addFriendDMCharacter");
#endif

    callback->on_addFriendDMCharacter(from, userId, friendDMCharId);
  }

  static void cb_removeFriendDMCharacter(NLNET::CMessage &message,
                                         NLNET::TSockId from,
                                         NLNET::CCallbackNetBase &netbase) {
    H_AUTO(removeFriendDMCharacter_on_removeFriendDMCharacter);
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_removeFriendDMCharacter received from "
            "class '%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_removeFriendDMCharacter : calling "
            "on_removeFriendDMCharacter");
#endif

    callback->on_removeFriendDMCharacter(from, userId, friendDMCharId);
  }

  static void cb_setKnownCharacterComments(NLNET::CMessage &message,
                                           NLNET::TSockId from,
                                           NLNET::CCallbackNetBase &netbase) {
    H_AUTO(setKnownCharacterComments_on_setKnownCharacterComments);
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_setKnownCharacterComments received "
            "from class '%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_setKnownCharacterComments : calling "
            "on_setKnownCharacterComments");
#endif

    callback->on_setKnownCharacterComments(from, userId, charId, relation,
                                           comments);
  }

  static void cb_inviteCharacter(NLNET::CMessage &message, NLNET::TSockId from,
                                 NLNET::CCallbackNetBase &netbase) {
    H_AUTO(inviteCharacter_on_inviteCharacter);
#ifdef NL_DEBUG
    nldebug(
        "CRingSessionManagerWeb::cb_inviteCharacter received from class '%s'",
        typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_inviteCharacter : calling "
            "on_inviteCharacter");
#endif

    callback->on_inviteCharacter(from, ownerCharId, sessionId, invitedCharId,
                                 charRole);
  }

  static void cb_removeInvitedCharacter(NLNET::CMessage &message,
                                        NLNET::TSockId from,
                                        NLNET::CCallbackNetBase &netbase) {
    H_AUTO(removeInvitedCharacter_on_removeInvitedCharacter);
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_removeInvitedCharacter received from "
            "class '%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_removeInvitedCharacter : calling "
            "on_removeInvitedCharacter");
#endif

    callback->on_removeInvitedCharacter(from, ownerCharId, sessionId,
                                        removedCharId);
  }

  static void cb_subscribeSession(NLNET::CMessage &message, NLNET::TSockId from,
                                  NLNET::CCallbackNetBase &netbase) {
    H_AUTO(subscribeSession_on_subscribeSession);
#ifdef NL_DEBUG
    nldebug(
        "CRingSessionManagerWeb::cb_subscribeSession received from class '%s'",
        typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_subscribeSession : calling "
            "on_subscribeSession");
#endif
  ...
  static void cb_unsubscribeSession(NLNET::CMessage &message,
                                    NLNET::TSockId from,
                                    NLNET::CCallbackNetBase &netbase) {
    H_AUTO(unsubscribeSession_on_unsubscribeSession);
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_unsubscribeSession received from class "
            "'%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_unsubscribeSession : calling "
            "on_unsubscribeSession");
#endif

    callback->on_unsubscribeSession(from, charId, sessionId);
  }

  static void cb_joinSession(NLNET::CMessage &message, NLNET::TSockId from,
                             NLNET::CCallbackNetBase &netbase) {
    H_AUTO(joinSession_on_joinSession);
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_joinSession received from class '%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
  ...
  static void cb_joinMainland(NLNET::CMessage &message, NLNET::TSockId from,
                              NLNET::CCallbackNetBase &netbase) {
    H_AUTO(joinMainland_on_joinMainland);
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_joinMainland received from class '%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug(
        "CRingSessionManagerWeb::cb_joinMainland : calling on_joinMainland");
#endif

    callback->on_joinMainland(from, charId, clientApplication);
  }

  static void cb_joinEditSession(NLNET::CMessage &message, NLNET::TSockId from,
                                 NLNET::CCallbackNetBase &netbase) {
    H_AUTO(joinEditSession_on_joinEditSession);
#ifdef NL_DEBUG
    nldebug(
        "CRingSessionManagerWeb::cb_joinEditSession received from class '%s'",
        typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_joinEditSession : calling "
            "on_joinEditSession");
#endif
  ...
  static void cb_hibernateEditSession(NLNET::CMessage &message,
                                      NLNET::TSockId from,
                                      NLNET::CCallbackNetBase &netbase) {
    H_AUTO(hibernateEditSession_on_hibernateEditSession);
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_hibernateEditSession received from "
            "class '%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_hibernateEditSession : calling "
            "on_hibernateEditSession");
#endif

    callback->on_hibernateEditSession(from, charId);
  }

  static void cb_getShards(NLNET::CMessage &message, NLNET::TSockId from,
                           NLNET::CCallbackNetBase &netbase) {
    H_AUTO(getShards_on_getShards);
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_getShards received from class '%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
  ...
  static void cb_kickCharacter(NLNET::CMessage &message, NLNET::TSockId from,
                               NLNET::CCallbackNetBase &netbase) {
    H_AUTO(kickCharacter_on_kickCharacter);
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_kickCharacter received from class '%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug(
        "CRingSessionManagerWeb::cb_kickCharacter : calling on_kickCharacter");
#endif

    callback->on_kickCharacter(from, ownerCharId, sessionId, kickedCharId);
  }

  static void cb_unkickCharacter(NLNET::CMessage &message, NLNET::TSockId from,
                                 NLNET::CCallbackNetBase &netbase) {
    H_AUTO(unkickCharacter_on_unkickCharacter);
#ifdef NL_DEBUG
    nldebug(
        "CRingSessionManagerWeb::cb_unkickCharacter received from class '%s'",
        typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_unkickCharacter : calling "
            "on_unkickCharacter");
#endif
  ...
  static void cb_inviteGuild(NLNET::CMessage &message, NLNET::TSockId from,
                             NLNET::CCallbackNetBase &netbase) {
    H_AUTO(inviteGuild_on_inviteGuild);
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_inviteGuild received from class '%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
  ...
  static void cb_removeInvitedGuild(NLNET::CMessage &message,
                                    NLNET::TSockId from,
                                    NLNET::CCallbackNetBase &netbase) {
    H_AUTO(removeInvitedGuild_on_removeInvitedGuild);
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_removeInvitedGuild received from class "
            "'%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_removeInvitedGuild : calling "
            "on_removeInvitedGuild");
#endif

    callback->on_removeInvitedGuild(from, charId, sessionId, guildId);
  }

  static void cb_setScenarioInfo(NLNET::CMessage &message, NLNET::TSockId from,
                                 NLNET::CCallbackNetBase &netbase) {
    H_AUTO(setScenarioInfo_on_setScenarioInfo);
#ifdef NL_DEBUG
    nldebug(
        "CRingSessionManagerWeb::cb_setScenarioInfo received from class '%s'",
        typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_setScenarioInfo : calling "
            "on_setScenarioInfo");
#endif

    callback->on_setScenarioInfo(from, charId, sessionId, title, numPlayer,
                                 playType);
  }

  static void cb_addJournalEntry(NLNET::CMessage &message, NLNET::TSockId from,
                                 NLNET::CCallbackNetBase &netbase) {
    H_AUTO(addJournalEntry_on_addJournalEntry);
#ifdef NL_DEBUG
    nldebug(
        "CRingSessionManagerWeb::cb_addJournalEntry received from class '%s'",
        typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_addJournalEntry : calling "
            "on_addJournalEntry");
#endif
  ...
  static void cb_setPlayerRating(NLNET::CMessage &message, NLNET::TSockId from,
                                 NLNET::CCallbackNetBase &netbase) {
    H_AUTO(setPlayerRating_on_setPlayerRating);
#ifdef NL_DEBUG
    nldebug(
        "CRingSessionManagerWeb::cb_setPlayerRating received from class '%s'",
        typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWeb::cb_setPlayerRating : calling "
            "on_setPlayerRating");
#endif

    callback->on_setPlayerRating(from, charId, sessionId, rateFun,
                                 rateDifficulty, rateAccessibility,
  ...
  virtual void on_scheduleSession(
      NLNET::TSockId from, uint32 charId, const TSessionType &sessionType,
      const std::string &sessionTitle, const std::string &sessionDesc,
      const R2::TSessionLevel &sessionLevel, const TRuleType &ruleType,
      const TEstimatedDuration &estimatedDuration, uint32 subscriptionSlot,
      const TAnimMode &animMode, const TRaceFilter &raceFilter,
      const TReligionFilter &religionFilter, const TGuildFilter &guildFilter,
      const TShardFilter &shardFilter, const TLevelFilter &levelFilter,
      const std::string &language, const TSessionOrientation &orientation,
      bool subscriptionClosed, bool autoInvite) = 0;

  // Set the start position of a session (eg while your are uploading an
  // animation session)
  virtual void
  on_setSessionStartParams(NLNET::TSockId from, uint32 charId,
                           TSessionId sessionId,
                           const std::string &initialIslandLocation,
                           const std::string &initialEntryPointLocation,
                           const std::string &initialSeason) = 0;
  ...
  virtual void on_getSessionInfo(NLNET::TSockId from, uint32 charId,
                                 TSessionId sessionId) = 0;
  ...
  virtual void on_updateSessionInfo(
      ...
      const std::string &sessionTitle, uint32 plannedDate,
      const std::string &sessionDesc, const R2::TSessionLevel &sessionLevel,
      const TEstimatedDuration &estimatedDuration, uint32 subscriptionSlot,
      const TRaceFilter &raceFilter, const TReligionFilter &religionFilter,
      const TGuildFilter &guildFilter, const TShardFilter &shardFilter,
      const TLevelFilter &levelFilter, bool subscriptionClosed, bool autoInvite,
      const std::string &language, const TSessionOrientation &orientation) = 0;
  ...
  virtual void on_cancelSession(NLNET::TSockId from, uint32 charId,
                                TSessionId sessionId) = 0;
  ...
  //                         4 : user is already have a running session of this
  //                         type 5 : session server failure 6 : Action
  //                         fordidden for free trial 7 : User not found
  virtual void on_startSession(NLNET::TSockId from, uint32 charId,
                               TSessionId sessionId) = 0;
  ...
  virtual void on_closeSession(NLNET::TSockId from, uint32 charId,
                               TSessionId sessionId) = 0;
  ...
  virtual void on_addFriendCharacter(NLNET::TSockId from, uint32 userId,
                                     uint32 friendCharId) = 0;
  ...
  //                         2 : friend char not found
  //                         3 : char not friend
  virtual void on_removeFriendCharacter(NLNET::TSockId from, uint32 userId,
                                        uint32 friendCharId) = 0;

  // Add a character to a user ban list. This ban the user that own the
  // character Return 'invokeResult' : 0 : ok
  //                         1 : user not found
  //                         2 : banned char not found
  //                         3 : char already banned by user
  virtual void on_addBannedCharacter(NLNET::TSockId from, uint32 userId,
                                     uint32 bannedCharId) = 0;
  ...
  virtual void on_removeBannedCharacter(NLNET::TSockId from, uint32 userId,
                                        uint32 bannedCharId) = 0;
  ...
  virtual void on_addFriendDMCharacter(NLNET::TSockId from, uint32 userId,
                                       uint32 friendDMCharId) = 0;
  ...
  //                         2 : friend char not found
  //                         3 : char not friend
  virtual void on_removeFriendDMCharacter(NLNET::TSockId from, uint32 userId,
                                          uint32 friendDMCharId) = 0;
  ...
  //                         3 : character relation don't match the set comments
  //                         relation 4 : internal error
  virtual void on_setKnownCharacterComments(NLNET::TSockId from, uint32 userId,
                                            uint32 charId,
  ...
  //                6 : char role and session type don't match (edit/editor,
  //                anim/animator) 7 : charRole is invalid (must be
  //                sps_play_invited, sps_edit_invited or sps_anim_invited) 8 :
  //                database failure
  ...
  virtual void on_inviteCharacter(NLNET::TSockId from, uint32 ownerCharId,
                                  TSessionId sessionId, uint32 invitedCharId,
                                  const TSessionPartStatus &charRole) = 0;
  ...
  virtual void on_removeInvitedCharacter(NLNET::TSockId from,
                                         uint32 ownerCharId,
                                         TSessionId sessionId,
                                         uint32 removedCharId) = 0;

  // A character subscribe to a public animation session
  // invokeReturn : 0 : ok, subscription accepted
  //                1 : char not found
  //                2 : session not found
  //                3 : character already subscribed to or invited in the
  //                session 4 : session not public 5 : character banned 6 : no
  //                place left, session is full 7 : session owner not found 8 :
  //                internal error
  virtual void on_subscribeSession(NLNET::TSockId from, uint32 charId,
                                   TSessionId sessionId) = 0;
  ...
  virtual void on_unsubscribeSession(NLNET::TSockId from, uint32 charId,
                                     TSessionId sessionId) = 0;

  // A character asks to join (or enter) a running session.
  // It must have been subscribed or invited to the session to be allowed
  virtual void on_joinSession(NLNET::TSockId from, uint32 charId,
                              TSessionId sessionId,
                              const std::string &clientApplication) = 0;
  ...
  virtual void on_joinMainland(NLNET::TSockId from, uint32 charId,
                               const std::string &clientApplication) = 0;
  ...
  virtual void on_joinEditSession(NLNET::TSockId from, uint32 charId,
                                  const std::string &clientApplication) = 0;
  ...
  //                4 : internal error
  //                5 : owner char don't own the session
  virtual void on_kickCharacter(NLNET::TSockId from, uint32 ownerCharId,
                                TSessionId sessionId, uint32 kickedCharId) = 0;
  ...
  //                4 : internal error
  //                5 : owner char don't own the session
  virtual void on_unkickCharacter(NLNET::TSockId from, uint32 ownerCharId,
                                  TSessionId sessionId,
                                  uint32 unkickedCharId) = 0;
  ...
  virtual void on_inviteGuild(NLNET::TSockId from, uint32 charId,
                              TSessionId sessionId, uint32 guildId) = 0;
  ...
  //                4 : guild not invited
  //                5 : char don't own the session
  virtual void on_removeInvitedGuild(NLNET::TSockId from, uint32 charId,
                                     TSessionId sessionId, uint32 guildId) = 0;
  ...
  //                3 : char not found
  virtual void on_setScenarioInfo(NLNET::TSockId from, uint32 charId,
                                  TSessionId sessionId,
                                  const std::string &title, uint32 numPlayer,
                                  const std::string &playType) = 0;

  // Add an entry in the session journal
  // invokeReturn : 0 : ok, entry added
  //                1 : scenario not found
  //                2 : user can't post in this journal
  virtual void on_addJournalEntry(NLNET::TSockId from, uint32 charId,
                                  TSessionId sessionId,
  ...
  //                8 : internal error
  virtual void on_setPlayerRating(NLNET::TSockId from, uint32 charId,
                                  TSessionId sessionId, uint32 rateFun,
                                  uint32 rateDifficulty,
                                  uint32 rateAccessibility,
                                  uint32 rateOriginality,
                                  uint32 rateDirection) = 0;
};
...
protected:
  ...
  static void _cbDisconnection(NLNET::TSockId from, void *arg) {
    CRingSessionManagerWebClientItf *_this =
        reinterpret_cast<CRingSessionManagerWebClientItf *>(arg);
...
public:
  ...
  static const std::string &getMessageName(const std::string &methodName) {
    ...
    if (!initialized) {
      messageNames.insert(
          std::make_pair(std::string("on_invokeResult"), std::string("RET")));
      messageNames.insert(std::make_pair(
          std::string("on_scheduleSessionResult"), std::string("SSSR")));
      messageNames.insert(std::make_pair(std::string("on_sessionInfoResult"),
                                         std::string("SIR")));
      messageNames.insert(std::make_pair(std::string("on_joinSessionResult"),
                                         std::string("JSSR")));
      messageNames.insert(std::make_pair(std::string("on_joinSessionResultExt"),
                                         std::string("JSSRE")));
      messageNames.insert(std::make_pair(std::string("on_getShardsResult"),
                                         std::string("GSHR")));
  ...
  CRingSessionManagerWebClientItf(
      ICallbackClientAdaptor *adaptorReplacement = NULL) {
    if (adaptorReplacement == NULL) {
      // use the default Nel adaptor
      _CallbackClient = CUniquePtr<ICallbackClientAdaptor>(
  ...
  /// Connect the interface client to the callback server at the specified
  /// address and port
  ...
  virtual void update() {
    ...
    try {
      ...
      nlwarning("CRingSessionManagerWeb : Exception launch in callback client "
                "update");
    }
  }
  ...
  void scheduleSession(
      uint32 charId, const TSessionType &sessionType,
      const std::string &sessionTitle, const std::string &sessionDesc,
      const R2::TSessionLevel &sessionLevel, const TRuleType &ruleType,
      const TEstimatedDuration &estimatedDuration, uint32 subscriptionSlot,
      const TAnimMode &animMode, const TRaceFilter &raceFilter,
  ...
  void setSessionStartParams(uint32 charId, TSessionId sessionId,
                             const std::string &initialIslandLocation,
                             const std::string &initialEntryPointLocation,
                             const std::string &initialSeason) {
#ifdef NL_DEBUG
    ...
    nlWrite(message, serial,
            const_cast<std::string &>(initialEntryPointLocation));
  ...
  void updateSessionInfo(
      uint32 charId, TSessionId sessionId, const std::string &sessionTitle,
      uint32 plannedDate, const std::string &sessionDesc,
      const R2::TSessionLevel &sessionLevel,
      const TEstimatedDuration &estimatedDuration, uint32 subscriptionSlot,
      const TRaceFilter &raceFilter, const TReligionFilter &religionFilter,
      const TGuildFilter &guildFilter, const TShardFilter &shardFilter,
      const TLevelFilter &levelFilter, bool subscriptionClosed, bool autoInvite,
  ...
  void setKnownCharacterComments(uint32 userId, uint32 charId,
                                 const std::string &relation,
  ...
  void inviteCharacter(uint32 ownerCharId, TSessionId sessionId,
                       uint32 invitedCharId,
                       const TSessionPartStatus &charRole) {
#ifdef NL_DEBUG
  ...
  void removeInvitedCharacter(uint32 ownerCharId, TSessionId sessionId,
                              uint32 removedCharId) {
#ifdef NL_DEBUG
  ...
  void joinSession(uint32 charId, TSessionId sessionId,
                   const std::string &clientApplication) {
#ifdef NL_DEBUG
  ...
  void kickCharacter(uint32 ownerCharId, TSessionId sessionId,
                     uint32 kickedCharId) {
#ifdef NL_DEBUG
  ...
  void unkickCharacter(uint32 ownerCharId, TSessionId sessionId,
                       uint32 unkickedCharId) {
#ifdef NL_DEBUG
  ...
  void setScenarioInfo(uint32 charId, TSessionId sessionId,
                       const std::string &title, uint32 numPlayer,
  ...
  void addJournalEntry(uint32 charId, TSessionId sessionId,
  ...
  void setPlayerRating(uint32 charId, TSessionId sessionId, uint32 rateFun,
  ...
  static void cb_invokeResult(NLNET::CMessage &message, NLNET::TSockId from,
                              NLNET::CCallbackNetBase &netbase) {
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWebClient::cb_invokeResult received from class "
            "'%s'",
            typeid(netbase).name());
#endif
    ICallbackClientAdaptor *adaptor =
        static_cast<ICallbackClientAdaptor *>(netbase.getUserData());

    CRingSessionManagerWebClientItf *callback =
        (CRingSessionManagerWebClientItf *)adaptor->getContainerClass();
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWebClient::cb_invokeResult : calling "
            "on_invokeResult");
#endif
  ...
  static void cb_scheduleSessionResult(NLNET::CMessage &message,
                                       NLNET::TSockId from,
                                       NLNET::CCallbackNetBase &netbase) {
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWebClient::cb_scheduleSessionResult received "
            "from class '%s'",
            typeid(netbase).name());
#endif
    ICallbackClientAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWebClient::cb_scheduleSessionResult : calling "
            "on_scheduleSessionResult");
#endif

    callback->on_scheduleSessionResult(from, charId, sessionId, result,
                                       resultString);
  }

  static void cb_sessionInfoResult(NLNET::CMessage &message,
                                   NLNET::TSockId from,
                                   NLNET::CCallbackNetBase &netbase) {
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWebClient::cb_sessionInfoResult received from "
            "class '%s'",
            typeid(netbase).name());
#endif
    ICallbackClientAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWebClient::cb_sessionInfoResult : calling "
            "on_sessionInfoResult");
#endif

    callback->on_sessionInfoResult(from, charId, sessionId, raceFilter,
                                   religionFilter, guildFilter, shardFilter,
                                   levelFilter, subscriptionClosed, autoInvite,
                                   language, orientation, description);
  }

  static void cb_joinSessionResult(NLNET::CMessage &message,
                                   NLNET::TSockId from,
                                   NLNET::CCallbackNetBase &netbase) {
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWebClient::cb_joinSessionResult received from "
            "class '%s'",
            typeid(netbase).name());
#endif
    ICallbackClientAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWebClient::cb_joinSessionResult : calling "
            "on_joinSessionResult");
#endif

    callback->on_joinSessionResult(from, userId, sessionId, result, shardAddr,
                                   participantStatus);
  }

  static void cb_joinSessionResultExt(NLNET::CMessage &message,
                                      NLNET::TSockId from,
                                      NLNET::CCallbackNetBase &netbase) {
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWebClient::cb_joinSessionResultExt received "
            "from class '%s'",
            typeid(netbase).name());
#endif
    ICallbackClientAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWebClient::cb_joinSessionResultExt : calling "
            "on_joinSessionResultExt");
#endif

    callback->on_joinSessionResultExt(from, userId, sessionId, result,
                                      shardAddr, participantStatus,
                                      securityCheckForFastDisconnection);
  }

  static void cb_getShardsResult(NLNET::CMessage &message, NLNET::TSockId from,
                                 NLNET::CCallbackNetBase &netbase) {
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWebClient::cb_getShardsResult received from "
            "class '%s'",
            typeid(netbase).name());
#endif
    ICallbackClientAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CRingSessionManagerWebClient::cb_getShardsResult : calling "
            "on_getShardsResult");
#endif
  ...
  virtual void
  on_CRingSessionManagerWebClient_Disconnection(NLNET::TSockId from) = 0;

  // Generic response to invoke.
  // result contains 0 if no error, more than 0 in case of error
  virtual void on_invokeResult(NLNET::TSockId from, uint32 userId,
                               uint32 resultCode,
                               const std::string &resultString) = 0;
  ...
  // session info result (anim)
  virtual void on_sessionInfoResult(
      NLNET::TSockId from, uint32 charId, TSessionId sessionId,
      const TRaceFilter &raceFilter, const TReligionFilter &religionFilter,
      const TGuildFilter &guildFilter, const TShardFilter &shardFilter,
      const TLevelFilter &levelFilter, bool subscriptionClosed, bool autoInvite,
  ...
  on_joinSessionResult(NLNET::TSockId from, uint32 userId, TSessionId sessionId,
                       uint32 result, const std::string &shardAddr,
                       const TSessionPartStatus &participantStatus) = 0;

  // See joinSessionResult.
  // Adds a security code.
  virtual void on_joinSessionResultExt(
      NLNET::TSockId from, uint32 userId, TSessionId sessionId, uint32 result,
      const std::string &shardAddr, const TSessionPartStatus &participantStatus,
      const CSecurityCode &securityCheckForFastDisconnection) = 0;
...
public:
  ...
  void setSessionId(TSessionId value) { _SessionId = value; }
  //
  bool getRequesterCharInvited() const { return _RequesterCharInvited; }

  void setRequesterCharInvited(bool value) { _RequesterCharInvited = value; }
  //
  bool getRequesterCharKicked() const { return _RequesterCharKicked; }

  void setRequesterCharKicked(bool value) { _RequesterCharKicked = value; }
  //
  const std::string &getOwnerName() const { return _OwnerName; }

  std::string &getOwnerName() { return _OwnerName; }

  void setOwnerName(const std::string &value) { _OwnerName = value; }
  //
  ...
  //
  TAnimMode getAnimMode() const { return _AnimMode; }

  void setAnimMode(TAnimMode value) { _AnimMode = value; }
  //
  R2::TSessionLevel getSessionLevel() const { return _SessionLevel; }

  void setSessionLevel(R2::TSessionLevel value) { _SessionLevel = value; }
  //
  bool getAllowFreeTrial() const { return _AllowFreeTrial; }

  void setAllowFreeTrial(bool value) { _AllowFreeTrial = value; }
  //
  uint32 getLaunchDate() const { return _LaunchDate; }

  void setLaunchDate(uint32 value) { _LaunchDate = value; }
  //
  uint32 getNbConnectedPlayer() const { return _NbConnectedPlayer; }

  void setNbConnectedPlayer(uint32 value) { _NbConnectedPlayer = value; }
  //
  ...
  //
  TSessionOrientation getOrientation() const { return _Orientation; }

  void setOrientation(TSessionOrientation value) { _Orientation = value; }
  //
  uint32 getNbRating() const { return _NbRating; }

  void setNbRating(uint32 value) { _NbRating = value; }
  //
  uint32 getRateFun() const { return _RateFun; }

  void setRateFun(uint32 value) { _RateFun = value; }
  //
  uint32 getRateDifficulty() const { return _RateDifficulty; }

  void setRateDifficulty(uint32 value) { _RateDifficulty = value; }
  //
  uint32 getRateAccessibility() const { return _RateAccessibility; }

  void setRateAccessibility(uint32 value) { _RateAccessibility = value; }
  //
  uint32 getRateOriginality() const { return _RateOriginality; }

  void setRateOriginality(uint32 value) { _RateOriginality = value; }
  //
  uint32 getRateDirection() const { return _RateDirection; }

  void setRateDirection(uint32 value) { _RateDirection = value; }
  //
  uint32 getScenarioRRPTotal() const { return _ScenarioRRPTotal; }

  void setScenarioRRPTotal(uint32 value) { _ScenarioRRPTotal = value; }
  ...
  bool operator==(const TSessionDesc &other) const {
    return _SessionId == other._SessionId &&
           ...
           _OwnerName == other._OwnerName && _Title == other._Title &&
           _Description == other._Description && _AnimMode == other._AnimMode &&
           ...
           _Language == other._Language && _Orientation == other._Orientation &&
           _NbRating == other._NbRating && _RateFun == other._RateFun &&
...
public:
  ...
  void setCharId(uint32 value) { _CharId = value; }
  //
  ...
  void setKicked(bool value) { _Kicked = value; }
  //
  const std::string &getCharName() const { return _CharName; }

  std::string &getCharName() { return _CharName; }

  void setCharName(const std::string &value) { _CharName = value; }
  //
  const std::string &getGuildName() const { return _GuildName; }

  std::string &getGuildName() { return _GuildName; }

  void setGuildName(const std::string &value) { _GuildName = value; }
  //
  uint32 getShardId() const { return _ShardId; }

  void setShardId(uint32 value) { _ShardId = value; }
  //
  R2::TSessionLevel getLevel() const { return _Level; }

  void setLevel(R2::TSessionLevel value) { _Level = value; }
  //
  CHARSYNC::TRace getRace() const { return _Race; }

  void setRace(CHARSYNC::TRace value) { _Race = value; }
  //
  CHARSYNC::TCivilisation getCivilisation() const { return _Civilisation; }

  void setCivilisation(CHARSYNC::TCivilisation value) { _Civilisation = value; }
  //
  CHARSYNC::TCult getCult() const { return _Cult; }

  void setCult(CHARSYNC::TCult value) { _Cult = value; }
  //
  TSessionPartStatus getPartStatus() const { return _PartStatus; }

  void setPartStatus(TSessionPartStatus value) { _PartStatus = value; }

  bool operator==(const TCharDesc &other) const {
    return _CharId == other._CharId && _Connected == other._Connected &&
           _Kicked == other._Kicked && _CharName == other._CharName &&
           _GuildName == other._GuildName && _ShardId == other._ShardId &&
           _Level == other._Level && _Race == other._Race &&
           _Civilisation == other._Civilisation && _Cult == other._Cult &&
...
protected:
  ...
  static void _cbConnection(NLNET::TSockId from, void *arg) {
    ...
    CSessionBrowserServerWebItf *_this =
        reinterpret_cast<CSessionBrowserServerWebItf *>(arg);
...
public:
  ...
  void update() {
    ...
    try {
      ...
      nlwarning("CSessionBrowserServerWeb : Exception launch in callback "
                "server update");
    }
  }
  ...
  void sessionList(NLNET::TSockId dest, uint32 charId,
                   const std::vector<TSessionDesc> &sessions) {
    ...
    nlWrite(message, serial, charId);
    nlWrite(message, serialCont,
            const_cast<std::vector<TSessionDesc> &>(sessions));

    _CallbackServer->send(message, dest);
  }
  // Return the list of player characters in the session

  void charList(NLNET::TSockId dest, uint32 charId, TSessionId sessionId,
                const std::vector<TCharDesc> &characters) {
    ...
    nlWrite(message, serial, sessionId);
    nlWrite(message, serialCont,
            const_cast<std::vector<TCharDesc> &>(characters));

    _CallbackServer->send(message, dest);
  }
  // Return current player rating of the current session scenario

  void playerRatings(NLNET::TSockId dest, uint32 charId, bool scenarioRated,
                     uint32 rateFun, uint32 rateDifficulty,
                     uint32 rateAccessibility, uint32 rateOriginality,
                     uint32 rateDirection) {
  ...
  void sessionAverageScores(NLNET::TSockId dest, bool scenarioRated,
                            uint32 rateFun, uint32 rateDifficulty,
                            uint32 rateAccessibility, uint32 rateOriginality,
  ...
  void scenarioAverageScores(NLNET::TSockId dest, bool scenarioRated,
                             uint32 rateFun, uint32 rateDifficulty,
                             uint32 rateAccessibility, uint32 rateOriginality,
                             uint32 rateDirection, uint32 rrpTotal) {
  ...
  void ringRatings(NLNET::TSockId dest, uint32 charId, uint32 authorRating,
                   uint32 AMRating, uint32 masterlessRating) {
  ...
  void ringPoints(NLNET::TSockId dest, uint32 charId,
  ...
  static void cb_authenticate(NLNET::CMessage &message, NLNET::TSockId from,
                              NLNET::CCallbackNetBase &netbase) {
    H_AUTO(authenticate_on_authenticate);
#ifdef NL_DEBUG
    nldebug(
        "CSessionBrowserServerWeb::cb_authenticate received from class '%s'",
        typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());

    CSessionBrowserServerWebItf *callback =
        (CSessionBrowserServerWebItf *)adaptor->getContainerClass();
...
#ifdef NL_DEBUG
    nldebug(
        "CSessionBrowserServerWeb::cb_authenticate : calling on_authenticate");
#endif

    callback->on_authenticate(from, userId, cookie);
  }

  static void cb_getSessionList(NLNET::CMessage &message, NLNET::TSockId from,
                                NLNET::CCallbackNetBase &netbase) {
    H_AUTO(getSessionList_on_getSessionList);
#ifdef NL_DEBUG
    nldebug(
        "CSessionBrowserServerWeb::cb_getSessionList received from class '%s'",
        typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWeb::cb_getSessionList : calling "
            "on_getSessionList");
#endif
  ...
  static void cb_getCharList(NLNET::CMessage &message, NLNET::TSockId from,
                             NLNET::CCallbackNetBase &netbase) {
    H_AUTO(getCharList_on_getCharList);
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWeb::cb_getCharList received from class '%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug(
        "CSessionBrowserServerWeb::cb_getCharList : calling on_getCharList");
#endif

    callback->on_getCharList(from, charId, sessionId);
  }

  static void cb_inviteCharacterByName(NLNET::CMessage &message,
                                       NLNET::TSockId from,
                                       NLNET::CCallbackNetBase &netbase) {
    H_AUTO(inviteCharacterByName_on_inviteCharacterByName);
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWeb::cb_inviteCharacterByName received from "
            "class '%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWeb::cb_inviteCharacterByName : calling "
            "on_inviteCharacterByName");
#endif

    callback->on_inviteCharacterByName(from, charId, invitedCharName);
  }

  static void cb_getMyRatings(NLNET::CMessage &message, NLNET::TSockId from,
                              NLNET::CCallbackNetBase &netbase) {
    H_AUTO(getMyRatings_on_getMyRatings);
#ifdef NL_DEBUG
    nldebug(
        "CSessionBrowserServerWeb::cb_getMyRatings received from class '%s'",
        typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug(
        "CSessionBrowserServerWeb::cb_getMyRatings : calling on_getMyRatings");
#endif

    callback->on_getMyRatings(from, charId, sessionId);
  }

  static void cb_getSessionAverageScores(NLNET::CMessage &message,
                                         NLNET::TSockId from,
                                         NLNET::CCallbackNetBase &netbase) {
    H_AUTO(getSessionAverageScores_on_getSessionAverageScores);
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWeb::cb_getSessionAverageScores received "
            "from class '%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWeb::cb_getSessionAverageScores : calling "
            "on_getSessionAverageScores");
#endif

    callback->on_getSessionAverageScores(from, sessionId);
  }

  static void cb_getScenarioAverageScores(NLNET::CMessage &message,
                                          NLNET::TSockId from,
                                          NLNET::CCallbackNetBase &netbase) {
    H_AUTO(getScenarioAverageScores_on_getScenarioAverageScores);
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWeb::cb_getScenarioAverageScores received "
            "from class '%s'",
            typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWeb::cb_getScenarioAverageScores : calling "
            "on_getScenarioAverageScores");
#endif

    callback->on_getScenarioAverageScores(from, md5);
  }

  static void cb_getRingRatings(NLNET::CMessage &message, NLNET::TSockId from,
                                NLNET::CCallbackNetBase &netbase) {
    H_AUTO(getRingRatings_on_getRingRatings);
#ifdef NL_DEBUG
    nldebug(
        "CSessionBrowserServerWeb::cb_getRingRatings received from class '%s'",
        typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWeb::cb_getRingRatings : calling "
            "on_getRingRatings");
#endif
  ...
  static void cb_getRingPoints(NLNET::CMessage &message, NLNET::TSockId from,
                               NLNET::CCallbackNetBase &netbase) {
    H_AUTO(getRingPoints_on_getRingPoints);
#ifdef NL_DEBUG
    nldebug(
        "CSessionBrowserServerWeb::cb_getRingPoints received from class '%s'",
        typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWeb::cb_getRingPoints : calling "
            "on_getRingPoints");
#endif
  ...
  static void cb_forwardToDss(NLNET::CMessage &message, NLNET::TSockId from,
                              NLNET::CCallbackNetBase &netbase) {
    H_AUTO(forwardToDss_on_forwardToDss);
#ifdef NL_DEBUG
    nldebug(
        "CSessionBrowserServerWeb::cb_forwardToDss received from class '%s'",
        typeid(netbase).name());
#endif
    ICallbackServerAdaptor *adaptor =
        static_cast<ICallbackServerAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug(
        "CSessionBrowserServerWeb::cb_forwardToDss : calling on_forwardToDss");
#endif
  ...
  /// Disconnection callback : one of the interface client disconnect
  virtual void
  on_CSessionBrowserServerWeb_Disconnection(NLNET::TSockId from) = 0;
  ...
  virtual void on_authenticate(NLNET::TSockId from, uint32 userId,
                               const NLNET::CLoginCookie &cookie) = 0;
  ...
  virtual void on_getCharList(NLNET::TSockId from, uint32 charId,
                              TSessionId sessionId) = 0;
  ...
  // 		plus all the error code from inviteCharacter in the ring session
  // manager interface
  virtual void on_inviteCharacterByName(NLNET::TSockId from, uint32 charId,
                                        std::string invitedCharName) = 0;

  // Ask for character existing rating for the current session scenario
  // return playerRatings.
  virtual void on_getMyRatings(NLNET::TSockId from, uint32 charId,
                               uint32 sessionId) = 0;

  // Ask for average scores of a session
  // return scessionAverageScores.
  virtual void on_getSessionAverageScores(NLNET::TSockId from,
                                          uint32 sessionId) = 0;

  // Ask for average scores of a scenario
  // return scenarioAverageScores.
  virtual void on_getScenarioAverageScores(NLNET::TSockId from,
  ...
  virtual void on_forwardToDss(NLNET::TSockId from, uint32 charId,
                               const NLNET::CMessage &msg) = 0;
};
...
protected:
  ...
  static void _cbDisconnection(NLNET::TSockId from, void *arg) {
    CSessionBrowserServerWebClientItf *_this =
        reinterpret_cast<CSessionBrowserServerWebClientItf *>(arg);
...
public:
  ...
  static const std::string &getMessageName(const std::string &methodName) {
    ...
    if (!initialized) {
      messageNames.insert(
          std::make_pair(std::string("on_sessionList"), std::string("SL")));
      messageNames.insert(
          std::make_pair(std::string("on_charList"), std::string("CL")));
      messageNames.insert(
          std::make_pair(std::string("on_playerRatings"), std::string("PR")));
      messageNames.insert(std::make_pair(std::string("on_sessionAverageScores"),
                                         std::string("SAS")));
      messageNames.insert(std::make_pair(
          std::string("on_scenarioAverageScores"), std::string("SCAS")));
      messageNames.insert(
          std::make_pair(std::string("on_ringRatings"), std::string("RR")));
      messageNames.insert(
          std::make_pair(std::string("on_ringPoints"), std::string("RP")));
  ...
  CSessionBrowserServerWebClientItf(
      ICallbackClientAdaptor *adaptorReplacement = NULL)
  ...
  static void cb_sessionList(NLNET::CMessage &message, NLNET::TSockId from,
                             NLNET::CCallbackNetBase &netbase) {
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWebClient::cb_sessionList received from "
            "class '%s'",
            typeid(netbase).name());
#endif
    ICallbackClientAdaptor *adaptor =
    ...
    CSessionBrowserServerWebClientItf *callback =
        (CSessionBrowserServerWebClientItf *)adaptor->getContainerClass();
...
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWebClient::cb_sessionList : calling "
            "on_sessionList");
#endif
  ...
  static void cb_charList(NLNET::CMessage &message, NLNET::TSockId from,
                          NLNET::CCallbackNetBase &netbase) {
#ifdef NL_DEBUG
    nldebug(
        "CSessionBrowserServerWebClient::cb_charList received from class '%s'",
        typeid(netbase).name());
#endif
    ICallbackClientAdaptor *adaptor =
        static_cast<ICallbackClientAdaptor *>(netbase.getUserData());
...
#ifdef NL_DEBUG
    nldebug(
        "CSessionBrowserServerWebClient::cb_charList : calling on_charList");
#endif

    callback->on_charList(from, charId, sessionId, characters);
  }

  static void cb_playerRatings(NLNET::CMessage &message, NLNET::TSockId from,
                               NLNET::CCallbackNetBase &netbase) {
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWebClient::cb_playerRatings received from "
            "class '%s'",
            typeid(netbase).name());
#endif
    ICallbackClientAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWebClient::cb_playerRatings : calling "
            "on_playerRatings");
#endif

    callback->on_playerRatings(from, charId, scenarioRated, rateFun,
                               rateDifficulty, rateAccessibility,
                               rateOriginality, rateDirection);
  }

  static void cb_sessionAverageScores(NLNET::CMessage &message,
                                      NLNET::TSockId from,
                                      NLNET::CCallbackNetBase &netbase) {
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWebClient::cb_sessionAverageScores received "
            "from class '%s'",
            typeid(netbase).name());
#endif
    ICallbackClientAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWebClient::cb_sessionAverageScores : calling "
            "on_sessionAverageScores");
#endif

    callback->on_sessionAverageScores(from, scenarioRated, rateFun,
                                      rateDifficulty, rateAccessibility,
                                      rateOriginality, rateDirection, rrpTotal);
  }

  static void cb_scenarioAverageScores(NLNET::CMessage &message,
                                       NLNET::TSockId from,
                                       NLNET::CCallbackNetBase &netbase) {
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWebClient::cb_scenarioAverageScores received "
            "from class '%s'",
            typeid(netbase).name());
#endif
    ICallbackClientAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWebClient::cb_scenarioAverageScores : "
            "calling on_scenarioAverageScores");
#endif

    callback->on_scenarioAverageScores(
        from, scenarioRated, rateFun, rateDifficulty, rateAccessibility,
        rateOriginality, rateDirection, rrpTotal);
  }

  static void cb_ringRatings(NLNET::CMessage &message, NLNET::TSockId from,
                             NLNET::CCallbackNetBase &netbase) {
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWebClient::cb_ringRatings received from "
            "class '%s'",
            typeid(netbase).name());
#endif
    ICallbackClientAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWebClient::cb_ringRatings : calling "
            "on_ringRatings");
#endif

    callback->on_ringRatings(from, charId, authorRating, AMRating,
                             masterlessRating);
  }

  static void cb_ringPoints(NLNET::CMessage &message, NLNET::TSockId from,
                            NLNET::CCallbackNetBase &netbase) {
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWebClient::cb_ringPoints received from class "
            "'%s'",
            typeid(netbase).name());
#endif
    ICallbackClientAdaptor *adaptor =
...
#ifdef NL_DEBUG
    nldebug("CSessionBrowserServerWebClient::cb_ringPoints : calling "
            "on_ringPoints");
#endif
  ...
  /// Disconnection callback : the connection to the server is lost
  virtual void
  on_CSessionBrowserServerWebClient_Disconnection(NLNET::TSockId from) = 0;

  // Return the list of available session
  virtual void on_sessionList(NLNET::TSockId from, uint32 charId,
                              const std::vector<TSessionDesc> &sessions) = 0;

  // Return the list of player characters in the session
  virtual void on_charList(NLNET::TSockId from, uint32 charId,
                           TSessionId sessionId,
                           const std::vector<TCharDesc> &characters) = 0;
