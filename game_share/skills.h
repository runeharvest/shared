...
// BRIANCODE - adding an "any" enum AFTER NUM_SKILLS so I can check if "any"
// skill is level X or higher (for example)
 ...
 * \return the ESkills associated to this string (Unknown if the string cannot
 * be interpreted)
 */
