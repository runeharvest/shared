...
struct SPropVisualA {
  ...
  SPropVisualA &operator=(const SPropVisualA &p) {
...
struct SPropVisualB {
  ...
  SPropVisualB &operator=(const SPropVisualB &p) {
...
struct SPropVisualC {
  ...
  SPropVisualC &operator=(const SPropVisualC &p) {
    PropertyC = p.PropertyC;
    return *this;
  }
...
struct SAltLookProp {
  ...
  /// \name Operators
  //@{
  SAltLookProp &operator=(const SAltLookProp &p) {
    Summary = p.Summary;
    return *this;
  }
...
struct SAltLookProp2 {
  ...
  /// \name Operators
  //@{
  SAltLookProp2 &operator=(const SAltLookProp2 &p) {
    Summary = p.Summary;
    return *this;
  }
