...
CScenarioValidator::CScenarioValidator(CScenarioValidatorLoadSuccededCallback *loadCb)
    : _LoadCb(loadCb)
{
}
...
CUserComponentValidator::CUserComponentValidator(CUserComponentValidatorLoadSuccededCallback *loadCb)
    : _LoadCb(loadCb)
{
}
