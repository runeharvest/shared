...
NL_END_STRING_CONVERSION_TABLE(TPVPType, StaticCOutpostTPVPTypeConversion,
                               UnknownPVPType)
...
NL_END_STRING_CONVERSION_TABLE(TPVPSide, StaticCOutpostTPVPSideConversion,
                               UnknownPVPSide)
...
NL_END_STRING_CONVERSION_TABLE(TOutpostState, StaticCOutpostStateConversion,
                               UnknownOutpostState)
...
NL_END_STRING_CONVERSION_TABLE(TOutpostEvent, StaticOutpostEventConversion,
                               UnknownOutpostEvent)
...
NL_END_STRING_CONVERSION_TABLE(TSquadType, StaticCOutpostSquadTypeConversion,
                               UnknownSquadType)
...
NL_END_STRING_CONVERSION_TABLE(TSquadState, StaticCOutpostSquadStateConversion,
                               UnknownSquadState)
...
NL_END_STRING_CONVERSION_TABLE(TSpecialOutpostEvent,
                               StaticSpecialOutpostEventConversion,
                               UnknownSpecialOutpostEvent)

std::string const &toString(TPVPType val) {
  return StaticCOutpostTPVPTypeConversion.toString(val);
}
TPVPType toPVPType(std::string const &val) {
  return StaticCOutpostTPVPTypeConversion.fromString(val);
}
std::string const &toString(TPVPSide val) {
  return StaticCOutpostTPVPSideConversion.toString(val);
}
TPVPSide toPVPSide(std::string const &val) {
  return StaticCOutpostTPVPSideConversion.fromString(val);
}
std::string const &toString(TOutpostState val) {
  return StaticCOutpostStateConversion.toString(val);
}
TOutpostState toOutpostState(std::string const &val) {
  return StaticCOutpostStateConversion.fromString(val);
}
std::string const &toString(TOutpostEvent val) {
  return StaticOutpostEventConversion.toString(val);
}
TOutpostEvent toOutpostEvent(std::string const &val) {
  return StaticOutpostEventConversion.fromString(val);
}
std::string const &toString(TSquadType val) {
  return StaticCOutpostSquadTypeConversion.toString(val);
}
TSquadType toSquadType(std::string const &val) {
  return StaticCOutpostSquadTypeConversion.fromString(val);
}
std::string const &toString(TSquadState val) {
  return StaticCOutpostSquadStateConversion.toString(val);
}
TSquadState toSquadState(std::string const &val) {
  return StaticCOutpostSquadStateConversion.fromString(val);
}
std::string const &toString(TSpecialOutpostEvent val) {
  return StaticSpecialOutpostEventConversion.toString(val);
}
TSpecialOutpostEvent toSpecialOutpostEvent(std::string const &val) {
  return StaticSpecialOutpostEventConversion.fromString(val);
}
