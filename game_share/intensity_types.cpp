...
void initMap() {
  ...
  StringToAttackIntensity.insert(
      make_pair(string("CRITICAL_HIT"), CRITICAL_HIT));
  AttackIntensityToString.insert(
      make_pair(CRITICAL_HIT, string("CRITICAL_HIT")));
  ...
  StringToAttackIntensity.insert(
      make_pair(string("STRONG_COMBO"), STRONG_COMBO));
  AttackIntensityToString.insert(
      make_pair(STRONG_COMBO, string("STRONG_COMBO")));
  ////////////////////////////////////////////////////////////////////////////////////
  StringToImpactIntensity.insert(
      make_pair(string("IMPACT_INSIGNIFICANT"), IMPACT_INSIGNIFICANT));
  ImpactIntensityToString.insert(
      make_pair(IMPACT_INSIGNIFICANT, string("IMPACT_INSIGNIFICANT")));

  StringToImpactIntensity.insert(
      make_pair(string("IMPACT_VERY_WEAK"), IMPACT_VERY_WEAK));
  ImpactIntensityToString.insert(
      make_pair(IMPACT_VERY_WEAK, string("IMPACT_VERY_WEAK")));
  ...
  StringToImpactIntensity.insert(
      make_pair(string("IMPACT_AVERAGE"), IMPACT_AVERAGE));
  ImpactIntensityToString.insert(
      make_pair(IMPACT_AVERAGE, string("IMPACT_AVERAGE")));

  StringToImpactIntensity.insert(
      make_pair(string("IMPACT_STRONG"), IMPACT_STRONG));
  ImpactIntensityToString.insert(
      make_pair(IMPACT_STRONG, string("IMPACT_STRONG")));

  /*StringToImpactIntensity.insert( make_pair( string("IMPACT_VERY_STRONG"),
  IMPACT_VERY_STRONG) ); ImpactIntensityToString.insert( make_pair(
  IMPACT_VERY_STRONG, string("IMPACT_VERY_STRONG") ) );

  StringToImpactIntensity.insert( make_pair( string("IMPACT_HUGE"), IMPACT_HUGE)
  ); ImpactIntensityToString.insert( make_pair( IMPACT_HUGE,
  string("IMPACT_HUGE") ) );


  StringToImpactIntensity.insert( make_pair( string("IMPACT_NONE"), IMPACT_NONE)
  ); ImpactIntensityToString.insert( make_pair( IMPACT_NONE,
  string("IMPACT_NONE") ) );
  */
} // initMap //
...
TAttackIntensity stringToAttackIntensity(const string &str) {
  ...
  map<string, TAttackIntensity>::const_iterator it =
      StringToAttackIntensity.find(str);
...
const string &attackIntensityToString(TAttackIntensity type) {
  ...
  map<TAttackIntensity, string>::const_iterator it =
      AttackIntensityToString.find(type);
...
TImpactIntensity stringToImpactIntensity(const string &str) {
  ...
  map<string, TImpactIntensity>::const_iterator it =
      StringToImpactIntensity.find(str);
...
const string &impactIntensityToString(TImpactIntensity type) {
  ...
  map<TImpactIntensity, string>::const_iterator it =
      ImpactIntensityToString.find(type);
