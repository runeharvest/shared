...
struct CBackupMsgRequestFile {
  ...
  CBackupMsgRequestFile() { RequestId = 0; }
...
struct CBackupMsgReceiveFile {
  ...
  CBackupMsgReceiveFile() { RequestId = 0; }
...
struct CBackupMsgReceiveFileList {
  ...
  CBackupMsgReceiveFileList() { RequestId = 0; }
...
struct CBackupMsgFileClass {
  ...
  CBackupMsgFileClass() { RequestId = 0; }
...
struct CBackupMsgReceiveFileClass {
  ...
  CBackupMsgReceiveFileClass() { RequestId = 0; }
