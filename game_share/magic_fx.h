...
// TODO: this enum is also used for attack, so could name it in a more general
// way
...
// TODO : this is also used for melee, range, so name it in a more general way
// in another namespace (NUM_ATTACK_POWER ?)
