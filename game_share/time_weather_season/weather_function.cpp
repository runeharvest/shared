...
//==================================================================
CWeatherFunction::CWeatherFunction() { _TotalWeight = 0; }

//==================================================================
void CWeatherFunction::buildFromSheet(const CWeatherFunctionSheet &sheet,
                                      const CWeatherManager &wm) {
  // copy common part of objects (parameters)
  static_cast<CWeatherFunctionParameters &>(*this) =
      static_cast<const CWeatherFunctionParameters &>(sheet);
...
//==================================================================
void CWeatherFunction::getWeatherState(float weatherValue,
                                       CWeatherState &dest) const {
  ...
  if (!floorSetup) {
    ...
    CWeatherState::blend(dest, floorSetup->WeatherState,
                         ceilSetup->WeatherState, blendFactor);
  }
}

//==================================================================
void CWeatherFunction::getClosestWeatherSetups(float weatherValue,
...
//==================================================================
void CWeatherFunction::getCloudState(float weatherValue,
  ...
  if (!floorSetup) {
    ...
    CCloudState::blend(dest, floorSetup->CloudState, floorSetup->CloudState,
                       blendFactor);
  }
}
...
float CWeatherFunction::getThunderIntensity(float weatherValue) const {
  ...
  if (!floorSetup && !ceilSetup)
    return 0.f;
  if (!floorSetup)
    return ceilSetup->WeatherState.ThunderIntensity;
  if (!ceilSetup)
    return floorSetup->WeatherState.ThunderIntensity;
  return blendFactor * ceilSetup->WeatherState.ThunderIntensity +
         (1.f - blendFactor) * floorSetup->WeatherState.ThunderIntensity;
}
