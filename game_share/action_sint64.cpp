...
void CActionSint64::registerNumericPropertiesRyzom() {
  CActionSint64::registerNumericProperty(PROPERTY_ORIENTATION,
                                         32); // overridden in fillOutBox
  CActionSint64::registerNumericProperty(PROPERTY_SHEET,
                                         52); // 32(sheet) + 20(row)
  CActionSint64::registerNumericProperty(PROPERTY_BEHAVIOUR, 48);
  CActionSint64::registerNumericProperty(
      PROPERTY_NAME_STRING_ID,
      32); // please do not lower it (or tell Olivier, used for forage sources)
  ...
  CActionSint64::registerNumericProperty(
      PROPERTY_BARS,
      32); // please do not lower it (or tell Olivier, used for forage sources)
  CActionSint64::registerNumericProperty(PROPERTY_TARGET_LIST,
                                         USER_DEFINED_PROPERTY_NB_BITS);
  CActionSint64::registerNumericProperty(
      PROPERTY_VISUAL_FX,
      11); // please do not lower it (or tell Olivier, used for forage sources)
  ...
  CActionSint64::registerNumericProperty(PROPERTY_OWNER_PEOPLE,
                                         3); // 4 races and unknow
...
/* This function transform the internal field and transform them into a buffer
 * for the UDP connection. \param buffer pointer to the buffer where the data
 * will be written \size size of the buffer
 */
 ...
 */
void CActionSint64::serial(NLMISC::IStream &f) { f.serial(_Value); }
