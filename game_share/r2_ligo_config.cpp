...
namespace R2 {
uint32
CR2LigoConfig::getFileStaticAliasMapping(const std::string &fileName) const {
...
uint32 CR2LigoConfig::getStaticAliasMapping(uint32 aiInstance,
                                            TScenarioType type) const {
