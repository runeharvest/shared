...
public:
TTradeCurrency() : _Value(invalid_val) {}
TTradeCurrency(TValues value) : _Value(value) {}
...
public:
TExplicitSaleType() : _Value(invalid_val) {}
TExplicitSaleType(TValues value) : _Value(value) {}
...
public:
  // Specify the faction
  PVP_CLAN::TPVPClan getFaction() const { return _Faction; }

  void setFaction(PVP_CLAN::TPVPClan value) { _Faction = value; }
  // the factor to apply to the price
  ...
  bool operator==(const TPriceFactionFactor &other) const {
    return _Faction == other._Faction && _Factor == other._Factor;
  }
...
protected:
  ...
  // The amount of the specified currency. -1 for dappers mean 'use normal
  // price'
  sint32 _Amount;
...
public:
  // Specify the type of currency
  TTradeCurrency getCurrency() const { return _Currency; }

  void setCurrency(TTradeCurrency value) { _Currency = value; }
  // The amount of the specified currency. -1 for dappers mean 'use normal
  // price'
  sint32 getAmount() const { return _Amount; }

  void setAmount(sint32 value) { _Amount = value; }
  // For RRPs, specify the level required
  R2::TSessionLevel getRRPLevel() const { return _RRPLevel; }

  void setRRPLevel(R2::TSessionLevel value) { _RRPLevel = value; }
  // SheetId for item currency (must be an item sheet)
  const NLMISC::CSheetId &getSheetId() const { return _SheetId; }

  NLMISC::CSheetId &getSheetId() { return _SheetId; }

  void setSheetId(const NLMISC::CSheetId &value) { _SheetId = value; }
  // The skill type for skill points currency
  EGSPD::CSPType::TSPType getSkillType() const { return _SkillType; }

  void setSkillType(EGSPD::CSPType::TSPType value) { _SkillType = value; }
  // For price in faction points, specify the faction
  PVP_CLAN::TPVPClan getFaction() const { return _Faction; }
  ...
  bool operator==(const TPriceInfo &other) const {
    return _Currency == other._Currency && _Amount == other._Amount &&
           _RRPLevel == other._RRPLevel && _SheetId == other._SheetId &&
           _SkillType == other._SkillType && _Faction == other._Faction &&
...
public:
  //
  TExplicitSaleType getSaleType() const { return _SaleType; }

  void setSaleType(TExplicitSaleType value) { _SaleType = value; }
  //
  const NLMISC::CSheetId &getSheetId() const { return _SheetId; }
  ...
  void setSheetId(const NLMISC::CSheetId &value) { _SheetId = value; }
  // Name of item for named item
  const std::string &getNamed() const { return _Named; }

  std::string &getNamed() { return _Named; }

  void setNamed(const std::string &value) { _Named = value; }
  //
  uint32 getQuantity() const { return _Quantity; }

  void setQuantity(uint32 value) { _Quantity = value; }
  //
  uint32 getQuality() const { return _Quality; }

  void setQuality(uint32 value) { _Quality = value; }
  // The price of the item
  const TPriceInfo &getPrice() const { return _Price; }

  TPriceInfo &getPrice() { return _Price; }

  void setPrice(const TPriceInfo &value) { _Price = value; }

  bool operator==(const TExplicitSale &other) const {
    return _SaleType == other._SaleType && _SheetId == other._SheetId &&
           _Named == other._Named && _Quantity == other._Quantity &&
           _Quality == other._Quality && _Price == other._Price;
  }
...
public:
  ...
  //
  const std::string &getDetail() const { return _Detail; }

  std::string &getDetail() { return _Detail; }

  void setDetail(const std::string &value) { _Detail = value; }

  bool operator==(const TContextOption &other) const {
    return _Title == other._Title && _Detail == other._Detail;
  }
...
public:
  ...
  void setAlias(uint32 value) { _Alias = value; }
  //
  uint32 getGrpAlias() const { return _GrpAlias; }

  void setGrpAlias(uint32 value) { _GrpAlias = value; }
  //
  const std::vector<uint32> &getMissionIds() const { return _MissionIds; }

  std::vector<uint32> &getMissionIds() { return _MissionIds; }

  void setMissionIds(const std::vector<uint32> &value) { _MissionIds = value; }
  //
  const std::vector<uint32> &getShopCategories() const {
    return _ShopCategories;
  }

  std::vector<uint32> &getShopCategories() { return _ShopCategories; }
  ...
  std::vector<TExplicitSale> &getExplicitSales() { return _ExplicitSales; }
  ...
  std::string &getWelcomePhrase() { return _WelcomePhrase; }

  void setWelcomePhrase(const std::string &value) { _WelcomePhrase = value; }
  //
  const std::string &getWebPage() const { return _WebPage; }

  std::string &getWebPage() { return _WebPage; }

  void setWebPage(const std::string &value) { _WebPage = value; }
  //
  const std::string &getWebPageName() const { return _WebPageName; }

  std::string &getWebPageName() { return _WebPageName; }

  void setWebPageName(const std::string &value) { _WebPageName = value; }
  //
  const NLMISC::CSheetId &getSheet() const { return _Sheet; }

  NLMISC::CSheetId &getSheet() { return _Sheet; }

  void setSheet(const NLMISC::CSheetId &value) { _Sheet = value; }
  //
  const TDataSetRow &getEntityIndex() const { return _EntityIndex; }

  TDataSetRow &getEntityIndex() { return _EntityIndex; }

  void setEntityIndex(const TDataSetRow &value) { _EntityIndex = value; }
  //
  bool getPlayerAttackable() const { return _PlayerAttackable; }

  void setPlayerAttackable(bool value) { _PlayerAttackable = value; }
  //
  bool getBotAttackable() const { return _BotAttackable; }

  void setBotAttackable(bool value) { _BotAttackable = value; }
  //
  const NLMISC::CSheetId &getRightHandItem() const { return _RightHandItem; }

  NLMISC::CSheetId &getRightHandItem() { return _RightHandItem; }
  ...
  //
  const NLMISC::CSheetId &getLeftHandItem() const { return _LeftHandItem; }

  NLMISC::CSheetId &getLeftHandItem() { return _LeftHandItem; }

  void setLeftHandItem(const NLMISC::CSheetId &value) { _LeftHandItem = value; }
  //
  uint8 getRightHandItemQuality() const { return _RightHandItemQuality; }

  void setRightHandItemQuality(uint8 value) { _RightHandItemQuality = value; }
  //
  uint8 getLeftHandItemQuality() const { return _LeftHandItemQuality; }

  void setLeftHandItemQuality(uint8 value) { _LeftHandItemQuality = value; }
  // True if this bot can give dynamic mission
  bool getDynamicMissionGiver() const { return _DynamicMissionGiver; }

  void setDynamicMissionGiver(bool value) { _DynamicMissionGiver = value; }
  //
  bool getDontFollow() const { return _DontFollow; }

  void setDontFollow(bool value) { _DontFollow = value; }
  // if that bot is a building bot it will be caught by outpost system
  bool getBuildingBot() const { return _BuildingBot; }
  ...
  std::vector<std::string> &getNewsChannels() { return _NewsChannels; }
  ...
  std::vector<TContextOption> &getContextOptions() { return _ContextOptions; }
  ...
  // list of loot
  const std::vector<NLMISC::CSheetId> &getLootList() const { return _LootList; }

  std::vector<NLMISC::CSheetId> &getLootList() { return _LootList; }
  ...
  NLMISC::CSheetId &getOutpost() { return _Outpost; }

  void setOutpost(const NLMISC::CSheetId &value) { _Outpost = value; }

  //
  uint32 getOrganization() const { return _Organization; }

  void setOrganization(uint32 value) { _Organization = value; }
  //
  float getMaxHitRangeForPC() const { return _MaxHitRangeForPC; }

  void setMaxHitRangeForPC(float value) { _MaxHitRangeForPC = value; }
  //
  const std::string &getUserModelId() const { return _UserModelId; }

  std::string &getUserModelId() { return _UserModelId; }

  void setUserModelId(const std::string &value) { _UserModelId = value; }
  //
  const std::string &getCustomLootTableId() const { return _CustomLootTableId; }

  std::string &getCustomLootTableId() { return _CustomLootTableId; }
  ...
  void setPrimAlias(uint32 value) { _PrimAlias = value; }

  bool operator==(const TGenNpcDescMsg &other) const {
    return _Alias == other._Alias && _GrpAlias == other._GrpAlias &&
           _MissionIds == other._MissionIds &&
           _ShopCategories == other._ShopCategories &&
           _ExplicitSales == other._ExplicitSales &&
           _FilterExplicitActionTradeByPlayerRace ==
               other._FilterExplicitActionTradeByPlayerRace &&
           _ExplicitActionSPType == other._ExplicitActionSPType &&
           _FilterExplicitActionTradeByBotRace ==
               other._FilterExplicitActionTradeByBotRace &&
           _WelcomePhrase == other._WelcomePhrase &&
           _WebPage == other._WebPage && _WebPageName == other._WebPageName &&
           _Sheet == other._Sheet && _EntityIndex == other._EntityIndex &&
           ...
           _LootList == other._LootList && _Outpost == other._Outpost &&
