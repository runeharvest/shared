...
{
	return ((family >= BeginCombatParameter && family <= EndCombatParameter) || (family >= BeginMagicParameter && family <= EndMagicParameter) || (family >= BeginFaberParameter && family <= EndFaberParameter) || (family >= BeginHarvestParameter && family <= EndHarvestParameter) || (family >= BeginForageProspectionParameter && family <= EndForageProspectionParameter) || (family >= BeginForageExtractionParameter && family <= EndForageExtractionParameter) || (family >= BeginPowerParameter && family <= EndPowerParameter));
}
