...
enum TBrickFamily {
  ...
  */
  ...
  // Yoyo: just for code below work (isRoot etc....). remove entries when true
  // families described
  AutoCodeCheck,
 ...
 * \return the TBrickFamily associated to this string (Unknown if the string
...
inline bool isRootFamily(TBrickFamily family) {
  return ((family >= BeginCombatRoot && family <= EndCombatRoot) ||
          ...
          (family >= BeginForageProspectionRoot &&
           family <= EndForageProspectionRoot) ||
          (family >= BeginForageExtractionRoot &&
           family <= EndForageExtractionRoot) ||
...
inline bool isMandatoryFamily(TBrickFamily family) {
  return ((family >= BeginCombatMandatory && family <= EndCombatMandatory) ||
          ...
          (family >= BeginForageProspectionMandatory &&
           family <= EndForageProspectionMandatory) ||
          (family >= BeginForageExtractionMandatory &&
           family <= EndForageExtractionMandatory) ||
...
inline bool isOptionFamily(TBrickFamily family) {
  return ((family >= BeginCombatOption && family <= EndCombatOption) ||
          ...
          (family >= BeginForageProspectionOption &&
           family <= EndForageProspectionOption) ||
          (family >= BeginForageExtractionOption &&
           family <= EndForageExtractionOption));
}
...
inline bool isCreditFamily(TBrickFamily family) {
  return ((family >= BeginCombatCredit && family <= EndCombatCredit) ||
          ...
          (family >= BeginForageProspectionCredit &&
           family <= EndForageProspectionCredit) ||
          (family >= BeginForageExtractionCredit &&
           family <= EndForageExtractionCredit) ||
...
inline bool isParameterFamily(TBrickFamily family) {
  return ((family >= BeginCombatParameter && family <= EndCombatParameter) ||
          ...
          (family >= BeginForageProspectionParameter &&
           family <= EndForageProspectionParameter) ||
          (family >= BeginForageExtractionParameter &&
           family <= EndForageExtractionParameter) ||
