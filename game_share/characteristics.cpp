...
CStringConversion<TCharacteristics>
 ...
 * \return the TCharacteristics associated to this string (unknown if the string
...
const CStringConversion<TCharacteristics>::CPair codeTable[] = {
    {"c", constitution}, {"m", metabolism}, {"i", intelligence},
    {"w", wisdom},       {"s", strength},   {"b", well_balanced},
    {"d", dexterity},    {"l", will},
};
CStringConversion<TCharacteristics>
    codeCharac(codeTable, sizeof(codeTable) / sizeof(codeTable[0]), Unknown);
