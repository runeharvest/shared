...
NL_END_STRING_CONVERSION_TABLE(TSpellMode, SpellModeConversion,
                               UnknownSpellMode)
//
...
NL_END_STRING_CONVERSION_TABLE(TSpellType, SpellTypeConversion,
                               UnknownSpellType)
//
...
NL_END_STRING_CONVERSION_TABLE(TSpellCastStage, SpellCastStageConversion,
                               UnknownSpellCastStage)
//
// *************************************************************************************
...
// *************************************************************************************
TMagicFx healtoMagicFx(sint32 healHp, sint32 healSap, sint32 healSta,
                       bool link) {
  if (!link) {
    if (healHp > healSap) {
      if (healHp > healSta)
