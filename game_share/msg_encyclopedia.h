 ...
 * CEncyMsgThema
 *
 * Maximum is 47 bytes per thema. There are 350 themas, so a potential total of
 * 16450 bytes. Its a theorical maximum that is never reached because few thema
 * has 8 tasks. Some has 8, some has 1. \author Matthieu 'Trap' Besson \author
 * Nevrax France \date October 2004
 */
class CEncyMsgThema {
public:
  ...
  uint8 getTaskState(uint8 nTask) {
    ...
    switch (nTask) {
    case 0:
      return Unpack.RiteState;
    case 1:
      return Unpack.Task0State;
    case 2:
      return Unpack.Task1State;
    case 3:
      return Unpack.Task2State;
    case 4:
      return Unpack.Task3State;
    case 5:
      return Unpack.Task4State;
    case 6:
      return Unpack.Task5State;
    case 7:
      return Unpack.Task6State;
    }
    return 0;
  }
};
...
public:
  ...
  CEncyMsgAlbum() { Name = RewardBrick = 0; }
