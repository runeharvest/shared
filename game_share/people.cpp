...
bool testClassificationType(CPeople::TPeople people,
  ...
  case CPeople::GooKitifly:
  case CPeople::GooKitikil:
    return (type == CClassificationType::TypeFlyingKitin ||
            type == CClassificationType::TypeKitin);
  ...
  case CPeople::Tribe:
  case CPeople::GooKalab:
    return (type == CClassificationType::TypeHomin ||
            type == CClassificationType::TypeHumanoid);

  case CPeople::Karavan:
    return (type == CClassificationType::TypeHomin ||
            type == CClassificationType::TypeHumanoid ||
            type == CClassificationType::TypeKaravan);
  ...
  case CPeople::GooGibbai:
  case CPeople::GooFrahar:
    return (type == CClassificationType::TypeDegenerated ||
            type == CClassificationType::TypeHumanoid);
  ...
  case CPeople::GooFilin:
    return (type == CClassificationType::TypeFauna ||
            type == CClassificationType::TypeRunner);
  ...
  case CPeople::GooVarinx:
    return (type == CClassificationType::TypeFauna ||
            type == CClassificationType::TypeDog);
  ...
  case CPeople::GooMektoubMount:
    return (type == CClassificationType::TypeFauna ||
            type == CClassificationType::TypeHorse);
  ...
  case CPeople::GooZerx:
    return (type == CClassificationType::TypeFauna ||
            type == CClassificationType::TypeRyzomian);
  ...
  case CPeople::GooRyzoholok:
    return (type == CClassificationType::TypeFauna ||
            type == CClassificationType::TypeGreatRyzomian);
  ...
  case CPeople::GooVampignon:
    return (type == CClassificationType::TypeFauna ||
            type == CClassificationType::TypePachyderm);
  ...
  case CPeople::GooHachtaha:
    return (type == CClassificationType::TypeFauna ||
            type == CClassificationType::TypeShellfish);
  ...
  case CPeople::Goorace_c5:
    return (type == CClassificationType::TypeFauna ||
            type == CClassificationType::TypeKitin ||
            type == CClassificationType::TypeLandKitin);
  ...
  case CPeople::GooClapclap:
    return (type == CClassificationType::TypeFauna ||
            type == CClassificationType::TypeFish);
